; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab1/lab1/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:1                                       ; preds = %8, %0
  ...
  %i_cast3_cast = zext i2 %i to i5                ; [#uses=1 type=i5]
  %tmp_6 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %i, i2 0) ; [#uses=1 type=i4]
  %p_shl_cast = zext i4 %tmp_6 to i5, !dbg !53    ; [#uses=1 type=i5] [debug line = 81:9]
  %tmp_7 = sub i5 %p_shl_cast, %i_cast3_cast, !dbg !53 ; [#uses=2 type=i5] [debug line = 81:9]
  ...
  %i_1 = add i2 %i, 1, !dbg !59                   ; [#uses=1 type=i2] [debug line = 75:30]
  br i1 %exitcond2, label %9, label %2, !dbg !50  ; [debug line = 75:21]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str) nounwind, !dbg !60 ; [debug line = 75:36]
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str) nounwind, !dbg !60 ; [#uses=1 type=i32] [debug line = 75:36]
  br label %3, !dbg !61                           ; [debug line = 77:23]

; <label>:3                                       ; preds = %7, %2
  %j = phi i2 [ 0, %2 ], [ %j_1, %7 ]             ; [#uses=3 type=i2]
  %j_cast2_cast = zext i2 %j to i5, !dbg !62      ; [#uses=2 type=i5] [debug line = 79:7]
  %tmp_8 = add i5 %tmp_7, %j_cast2_cast, !dbg !62 ; [#uses=1 type=i5] [debug line = 79:7]
  %tmp_8_cast = sext i5 %tmp_8 to i32, !dbg !62   ; [#uses=1 type=i32] [debug line = 79:7]
  %res_addr = getelementptr [9 x i16]* %res, i32 0, i32 %tmp_8_cast, !dbg !62 ; [#uses=1 type=i16*] [debug line = 79:7]
  ...
  %j_1 = add i2 %j, 1, !dbg !63                   ; [#uses=1 type=i2] [debug line = 77:32]
  br i1 %exitcond1, label %8, label %4, !dbg !61  ; [debug line = 77:23]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str1) nounwind, !dbg !64 ; [debug line = 77:38]
  %tmp_5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str1) nounwind, !dbg !64 ; [#uses=1 type=i32] [debug line = 77:38]
  br label %5, !dbg !65                           ; [debug line = 80:29]

; <label>:5                                       ; preds = %6, %4
  %res_load = phi i16 [ 0, %4 ], [ %tmp_3, %6 ]   ; [#uses=2 type=i16]
  %k = phi i2 [ 0, %4 ], [ %k_1, %6 ]             ; [#uses=4 type=i2]
  store i16 %res_load, i16* %res_addr, align 2, !dbg !53 ; [debug line = 81:9]
  %k_cast1_cast = zext i2 %k to i5, !dbg !53      ; [#uses=2 type=i5] [debug line = 81:9]
  %tmp_9 = add i5 %tmp_7, %k_cast1_cast, !dbg !53 ; [#uses=1 type=i5] [debug line = 81:9]
  %tmp_9_cast = sext i5 %tmp_9 to i32, !dbg !53   ; [#uses=1 type=i32] [debug line = 81:9]
  %a_addr = getelementptr [9 x i8]* %a, i32 0, i32 %tmp_9_cast, !dbg !53 ; [#uses=1 type=i8*] [debug line = 81:9]
  %tmp_s = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %k, i2 0) ; [#uses=1 type=i4]
  %p_shl1_cast = zext i4 %tmp_s to i5, !dbg !53   ; [#uses=1 type=i5] [debug line = 81:9]
  %tmp_10 = sub i5 %p_shl1_cast, %k_cast1_cast, !dbg !53 ; [#uses=1 type=i5] [debug line = 81:9]
  %tmp_11 = add i5 %tmp_10, %j_cast2_cast, !dbg !53 ; [#uses=1 type=i5] [debug line = 81:9]
  %tmp_12_cast = sext i5 %tmp_11 to i32, !dbg !53 ; [#uses=1 type=i32] [debug line = 81:9]
  %b_addr = getelementptr [9 x i8]* %b, i32 0, i32 %tmp_12_cast, !dbg !53 ; [#uses=1 type=i8*] [debug line = 81:9]
...
; <label>:6                                       ; preds = %5
  ...
  %a_load = load i8* %a_addr, align 1, !dbg !53   ; [#uses=1 type=i8] [debug line = 81:9]
  %tmp = sext i8 %a_load to i16, !dbg !53         ; [#uses=1 type=i16] [debug line = 81:9]
  %b_load = load i8* %b_addr, align 1, !dbg !53   ; [#uses=1 type=i8] [debug line = 81:9]
  %tmp_1 = sext i8 %b_load to i16, !dbg !53       ; [#uses=1 type=i16] [debug line = 81:9]
  %tmp_2 = mul i16 %tmp_1, %tmp, !dbg !53         ; [#uses=1 type=i16] [debug line = 81:9]
  %tmp_3 = add i16 %res_load, %tmp_2, !dbg !53    ; [#uses=1 type=i16] [debug line = 81:9]
...
; <label>:7                                       ; preds = %5
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str1, i32 %tmp_5) nounwind, !dbg !70 ; [#uses=0 type=i32] [debug line = 83:5]
  call void @llvm.dbg.value(metadata !{i2 %j_1}, i64 0, metadata !71), !dbg !63 ; [debug line = 77:32] [debug variable = j]
  br label %3, !dbg !63                           ; [debug line = 77:32]

; <label>:8                                       ; preds = %3
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str, i32 %tmp_4) nounwind, !dbg !72 ; [#uses=0 type=i32] [debug line = 84:3]
  call void @llvm.dbg.value(metadata !{i2 %i_1}, i64 0, metadata !73), !dbg !59 ; [debug line = 75:30] [debug variable = i]
...
!23 = metadata !{i32 786473, metadata !"../../labs/lab1/matrixmul.cpp", metadata !"C:\5CUsers\5CAndrew\5CDocuments\5CVivado_projects\5CHLS_Xilinx_university_program\5Cprojects\5Clab1", null} ; [ DW_TAG_file_type ]
...
!53 = metadata !{i32 81, i32 9, metadata !54, null}
!54 = metadata !{i32 786443, metadata !55, i32 80, i32 43, metadata !23, i32 6} ; [ DW_TAG_lexical_block ]
!55 = metadata !{i32 786443, metadata !56, i32 80, i32 16, metadata !23, i32 5} ; [ DW_TAG_lexical_block ]
!56 = metadata !{i32 786443, metadata !57, i32 77, i32 37, metadata !23, i32 4} ; [ DW_TAG_lexical_block ]
!57 = metadata !{i32 786443, metadata !58, i32 77, i32 10, metadata !23, i32 3} ; [ DW_TAG_lexical_block ]
!58 = metadata !{i32 786443, metadata !51, i32 75, i32 35, metadata !23, i32 2} ; [ DW_TAG_lexical_block ]
!59 = metadata !{i32 75, i32 30, metadata !51, null}
!60 = metadata !{i32 75, i32 36, metadata !58, null}
!61 = metadata !{i32 77, i32 23, metadata !57, null}
!62 = metadata !{i32 79, i32 7, metadata !56, null}
!63 = metadata !{i32 77, i32 32, metadata !57, null}
!64 = metadata !{i32 77, i32 38, metadata !56, null}
!65 = metadata !{i32 80, i32 29, metadata !55, null}
!66 = metadata !{i32 80, i32 38, metadata !55, null}
!67 = metadata !{i32 80, i32 44, metadata !54, null}
!68 = metadata !{i32 786688, metadata !55, metadata !"k", metadata !23, i32 80, metadata !69, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!69 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!70 = metadata !{i32 83, i32 5, metadata !56, null}
!71 = metadata !{i32 786688, metadata !57, metadata !"j", metadata !23, i32 77, metadata !69, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!72 = metadata !{i32 84, i32 3, metadata !58, null}
