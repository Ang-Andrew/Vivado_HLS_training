...
#ifndef __fir_mac_muladd_16cud__HH__
#define __fir_mac_muladd_16cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_mac_muladd_16cud) {
    ...
    SC_CTOR(fir_mac_muladd_16cud):  simcore_mac_0_U ("simcore_mac_0_U") {
