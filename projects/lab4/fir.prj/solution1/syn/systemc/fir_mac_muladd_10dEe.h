...
#ifndef __fir_mac_muladd_10dEe__HH__
#define __fir_mac_muladd_10dEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_mac_muladd_10dEe) {
    ...
    SC_CTOR(fir_mac_muladd_10dEe):  simcore_mac_1_U ("simcore_mac_1_U") {
