...
(* CORE_GENERATION_INFO="fir,hls_ip_2016_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.380000,HLS_SYN_LAT=63,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=172,HLS_SYN_LUT=118}" *)
...
reg   [0:0] ap_pipeline_reg_pp0_iter1_tmp_2_reg_226;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & ~(1'b0 == tmp_2_fu_141_p2))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if (((1'b1 == ap_CS_fsm_state4) | ((1'b1 == ap_CS_fsm_pp0_stage0) & ~(1'b0 == tmp_2_fu_141_p2)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_enable_reg_pp0_iter2) & (1'b0 == ap_pipeline_reg_pp0_iter1_tmp_2_reg_226))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (tmp_2_reg_226 == 1'b0))) begin
        i_reg_119 <= i_1_reg_235;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        i_reg_119 <= ap_const_lv6_39;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_pp0_stage0)) begin
        ap_pipeline_reg_pp0_iter1_tmp_2_reg_226 <= tmp_2_reg_226;
        tmp_2_reg_226 <= tmp_2_fu_141_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_2_reg_226 == 1'b0))) begin
        c_load_reg_250 <= c_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == tmp_2_fu_141_p2) & (1'b1 == ap_enable_reg_pp0_iter0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (tmp_2_reg_226 == 1'b0)))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (tmp_2_reg_226 == 1'b0)) | (1'b1 == ap_CS_fsm_state8))) begin
        shift_reg_we1 = 1'b1;
    end else begin
        shift_reg_we1 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b1 == ap_enable_reg_pp0_iter2) & ~(1'b1 == ap_enable_reg_pp0_iter1)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & ~(1'b0 == tmp_2_fu_141_p2) & ~(1'b1 == ap_enable_reg_pp0_iter1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((1'b1 == ap_enable_reg_pp0_iter0) & ~(1'b0 == tmp_2_fu_141_p2) & ~(1'b1 == ap_enable_reg_pp0_iter1))) begin
...
assign acc_fu_187_p1 = ap_const_lv26_3FFFE86;
...
assign grp_fu_201_p0 = ap_const_lv26_3FFFE86;

assign grp_fu_201_p2 = acc1_reg_109[30:0];

assign i_1_cast_fu_158_p1 = i_1_fu_152_p2;

assign i_1_fu_152_p2 = ($signed(i_phi_fu_123_p4) + $signed(ap_const_lv6_3F));

assign i_cast1_fu_147_p1 = i_phi_fu_123_p4;

assign tmp_2_fu_141_p2 = ((i_phi_fu_123_p4 == ap_const_lv6_0) ? 1'b1 : 1'b0);

assign y = {{grp_fu_201_p3[ap_const_lv32_1E : ap_const_lv32_F]}};
