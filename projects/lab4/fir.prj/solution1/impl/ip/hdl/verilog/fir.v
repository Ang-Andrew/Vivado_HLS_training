...
(* CORE_GENERATION_INFO="fir,hls_ip_2016_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.380000,HLS_SYN_LAT=63,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=268,HLS_SYN_LUT=222}" *)
...
reg    c_ce0;
wire   [15:0] c_q0;
reg   [36:0] acc1_reg_115;
reg   [5:0] i_reg_125;
reg  signed [15:0] reg_136;
...
wire  signed [36:0] acc_cast_fu_144_p1;
wire   [0:0] tmp_3_fu_147_p2;
reg   [0:0] ap_pipeline_reg_pp0_iter1_tmp_3_reg_232;
wire   [31:0] i_cast1_fu_153_p1;
reg   [31:0] i_cast1_reg_236;
wire   [5:0] i_1_fu_158_p2;
reg   [5:0] i_1_reg_241;
reg    ap_enable_reg_pp0_iter0;
reg  signed [15:0] c_load_reg_256;
wire  signed [36:0] grp_fu_199_p3;
reg    ap_enable_reg_pp0_iter2;
reg   [5:0] i_phi_fu_129_p4;
wire   [31:0] i_1_cast_fu_164_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & ~(1'b0 == tmp_3_fu_147_p2))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if (((1'b1 == ap_CS_fsm_state4) | ((1'b1 == ap_CS_fsm_pp0_stage0) & ~(1'b0 == tmp_3_fu_147_p2)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_enable_reg_pp0_iter2) & (1'b0 == ap_pipeline_reg_pp0_iter1_tmp_3_reg_232))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (tmp_3_reg_232 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_3_reg_232 == 1'b0))) begin
        c_load_reg_256 <= c_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == tmp_3_fu_147_p2) & (1'b1 == ap_enable_reg_pp0_iter0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == tmp_3_fu_147_p2))) begin
        i_cast1_reg_236[5 : 0] <= i_cast1_fu_153_p1[5 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (tmp_3_reg_232 == 1'b0)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter0))) begin
        shift_reg_address0 = i_1_cast_fu_164_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        shift_reg_address1 = i_cast1_reg_236;
    end else begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter0)) | ((ap_CS_fsm_state1 == 1'b1) & ~(ap_start == 1'b0)))) begin
        shift_reg_ce0 = 1'b1;
    end else begin
        shift_reg_ce0 = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1)) | (1'b1 == ap_CS_fsm_state8))) begin
        shift_reg_ce1 = 1'b1;
    end else begin
        shift_reg_ce1 = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (tmp_3_reg_232 == 1'b0)) | (1'b1 == ap_CS_fsm_state8))) begin
        shift_reg_we1 = 1'b1;
    end else begin
        shift_reg_we1 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b1 == ap_enable_reg_pp0_iter2) & ~(1'b1 == ap_enable_reg_pp0_iter1)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & ~(1'b0 == tmp_3_fu_147_p2) & ~(1'b1 == ap_enable_reg_pp0_iter1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((1'b1 == ap_enable_reg_pp0_iter0) & ~(1'b0 == tmp_3_fu_147_p2) & ~(1'b1 == ap_enable_reg_pp0_iter1))) begin
...
assign acc_cast_fu_144_p1 = acc_reg_216;

assign acc_fu_193_p1 = ap_const_lv26_3FFFE86;
...
assign grp_fu_207_p0 = ap_const_lv26_3FFFE86;

assign grp_fu_207_p2 = acc1_reg_115[30:0];

assign i_1_cast_fu_164_p1 = i_1_fu_158_p2;

assign i_1_fu_158_p2 = ($signed(i_phi_fu_129_p4) + $signed(ap_const_lv6_3F));

assign i_cast1_fu_153_p1 = i_phi_fu_129_p4;

assign tmp_3_fu_147_p2 = ((i_phi_fu_129_p4 == ap_const_lv6_0) ? 1'b1 : 1'b0);

assign y = {{grp_fu_207_p3[ap_const_lv32_1E : ap_const_lv32_F]}};

always @ (posedge ap_clk) begin
    i_cast1_reg_236[31:6] <= 26'b00000000000000000000000000;
end
