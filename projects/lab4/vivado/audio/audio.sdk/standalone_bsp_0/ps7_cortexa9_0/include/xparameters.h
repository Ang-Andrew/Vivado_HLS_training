...
#define XPAR_FIR_LEFT_S_AXI_FIR_IO_BASEADDR 0x43C10000
#define XPAR_FIR_LEFT_S_AXI_FIR_IO_HIGHADDR 0x43C1FFFF
...
#define XPAR_XFIR_0_DEVICE_ID XPAR_FIR_LEFT_DEVICE_ID
