...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab4/bitstream_gen.tcl"
  ...
  if {$src_rc} { 
    ...
    send_msg_id runtcl-2 error "sourcing script C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab4/bitstream_gen.tcl failed"
    return -code error
  }
