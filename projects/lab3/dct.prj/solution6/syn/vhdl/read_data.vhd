...
architecture behav of read_data is 
    ...
    signal c_2_fu_286_p2 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal r_2_fu_231_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_CS_fsm_state1 = ap_const_lv1_1) and not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1)))) or ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage0) and not((exitcond_flatten_fu_219_p2 = ap_const_lv1_0))))) then 
                    ap_enable_reg_pp0_iter1 <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, exitcond_flatten_fu_219_p2, ap_enable_reg_pp0_iter0)
    begin
        case ap_CS_fsm is
    ...
    c_2_fu_286_p2 <= std_logic_vector(unsigned(c_mid2_fu_243_p3) + unsigned(ap_const_lv4_1));
    c_cast1_fu_292_p1 <= std_logic_vector(resize(unsigned(c_mid2_reg_312),32));
    c_cast_fu_271_p1 <= std_logic_vector(resize(unsigned(c_mid2_fu_243_p3),6));
    c_mid2_fu_243_p3 <= 
    ...
    r_2_fu_231_p2 <= std_logic_vector(unsigned(ap_const_lv4_1) + unsigned(r_phi_fu_201_p4));
    ...
    sum_fu_275_p2 <= std_logic_vector(unsigned(c_cast_fu_271_p1) + unsigned(tmp_mid2_fu_263_p3));
    tmp_fu_259_p1 <= tmp_mid2_v_v_fu_251_p3(3 - 1 downto 0);
    tmp_mid2_fu_263_p3 <= (tmp_fu_259_p1 & ap_const_lv3_0);
    tmp_mid2_v_v_fu_251_p3 <= 
        r_2_fu_231_p2 when (exitcond3_fu_237_p2(0) = '1') else 
        r_phi_fu_201_p4;
end behav;
