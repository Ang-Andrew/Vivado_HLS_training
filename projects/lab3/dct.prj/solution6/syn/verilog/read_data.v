...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((ap_CS_fsm_state1 == 1'b1) & ~((ap_start == 1'b0) | (ap_done_reg == 1'b1))) | ((1'b1 == ap_CS_fsm_pp0_stage0) & ~(exitcond_flatten_fu_219_p2 == 1'b0)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
assign c_2_fu_286_p2 = (c_mid2_fu_243_p3 + ap_const_lv4_1);

assign c_cast1_fu_292_p1 = c_mid2_reg_312;

assign c_cast_fu_271_p1 = c_mid2_fu_243_p3;
...
assign r_2_fu_231_p2 = (ap_const_lv4_1 + r_phi_fu_201_p4);

assign sum_cast_fu_281_p1 = sum_fu_275_p2;

assign sum_fu_275_p2 = (c_cast_fu_271_p1 + tmp_mid2_fu_263_p3);

assign tmp_fu_259_p1 = tmp_mid2_v_v_fu_251_p3[2:0];

assign tmp_mid2_fu_263_p3 = {{tmp_fu_259_p1}, {ap_const_lv3_0}};

assign tmp_mid2_v_v_fu_251_p3 = ((exitcond3_fu_237_p2[0:0] === 1'b1) ? r_2_fu_231_p2 : r_phi_fu_201_p4);
