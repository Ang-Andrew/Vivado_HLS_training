...
void read_data::thread_c_2_fu_286_p2() {
    c_2_fu_286_p2 = (!c_mid2_fu_243_p3.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(c_mid2_fu_243_p3.read()) + sc_biguint<4>(ap_const_lv4_1));
}
...
void read_data::thread_c_cast_fu_271_p1() {
...
void read_data::thread_r_2_fu_231_p2() {
...
void read_data::thread_sum_fu_275_p2() {
    sum_fu_275_p2 = (!c_cast_fu_271_p1.read().is_01() || !tmp_mid2_fu_263_p3.read().is_01())? sc_lv<6>(): (sc_biguint<6>(c_cast_fu_271_p1.read()) + sc_biguint<6>(tmp_mid2_fu_263_p3.read()));
}
...
void read_data::thread_tmp_mid2_v_v_fu_251_p3() {
    tmp_mid2_v_v_fu_251_p3 = (!exitcond3_fu_237_p2.read()[0].is_01())? sc_lv<4>(): ((exitcond3_fu_237_p2.read()[0].to_bool())? r_2_fu_231_p2.read(): r_phi_fu_201_p4.read());
}
