...
#ifndef _dct_row_outbuf_i_H_
#define _dct_row_outbuf_i_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "dct_row_outbuf_i_memcore.h"

SC_MODULE(dct_row_outbuf_i) {
...
public:
    ~dct_row_outbuf_i();
    SC_CTOR(dct_row_outbuf_i) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        dct_row_outbuf_i_memcore_U = new dct_row_outbuf_i_memcore("dct_row_outbuf_i_memcore_U");
        dct_row_outbuf_i_memcore_U->clk      ( clk );
        dct_row_outbuf_i_memcore_U->reset    ( reset );
        dct_row_outbuf_i_memcore_U->ce0      ( i_ce0 );
        dct_row_outbuf_i_memcore_U->we0      ( i_we0 );
        dct_row_outbuf_i_memcore_U->address0 ( memcore_iaddr );
        dct_row_outbuf_i_memcore_U->d0       ( i_d0 );
        dct_row_outbuf_i_memcore_U->q0       ( i_q0 );

        dct_row_outbuf_i_memcore_U->ce1      ( t_ce0 );
        dct_row_outbuf_i_memcore_U->we1      ( t_we0 );
        dct_row_outbuf_i_memcore_U->address1 ( memcore_taddr );
        dct_row_outbuf_i_memcore_U->d1       ( t_d0 );
        dct_row_outbuf_i_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "dct_row_outbuf_i.trace");
            // ports
