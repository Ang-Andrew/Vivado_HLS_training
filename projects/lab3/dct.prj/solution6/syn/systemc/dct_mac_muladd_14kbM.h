...
#ifndef __dct_mac_muladd_14kbM__HH__
#define __dct_mac_muladd_14kbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mac_muladd_14kbM) {
    ...
    SC_CTOR(dct_mac_muladd_14kbM):  simcore_mac_0_U ("simcore_mac_0_U") {
