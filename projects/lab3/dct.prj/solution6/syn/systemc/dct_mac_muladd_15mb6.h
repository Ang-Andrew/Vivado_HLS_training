...
#ifndef __dct_mac_muladd_15mb6__HH__
#define __dct_mac_muladd_15mb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mac_muladd_15mb6) {
    ...
    SC_CTOR(dct_mac_muladd_15mb6):  simcore_mac_2_U ("simcore_mac_2_U") {
