...
(* CORE_GENERATION_INFO="dct,hls_ip_2016_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.790000,HLS_SYN_LAT=623,HLS_SYN_TPT=131,HLS_SYN_MEM=22,HLS_SYN_DSP=16,HLS_SYN_FF=1716,HLS_SYN_LUT=5141}" *)
