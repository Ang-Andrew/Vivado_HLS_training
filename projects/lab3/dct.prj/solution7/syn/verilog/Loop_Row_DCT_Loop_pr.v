...
reg   [3:0] i_reg_508;
wire   [7:0] tmp_16_cast_fu_192_p1;
reg   [7:0] tmp_16_cast_reg_513;
reg   [2:0] buf_2d_in_addr_reg_518;
...
wire   [7:0] tmp_4_fu_217_p2;
reg   [7:0] tmp_4_reg_532;
reg   [7:0] ap_pipeline_reg_pp0_iter1_tmp_4_reg_532;
reg   [7:0] ap_pipeline_reg_pp0_iter2_tmp_4_reg_532;
reg   [7:0] ap_pipeline_reg_pp0_iter3_tmp_4_reg_532;
wire   [15:0] tmp_49_fu_222_p1;
reg  signed [15:0] tmp_49_reg_542;
wire   [15:0] tmp_50_fu_226_p1;
reg  signed [15:0] tmp_50_reg_547;
...
(* use_dsp48 = "no" *) wire   [28:0] tmp4_fu_422_p2;
(* use_dsp48 = "no" *) wire   [28:0] tmp1_fu_418_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & ~(tmp_fu_167_p2 == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_CS_fsm_state2) & (tmp_fu_167_p2 == 1'b0)) | ((1'b1 == ap_CS_fsm_pp0_stage0) & ~(1'b0 == tmp_i_fu_196_p2)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_167_p2 == 1'b0))) begin
        buf_2d_in_addr_reg_518 <= i_2_i1_cast_i_fu_179_p1;
        tmp_16_cast_reg_513[6 : 3] <= tmp_16_cast_fu_192_p1[6 : 3];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == tmp_i_reg_523))) begin
        tmp_10_i_reg_567 <= {{buf_2d_in_q0[ap_const_lv9_2F : ap_const_lv9_20]}};
        tmp_11_i_reg_572 <= {{dct_coeff_table_q0[ap_const_lv32_3F : ap_const_lv32_30]}};
        tmp_12_i_reg_577 <= {{buf_2d_in_q0[ap_const_lv9_3F : ap_const_lv9_30]}};
        tmp_13_i_reg_582 <= {{dct_coeff_table_q0[ap_const_lv32_4F : ap_const_lv32_40]}};
        tmp_14_i_reg_587 <= {{buf_2d_in_q0[ap_const_lv9_4F : ap_const_lv9_40]}};
        tmp_15_i_reg_592 <= {{dct_coeff_table_q0[ap_const_lv32_5F : ap_const_lv32_50]}};
        tmp_16_i_reg_597 <= {{buf_2d_in_q0[ap_const_lv9_5F : ap_const_lv9_50]}};
        tmp_17_i_reg_602 <= {{dct_coeff_table_q0[ap_const_lv32_6F : ap_const_lv32_60]}};
        tmp_18_i_reg_607 <= {{buf_2d_in_q0[ap_const_lv9_6F : ap_const_lv9_60]}};
        tmp_1_reg_612 <= {{dct_coeff_table_q0[ap_const_lv32_7E : ap_const_lv32_70]}};
        tmp_20_i_reg_617 <= {{buf_2d_in_q0[ap_const_lv9_7F : ap_const_lv9_70]}};
        ...
        tmp_7_i_reg_557 <= {{buf_2d_in_q0[ap_const_lv9_1F : ap_const_lv9_10]}};
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_CS_fsm_state2) & ~(tmp_fu_167_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign buf_2d_in_address0 = buf_2d_in_addr_reg_518;

assign dct_coeff_table_address0 = k_cast1_i_fu_208_p1;

assign grp_fu_471_p2 = ap_const_lv29_1000;

assign i_2_i1_cast_i_fu_179_p1 = i_0_i_reg_145;

assign i_fu_173_p2 = (i_0_i_reg_145 + ap_const_lv4_1);
...
assign row_outbuf_i_address0 = tmp_17_cast_fu_442_p1;

assign row_outbuf_i_d0 = tmp_1_i_reg_642;

assign tmp1_fu_418_p2 = ($signed(grp_fu_488_p3) + $signed(grp_fu_480_p3));

assign tmp4_fu_422_p2 = ($signed(tmp6_reg_637) + $signed(grp_fu_496_p3));

assign tmp_16_cast_fu_192_p1 = tmp_s_fu_184_p3;

assign tmp_17_cast_fu_442_p1 = ap_pipeline_reg_pp0_iter3_tmp_4_reg_532;

assign tmp_49_fu_222_p1 = dct_coeff_table_q0[15:0];

assign tmp_4_fu_217_p2 = (k_cast1_i_cast_fu_213_p1 + tmp_16_cast_reg_513);

assign tmp_50_fu_226_p1 = buf_2d_in_q0[15:0];

assign tmp_9_i_fu_426_p2 = (tmp4_fu_422_p2 + tmp1_fu_418_p2);

assign tmp_fu_167_p2 = ((i_0_i_reg_145 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_i_fu_196_p2 = ((k_i_reg_156 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_s_fu_184_p3 = {{i_0_i_reg_145}, {ap_const_lv3_0}};

always @ (posedge ap_clk) begin
    tmp_16_cast_reg_513[2:0] <= 3'b000;
    tmp_16_cast_reg_513[7] <= 1'b0;
end
