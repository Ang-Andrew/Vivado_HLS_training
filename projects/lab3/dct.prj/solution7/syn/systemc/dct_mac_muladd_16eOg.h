...
#ifndef __dct_mac_muladd_16eOg__HH__
#define __dct_mac_muladd_16eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mac_muladd_16eOg) {
    ...
    SC_CTOR(dct_mac_muladd_16eOg):  simcore_mac_1_U ("simcore_mac_1_U") {
