...
architecture behav of dct is 
    ...
    "dct,hls_ip_2016_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.790000,HLS_SYN_LAT=623,HLS_SYN_TPT=131,HLS_SYN_MEM=22,HLS_SYN_DSP=16,HLS_SYN_FF=1716,HLS_SYN_LUT=5141}";
    ...
    signal read_data_U0_buf_r_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal read_data_U0_buf_r_ce0 : STD_LOGIC;
    signal read_data_U0_buf_r_we0 : STD_LOGIC;
    signal read_data_U0_buf_r_d0 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_channel_done_buf_2d_in : STD_LOGIC;
    signal read_data_U0_buf_r_full_n : STD_LOGIC;
    ...
    signal Loop_Row_DCT_Loop_pr_U0_buf_2d_in_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal Loop_Row_DCT_Loop_pr_U0_buf_2d_in_ce0 : STD_LOGIC;
    ...
    signal Loop_Xpose_Row_Outer_U0_col_inbuf_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal Loop_Xpose_Row_Outer_U0_col_inbuf_ce0 : STD_LOGIC;
    signal Loop_Xpose_Row_Outer_U0_col_inbuf_we0 : STD_LOGIC;
    signal Loop_Xpose_Row_Outer_U0_col_inbuf_d0 : STD_LOGIC_VECTOR (127 downto 0);
    ...
    signal Loop_Col_DCT_Loop_pr_U0_col_inbuf_address0 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    Loop_Row_DCT_Loop_pr_U0_ap_start <= buf_2d_in_t_empty_n;
    ...
    ap_channel_done_buf_2d_in <= read_data_U0_ap_done;
    ...
    ap_idle <= (read_data_U0_ap_idle and Loop_Row_DCT_Loop_pr_U0_ap_idle and Loop_Xpose_Row_Outer_U0_ap_idle and Loop_Col_DCT_Loop_pr_U0_ap_idle and Loop_Xpose_Col_Outer_U0_ap_idle and write_data_U0_ap_idle and (buf_2d_in_t_empty_n xor ap_const_logic_1) and (row_outbuf_i_t_empty_n xor ap_const_logic_1) and (col_inbuf_t_empty_n xor ap_const_logic_1) and (col_outbuf_i_t_empty_n xor ap_const_logic_1) and (buf_2d_out_t_empty_n xor ap_const_logic_1));
    ap_ready <= read_data_U0_ap_ready;
    input_r_address0 <= read_data_U0_input_r_address0;
    ...
    read_data_U0_ap_continue <= buf_2d_in_i_full_n;
    read_data_U0_ap_start <= ap_start;
    read_data_U0_buf_r_full_n <= buf_2d_in_i_full_n;
