; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution7/.autopilot/db/a.o.bc'
...
define void @dct_1d(i16* %src, i16* %dst) nounwind {
  ...
  call void bitcast (void (...)* @_ssdm_SpecArrayReshape to void ([8 x i16]*, i32, i8*, i32, i8*)*)([8 x i16]* getelementptr inbounds ([8 x [8 x i16]]* @dct_1d.dct_coeff_table, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !73 ; [debug line = 11:1]
...
; <label>:9                                       ; preds = %6
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !76 ; [debug line = 13:67]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !76 ; [debug line = 13:67]
...
; <label>:14                                      ; preds = %11
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !81 ; [debug line = 15:78]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !81 ; [debug line = 15:78]
  ...
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !87 ; [debug line = 18:7]
...
; <label>:33                                      ; preds = %11
  ...
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !90 ; [debug line = 20:4]
...
define void @dct_2d([8 x i16]* %in_block, [8 x i16]* %out_block) nounwind {
  ...
  call void bitcast (void (...)* @_ssdm_SpecArrayReshape to void ([8 x i16]*, i32, i8*, i32, i8*)*)([8 x i16]* %5, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !108 ; [debug line = 28:1]
...
define void @dct(i16* %input, i16* %output) nounwind {
  %1 = alloca i16*, align 4                       ; [#uses=3 type=i16**]
  %2 = alloca i16*, align 4                       ; [#uses=3 type=i16**]
  %buf_2d_in = alloca [8 x [8 x i16]], align 2    ; [#uses=4 type=[8 x [8 x i16]]*]
  ...
  call void bitcast (void (...)* @_ssdm_SpecArrayReshape to void ([8 x i16]*, i32, i8*, i32, i8*)*)([8 x i16]* %5, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !225 ; [debug line = 82:1]
  %6 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !225 ; [#uses=1 type=[8 x i16]*] [debug line = 82:1]
  call void bitcast (void (...)* @_ssdm_SpecArrayReshape to void ([8 x i16]*, i32, i8*, i32, i8*)*)([8 x i16]* %6, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !225 ; [debug line = 82:1]
  ...
  %7 = load i16** %1, align 4, !dbg !228          ; [#uses=1 type=i16*] [debug line = 85:4]
  %8 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !228 ; [#uses=1 type=[8 x i16]*] [debug line = 85:4]
  call void @read_data(i16* %7, [8 x i16]* %8), !dbg !228 ; [debug line = 85:4]
  %9 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !229 ; [#uses=1 type=[8 x i16]*] [debug line = 87:4]
  %10 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 0, !dbg !229 ; [#uses=1 type=[8 x i16]*] [debug line = 87:4]
  call void @dct_2d([8 x i16]* %9, [8 x i16]* %10), !dbg !229 ; [debug line = 87:4]
  %11 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 0, !dbg !230 ; [#uses=1 type=[8 x i16]*] [debug line = 90:4]
  %12 = load i16** %2, align 4, !dbg !230         ; [#uses=1 type=i16*] [debug line = 90:4]
  call void @write_data([8 x i16]* %11, i16* %12), !dbg !230 ; [debug line = 90:4]
