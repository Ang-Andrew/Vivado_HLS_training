; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution7/.autopilot/db/a.o.3.bc'
...
.reset:                                           ; preds = %1
  ...
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str13), !dbg !51 ; [#uses=1 type=i32] [debug line = 74:2]
  ...
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str13, i32 %tmp_2), !dbg !53 ; [#uses=0 type=i32] [debug line = 74:67]
...
; <label>:1                                       ; preds = %.reset, %0
  %indvar_flatten = phi i7 [ 0, %0 ], [ %indvar_flatten_next, %.reset ] ; [#uses=2 type=i7]
  %r = phi i4 [ 0, %0 ], [ %r_cast4_mid2_v, %.reset ] ; [#uses=2 type=i4]
...
.reset:                                           ; preds = %1
  ...
  %r_cast4_mid2_v = select i1 %exitcond5, i4 %r_2, i4 %r, !dbg !64 ; [#uses=3 type=i4] [debug line = 59:9]
  %r_cast4_mid2 = zext i4 %r_cast4_mid2_v to i32, !dbg !64 ; [#uses=1 type=i32] [debug line = 59:9]
  ...
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str11), !dbg !74 ; [#uses=1 type=i32] [debug line = 62:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !75 ; [debug line = 63:1]
  %sum = add i6 %c_cast2, %tmp_mid2               ; [#uses=1 type=i6]
  %sum_cast = zext i6 %sum to i32                 ; [#uses=1 type=i32]
  %input_addr = getelementptr [64 x i16]* %input, i32 0, i32 %sum_cast, !dbg !72 ; [#uses=1 type=i16*] [debug line = 62:1]
  %input_load = load i16* %input_addr, align 2, !dbg !72 ; [#uses=1 type=i16] [debug line = 62:1]
  %buf_addr = getelementptr [8 x i128]* %buf, i32 0, i32 %r_cast4_mid2, !dbg !72 ; [#uses=2 type=i128*] [debug line = 62:1]
  %buf_load = load i128* %buf_addr, align 8, !dbg !72 ; [#uses=1 type=i128] [debug line = 62:1]
  %tmp_2 = trunc i4 %c_mid2 to i3                 ; [#uses=1 type=i3]
  %tmp_7 = call i7 @_ssdm_op_BitConcatenate.i7.i3.i4(i3 %tmp_2, i4 0), !dbg !72 ; [#uses=3 type=i7] [debug line = 62:1]
  %tmp_8 = or i7 %tmp_7, 15                       ; [#uses=2 type=i7]
  %tmp_3 = icmp ugt i7 %tmp_7, %tmp_8             ; [#uses=4 type=i1]
  %tmp_5 = zext i7 %tmp_7 to i8, !dbg !72         ; [#uses=4 type=i8] [debug line = 62:1]
  %tmp_6 = zext i7 %tmp_8 to i8, !dbg !72         ; [#uses=2 type=i8] [debug line = 62:1]
  %tmp_9 = zext i16 %input_load to i128, !dbg !72 ; [#uses=1 type=i128] [debug line = 62:1]
  %tmp_10 = xor i8 %tmp_5, 127, !dbg !72          ; [#uses=1 type=i8] [debug line = 62:1]
  %tmp_11 = select i1 %tmp_3, i8 %tmp_5, i8 %tmp_6 ; [#uses=1 type=i8]
  %tmp_12 = select i1 %tmp_3, i8 %tmp_6, i8 %tmp_5 ; [#uses=1 type=i8]
  %tmp_13 = select i1 %tmp_3, i8 %tmp_10, i8 %tmp_5 ; [#uses=1 type=i8]
  ...
  %tmp_18 = shl i128 %tmp_9, %tmp_15, !dbg !72    ; [#uses=2 type=i128] [debug line = 62:1]
  %tmp_19 = call i128 @llvm.part.select.i128(i128 %tmp_18, i32 127, i32 0), !dbg !72 ; [#uses=1 type=i128] [debug line = 62:1]
  %tmp_20 = select i1 %tmp_3, i128 %tmp_19, i128 %tmp_18 ; [#uses=1 type=i128]
  ...
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str11, i32 %tmp_4), !dbg !76 ; [#uses=0 type=i32] [debug line = 62:66]
...
.preheader2.i:                                    ; preds = %0
  ...
  %j_0_i_cast8_mid2_v = select i1 %tmp_s, i4 %j, i4 %j_0_i, !dbg !123 ; [#uses=3 type=i4] [debug line = 37:9@87:4]
  %j_0_i_cast8_mid2 = zext i4 %j_0_i_cast8_mid2_v to i32, !dbg !123 ; [#uses=1 type=i32] [debug line = 37:9@87:4]
  ...
  %tmp_7_cast = zext i7 %tmp to i8, !dbg !124     ; [#uses=1 type=i8] [debug line = 40:1@87:4]
  %tmp_8 = add i8 %tmp_7_cast, %j_0_i_cast8_mid2_cas, !dbg !124 ; [#uses=1 type=i8] [debug line = 40:1@87:4]
  %tmp_8_cast = zext i8 %tmp_8 to i32, !dbg !124  ; [#uses=1 type=i32] [debug line = 40:1@87:4]
  %row_outbuf_i_addr = getelementptr [64 x i16]* %row_outbuf_i, i32 0, i32 %tmp_8_cast, !dbg !124 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str6) nounwind, !dbg !126 ; [debug line = 40:2@87:4]
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str6) nounwind, !dbg !126 ; [#uses=1 type=i32] [debug line = 40:2@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !127 ; [debug line = 41:1@87:4]
  %row_outbuf_i_load = load i16* %row_outbuf_i_addr, align 2, !dbg !124 ; [#uses=1 type=i16] [debug line = 40:1@87:4]
  %col_inbuf_addr = getelementptr [8 x i128]* %col_inbuf, i32 0, i32 %j_0_i_cast8_mid2, !dbg !124 ; [#uses=2 type=i128*] [debug line = 40:1@87:4]
  %col_inbuf_load = load i128* %col_inbuf_addr, align 8, !dbg !124 ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_27 = trunc i4 %i_1_i_mid2 to i3            ; [#uses=1 type=i3]
  %tmp_3 = call i7 @_ssdm_op_BitConcatenate.i7.i3.i4(i3 %tmp_27, i4 0), !dbg !124 ; [#uses=3 type=i7] [debug line = 40:1@87:4]
  %tmp_4 = or i7 %tmp_3, 15                       ; [#uses=2 type=i7]
  %tmp_28 = icmp ugt i7 %tmp_3, %tmp_4            ; [#uses=4 type=i1]
  %tmp_29 = zext i7 %tmp_3 to i8, !dbg !124       ; [#uses=4 type=i8] [debug line = 40:1@87:4]
  %tmp_30 = zext i7 %tmp_4 to i8, !dbg !124       ; [#uses=2 type=i8] [debug line = 40:1@87:4]
  %tmp_31 = zext i16 %row_outbuf_i_load to i128, !dbg !124 ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_32 = xor i8 %tmp_29, 127, !dbg !124        ; [#uses=1 type=i8] [debug line = 40:1@87:4]
  ...
  %tmp_36 = xor i8 %tmp_33, 127, !dbg !124        ; [#uses=1 type=i8] [debug line = 40:1@87:4]
  %tmp_37 = zext i8 %tmp_35 to i128, !dbg !124    ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_38 = zext i8 %tmp_34 to i128, !dbg !124    ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_39 = zext i8 %tmp_36 to i128, !dbg !124    ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_40 = shl i128 %tmp_31, %tmp_37, !dbg !124  ; [#uses=2 type=i128] [debug line = 40:1@87:4]
  %tmp_41 = call i128 @llvm.part.select.i128(i128 %tmp_40, i32 127, i32 0), !dbg !124 ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_42 = select i1 %tmp_28, i128 %tmp_41, i128 %tmp_40 ; [#uses=1 type=i128]
  %tmp_43 = shl i128 -1, %tmp_38, !dbg !124       ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_44 = lshr i128 -1, %tmp_39, !dbg !124      ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %p_demorgan = and i128 %tmp_43, %tmp_44, !dbg !124 ; [#uses=2 type=i128] [debug line = 40:1@87:4]
  %tmp_45 = xor i128 %p_demorgan, -1, !dbg !124   ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_46 = and i128 %col_inbuf_load, %tmp_45, !dbg !124 ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_47 = and i128 %tmp_42, %p_demorgan, !dbg !124 ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  %tmp_48 = or i128 %tmp_46, %tmp_47, !dbg !124   ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  store i128 %tmp_48, i128* %col_inbuf_addr, align 8, !dbg !124 ; [debug line = 40:1@87:4]
  %empty_26 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str6, i32 %tmp_2) nounwind, !dbg !128 ; [#uses=0 type=i32] [debug line = 40:34@87:4]
  %i = add i4 1, %i_1_i_mid2, !dbg !129           ; [#uses=1 type=i4] [debug line = 39:63@87:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !130) nounwind, !dbg !129 ; [debug line = 39:63@87:4] [debug variable = i]
  br label %0
...
.preheader.i:                                     ; preds = %0
  %j = add i4 %j_1_i, 1, !dbg !131                ; [#uses=1 type=i4] [debug line = 48:61@87:4]
  call void @llvm.dbg.value(metadata !{i4 %j}, i64 0, metadata !118) nounwind, !dbg !131 ; [debug line = 48:61@87:4] [debug variable = j]
  call void (...)* @_ssdm_op_SpecLoopName([42 x i8]* @Xpose_Col_Outer_Loop)
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) nounwind ; [#uses=0 type=i32]
  %tmp_s = icmp eq i4 %i_3_i, -8, !dbg !133       ; [#uses=2 type=i1] [debug line = 50:11@87:4]
  %i_3_i_mid2 = select i1 %tmp_s, i4 0, i4 %i_3_i ; [#uses=3 type=i4]
  %j_1_i_cast5_mid2_v = select i1 %tmp_s, i4 %j, i4 %j_1_i, !dbg !136 ; [#uses=3 type=i4] [debug line = 48:9@87:4]
  ...
  %tmp_10_cast = zext i7 %tmp to i8, !dbg !133    ; [#uses=1 type=i8] [debug line = 50:11@87:4]
  ...
  %tmp_12_cast = zext i7 %tmp_1 to i8, !dbg !137  ; [#uses=1 type=i8] [debug line = 51:1@87:4]
  %tmp_2 = add i8 %j_1_i_cast5_mid2_cas, %tmp_12_cast, !dbg !137 ; [#uses=1 type=i8] [debug line = 51:1@87:4]
  %tmp_13_cast = zext i8 %tmp_2 to i32, !dbg !137 ; [#uses=1 type=i32] [debug line = 51:1@87:4]
  %col_outbuf_i_addr = getelementptr [64 x i16]* %col_outbuf_i, i32 0, i32 %tmp_13_cast, !dbg !137 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  %tmp_3 = add i8 %i_3_i_cast4_cast, %tmp_10_cast, !dbg !137 ; [#uses=1 type=i8] [debug line = 51:1@87:4]
  %tmp_14_cast = zext i8 %tmp_3 to i32, !dbg !137 ; [#uses=1 type=i32] [debug line = 51:1@87:4]
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i32 0, i32 %tmp_14_cast, !dbg !137 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str9) nounwind, !dbg !139 ; [debug line = 51:2@87:4]
  %tmp_6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str9) nounwind, !dbg !139 ; [#uses=1 type=i32] [debug line = 51:2@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !140 ; [debug line = 52:1@87:4]
  %col_outbuf_i_load = load i16* %col_outbuf_i_addr, align 2, !dbg !137 ; [#uses=1 type=i16] [debug line = 51:1@87:4]
  store i16 %col_outbuf_i_load, i16* %buf_2d_out_addr, align 2, !dbg !137 ; [debug line = 51:1@87:4]
  %empty_27 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str9, i32 %tmp_6) nounwind, !dbg !141 ; [#uses=0 type=i32] [debug line = 51:34@87:4]
  %i = add i4 %i_3_i_mid2, 1, !dbg !142           ; [#uses=1 type=i4] [debug line = 50:63@87:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !130) nounwind, !dbg !142 ; [debug line = 50:63@87:4] [debug variable = i]
  br label %0
...
newFuncRoot:
  br label %dct_1d.exit, !dbg !143                ; [debug line = 32:8@87:4]
...
dct_1d.exit:                                      ; preds = %dct_1d.exit.loopexit, %newFuncRoot
  ...
  %tmp = icmp eq i4 %i_0_i, -8, !dbg !143         ; [#uses=1 type=i1] [debug line = 32:8@87:4]
  %i = add i4 %i_0_i, 1, !dbg !145                ; [#uses=1 type=i4] [debug line = 32:60@87:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !130) nounwind, !dbg !145 ; [debug line = 32:60@87:4] [debug variable = i]
  br i1 %tmp, label %.preheader2.i.exitStub, label %0, !dbg !143 ; [debug line = 32:8@87:4]

; <label>:0                                       ; preds = %dct_1d.exit
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @p_str4) nounwind, !dbg !146 ; [debug line = 32:66@87:4]
  %i_2_i1_cast_i = zext i4 %i_0_i to i32          ; [#uses=1 type=i32]
  %tmp_s = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_0_i, i3 0) ; [#uses=1 type=i7]
  %tmp_16_cast = zext i7 %tmp_s to i8, !dbg !148  ; [#uses=1 type=i8] [debug line = 4:24]
  call void @llvm.dbg.value(metadata !{[8 x i128]* %buf_2d_in}, i64 0, metadata !153) nounwind, !dbg !148 ; [debug line = 4:24] [debug variable = src]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %row_outbuf_i}, i64 0, metadata !155) nounwind, !dbg !156 ; [debug line = 4:81] [debug variable = dst]
  %buf_2d_in_addr = getelementptr [8 x i128]* %buf_2d_in, i32 0, i32 %i_2_i1_cast_i, !dbg !157 ; [#uses=1 type=i128*] [debug line = 17:10]
  br label %1, !dbg !163                          ; [debug line = 13:9]

; <label>:1                                       ; preds = %2, %0
  %k_i = phi i4 [ 0, %0 ], [ %k, %2 ]             ; [#uses=4 type=i4]
  %tmp_i = icmp eq i4 %k_i, -8, !dbg !163         ; [#uses=1 type=i1] [debug line = 13:9]
  %k = add i4 %k_i, 1, !dbg !164                  ; [#uses=1 type=i4] [debug line = 13:61]
  br i1 %tmp_i, label %dct_1d.exit.loopexit, label %2, !dbg !163 ; [debug line = 13:9]

; <label>:2                                       ; preds = %1
  %k_cast1_i = zext i4 %k_i to i32, !dbg !163     ; [#uses=1 type=i32] [debug line = 13:9]
  %k_cast1_i_cast = zext i4 %k_i to i8, !dbg !165 ; [#uses=1 type=i8] [debug line = 19:7]
  %tmp_4 = add i8 %k_cast1_i_cast, %tmp_16_cast, !dbg !165 ; [#uses=1 type=i8] [debug line = 19:7]
  %tmp_17_cast = zext i8 %tmp_4 to i32, !dbg !165 ; [#uses=1 type=i32] [debug line = 19:7]
  %row_outbuf_i_addr = getelementptr [64 x i16]* %row_outbuf_i, i32 0, i32 %tmp_17_cast, !dbg !165 ; [#uses=1 type=i16*] [debug line = 19:7]
  %empty_28 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str2) nounwind, !dbg !166 ; [debug line = 13:67]
  %tmp_2_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str2) nounwind, !dbg !166 ; [#uses=1 type=i32] [debug line = 13:67]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !167 ; [debug line = 14:1]
  %dct_coeff_table_addr = getelementptr [8 x i127]* @dct_coeff_table, i32 0, i32 %k_cast1_i, !dbg !168 ; [#uses=1 type=i127*] [debug line = 16:48]
  %dct_coeff_table_load = load i127* %dct_coeff_table_addr, align 16, !dbg !168 ; [#uses=8 type=i127] [debug line = 16:48]
  %tmp_49 = trunc i127 %dct_coeff_table_load to i16, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_cast_i = sext i16 %tmp_49 to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %buf_2d_in_load = load i128* %buf_2d_in_addr, align 8, !dbg !157 ; [#uses=8 type=i128] [debug line = 17:10]
  %tmp_50 = trunc i128 %buf_2d_in_load to i16, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_cast_i = sext i16 %tmp_50 to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_i = mul i29 %coeff_cast_i, %tmp_2_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_6_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 16, i32 31) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_1_cast_i = sext i16 %tmp_6_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 16, i9 31) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_1_cast_i = sext i16 %tmp_7_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_1_i = mul i29 %coeff_1_cast_i, %tmp_2_1_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_8_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 32, i32 47) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_2_cast_i = sext i16 %tmp_8_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_10_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 32, i9 47) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_2_cast_i = sext i16 %tmp_10_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_2_i = mul i29 %coeff_2_cast_i, %tmp_2_2_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_11_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 48, i32 63) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_3_cast_i = sext i16 %tmp_11_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_12_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 48, i9 63) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_3_cast_i = sext i16 %tmp_12_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_3_i = mul i29 %coeff_3_cast_i, %tmp_2_3_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_13_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 64, i32 79) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_4_cast_i = sext i16 %tmp_13_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_14_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 64, i9 79) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_4_cast_i = sext i16 %tmp_14_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_4_i = mul i29 %coeff_4_cast_i, %tmp_2_4_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_15_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 80, i32 95) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_5_cast_i = sext i16 %tmp_15_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_16_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 80, i9 95) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_5_cast_i = sext i16 %tmp_16_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_5_i = mul i29 %coeff_5_cast_i, %tmp_2_5_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_17_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 96, i32 111) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_6_cast_i = sext i16 %tmp_17_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_18_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 96, i9 111) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_6_cast_i = sext i16 %tmp_18_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_6_i = mul i29 %coeff_6_cast_i, %tmp_2_6_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_1 = call i15 @_ssdm_op_PartSelect.i15.i127.i32.i32(i127 %dct_coeff_table_load, i32 112, i32 126) nounwind, !dbg !168 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_7_cast_i = sext i15 %tmp_1 to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_20_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 112, i9 127) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_7_cast_i = sext i16 %tmp_20_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_7_i = mul i29 %tmp_2_7_cast_i, %coeff_7_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp2 = add i29 %tmp_3_i, %tmp_3_1_i, !dbg !165 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp3 = add i29 %tmp_3_2_i, %tmp_3_3_i, !dbg !165 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp1 = add i29 %tmp3, %tmp2, !dbg !165         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp5 = add i29 %tmp_3_4_i, %tmp_3_5_i, !dbg !165 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp7 = add i29 4096, %tmp_3_7_i, !dbg !165     ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp6 = add i29 %tmp7, %tmp_3_6_i, !dbg !165    ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp4 = add i29 %tmp6, %tmp5, !dbg !165         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp_9_i = add i29 %tmp4, %tmp1, !dbg !165      ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp_1_i = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_9_i, i32 13, i32 28), !dbg !165 ; [#uses=1 type=i16] [debug line = 19:7]
  store i16 %tmp_1_i, i16* %row_outbuf_i_addr, align 2, !dbg !165 ; [debug line = 19:7]
  %empty_29 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str2, i32 %tmp_2_i) nounwind, !dbg !169 ; [#uses=0 type=i32] [debug line = 20:4]
  call void @llvm.dbg.value(metadata !{i4 %k}, i64 0, metadata !170) nounwind, !dbg !164 ; [debug line = 13:61] [debug variable = k]
  br label %1, !dbg !164                          ; [debug line = 13:61]
}
...
.preheader1.i:                                    ; preds = %.preheader1.i.loopexit, %newFuncRoot
  ...
  %tmp_5 = icmp eq i4 %i_2_i, -8, !dbg !171       ; [#uses=1 type=i1] [debug line = 43:9@87:4]
  %i = add i4 %i_2_i, 1, !dbg !173                ; [#uses=1 type=i4] [debug line = 43:61@87:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !130) nounwind, !dbg !173 ; [debug line = 43:61@87:4] [debug variable = i]
  br i1 %tmp_5, label %.preheader.i.exitStub, label %0, !dbg !171 ; [debug line = 43:9@87:4]

; <label>:0                                       ; preds = %.preheader1.i
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @p_str7) nounwind, !dbg !174 ; [debug line = 43:67@87:4]
  %i_2_i1_cast_i = zext i4 %i_2_i to i32          ; [#uses=1 type=i32]
  %tmp_s = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_2_i, i3 0) ; [#uses=1 type=i7]
  %tmp_19_cast = zext i7 %tmp_s to i8, !dbg !148  ; [#uses=1 type=i8] [debug line = 4:24]
  call void @llvm.dbg.value(metadata !{[8 x i128]* %col_inbuf}, i64 0, metadata !153) nounwind, !dbg !148 ; [debug line = 4:24] [debug variable = src]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %col_outbuf_i}, i64 0, metadata !155) nounwind, !dbg !156 ; [debug line = 4:81] [debug variable = dst]
  %col_inbuf_addr = getelementptr [8 x i128]* %col_inbuf, i32 0, i32 %i_2_i1_cast_i, !dbg !157 ; [#uses=1 type=i128*] [debug line = 17:10]
  br label %1, !dbg !163                          ; [debug line = 13:9]
...
; <label>:1                                       ; preds = %2, %0
  ...
  %tmp_i = icmp eq i4 %k_i, -8, !dbg !163         ; [#uses=1 type=i1] [debug line = 13:9]
  %k = add i4 %k_i, 1, !dbg !164                  ; [#uses=1 type=i4] [debug line = 13:61]
  br i1 %tmp_i, label %.preheader1.i.loopexit, label %2, !dbg !163 ; [debug line = 13:9]

; <label>:2                                       ; preds = %1
  %k_cast1_i = zext i4 %k_i to i32, !dbg !163     ; [#uses=1 type=i32] [debug line = 13:9]
  %k_cast1_i_cast = zext i4 %k_i to i8, !dbg !165 ; [#uses=1 type=i8] [debug line = 19:7]
  %tmp_6 = add i8 %k_cast1_i_cast, %tmp_19_cast, !dbg !165 ; [#uses=1 type=i8] [debug line = 19:7]
  %tmp_20_cast = zext i8 %tmp_6 to i32, !dbg !165 ; [#uses=1 type=i32] [debug line = 19:7]
  %col_outbuf_i_addr = getelementptr [64 x i16]* %col_outbuf_i, i32 0, i32 %tmp_20_cast, !dbg !165 ; [#uses=1 type=i16*] [debug line = 19:7]
  ...
  %dct_coeff_table_addr = getelementptr [8 x i127]* @dct_coeff_table, i32 0, i32 %k_cast1_i, !dbg !168 ; [#uses=1 type=i127*] [debug line = 16:48]
  %dct_coeff_table_load = load i127* %dct_coeff_table_addr, align 16, !dbg !168 ; [#uses=8 type=i127] [debug line = 16:48]
  %tmp_51 = trunc i127 %dct_coeff_table_load to i16, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_cast_i = sext i16 %tmp_51 to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %col_inbuf_load = load i128* %col_inbuf_addr, align 8, !dbg !157 ; [#uses=8 type=i128] [debug line = 17:10]
  %tmp_52 = trunc i128 %col_inbuf_load to i16, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_cast_i = sext i16 %tmp_52 to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_i = mul i29 %coeff_cast_i, %tmp_2_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_6_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 16, i32 31) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_1_cast_i = sext i16 %tmp_6_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_7_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 16, i9 31) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_1_cast_i = sext i16 %tmp_7_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_1_i = mul i29 %coeff_1_cast_i, %tmp_2_1_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_8_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 32, i32 47) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_2_cast_i = sext i16 %tmp_8_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_10_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 32, i9 47) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_2_cast_i = sext i16 %tmp_10_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_2_i = mul i29 %coeff_2_cast_i, %tmp_2_2_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_11_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 48, i32 63) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_3_cast_i = sext i16 %tmp_11_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_12_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 48, i9 63) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_3_cast_i = sext i16 %tmp_12_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_3_i = mul i29 %coeff_3_cast_i, %tmp_2_3_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_13_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 64, i32 79) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_4_cast_i = sext i16 %tmp_13_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_14_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 64, i9 79) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_4_cast_i = sext i16 %tmp_14_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_4_i = mul i29 %coeff_4_cast_i, %tmp_2_4_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_15_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 80, i32 95) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_5_cast_i = sext i16 %tmp_15_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_16_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 80, i9 95) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_5_cast_i = sext i16 %tmp_16_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_5_i = mul i29 %coeff_5_cast_i, %tmp_2_5_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_17_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 96, i32 111) nounwind, !dbg !168 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff_6_cast_i = sext i16 %tmp_17_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_18_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 96, i9 111) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_6_cast_i = sext i16 %tmp_18_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_6_i = mul i29 %coeff_6_cast_i, %tmp_2_6_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_2 = call i15 @_ssdm_op_PartSelect.i15.i127.i32.i32(i127 %dct_coeff_table_load, i32 112, i32 126) nounwind, !dbg !168 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_7_cast_i = sext i15 %tmp_2 to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_20_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 112, i9 127) nounwind, !dbg !157 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_2_7_cast_i = sext i16 %tmp_20_i to i29, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp_3_7_i = mul i29 %tmp_2_7_cast_i, %coeff_7_cast_i, !dbg !157 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp1 = add i29 %tmp_3_i, %tmp_3_1_i, !dbg !165 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp2 = add i29 %tmp_3_2_i, %tmp_3_3_i, !dbg !165 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp = add i29 %tmp2, %tmp1, !dbg !165          ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp4 = add i29 %tmp_3_4_i, %tmp_3_5_i, !dbg !165 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp6 = add i29 4096, %tmp_3_7_i, !dbg !165     ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp5 = add i29 %tmp6, %tmp_3_6_i, !dbg !165    ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp3 = add i29 %tmp5, %tmp4, !dbg !165         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp_9_i = add i29 %tmp3, %tmp, !dbg !165       ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp_1_i = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_9_i, i32 13, i32 28), !dbg !165 ; [#uses=1 type=i16] [debug line = 19:7]
  store i16 %tmp_1_i, i16* %col_outbuf_i_addr, align 2, !dbg !165 ; [debug line = 19:7]
  %empty_31 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str2, i32 %tmp_2_i) nounwind, !dbg !169 ; [#uses=0 type=i32] [debug line = 20:4]
  call void @llvm.dbg.value(metadata !{i4 %k}, i64 0, metadata !170) nounwind, !dbg !164 ; [debug line = 13:61] [debug variable = k]
  br label %1, !dbg !164                          ; [debug line = 13:61]
}
...
!123 = metadata !{i32 37, i32 9, metadata !117, metadata !109}
!124 = metadata !{i32 40, i32 1, metadata !125, metadata !109}
!125 = metadata !{i32 786443, metadata !121, i32 40, i32 1, metadata !21, i32 11} ; [ DW_TAG_lexical_block ]
!126 = metadata !{i32 40, i32 2, metadata !125, metadata !109}
!127 = metadata !{i32 41, i32 1, metadata !125, metadata !109}
!128 = metadata !{i32 40, i32 34, metadata !125, metadata !109}
!129 = metadata !{i32 39, i32 63, metadata !121, metadata !109}
!130 = metadata !{i32 786688, metadata !100, metadata !"i", metadata !21, i32 28, metadata !119, i32 0, metadata !109} ; [ DW_TAG_auto_variable ]
!131 = metadata !{i32 48, i32 61, metadata !132, metadata !109}
!132 = metadata !{i32 786443, metadata !100, i32 48, i32 4, metadata !21, i32 14} ; [ DW_TAG_lexical_block ]
!133 = metadata !{i32 50, i32 11, metadata !134, metadata !109}
!134 = metadata !{i32 786443, metadata !135, i32 50, i32 7, metadata !21, i32 16} ; [ DW_TAG_lexical_block ]
!135 = metadata !{i32 786443, metadata !132, i32 49, i32 1, metadata !21, i32 15} ; [ DW_TAG_lexical_block ]
!136 = metadata !{i32 48, i32 9, metadata !132, metadata !109}
!137 = metadata !{i32 51, i32 1, metadata !138, metadata !109}
!138 = metadata !{i32 786443, metadata !134, i32 51, i32 1, metadata !21, i32 17} ; [ DW_TAG_lexical_block ]
!139 = metadata !{i32 51, i32 2, metadata !138, metadata !109}
!140 = metadata !{i32 52, i32 1, metadata !138, metadata !109}
!141 = metadata !{i32 51, i32 34, metadata !138, metadata !109}
!142 = metadata !{i32 50, i32 63, metadata !134, metadata !109}
!143 = metadata !{i32 32, i32 8, metadata !144, metadata !109}
!144 = metadata !{i32 786443, metadata !100, i32 32, i32 4, metadata !21, i32 6} ; [ DW_TAG_lexical_block ]
!145 = metadata !{i32 32, i32 60, metadata !144, metadata !109}
!146 = metadata !{i32 32, i32 66, metadata !147, metadata !109}
!147 = metadata !{i32 786443, metadata !144, i32 32, i32 65, metadata !21, i32 7} ; [ DW_TAG_lexical_block ]
!148 = metadata !{i32 4, i32 24, metadata !149, null}
!149 = metadata !{i32 786478, i32 0, metadata !21, metadata !"dct_1d", metadata !"dct_1d", metadata !"", metadata !21, i32 4, metadata !150, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !30, i32 5} ; [ DW_TAG_subprogram ]
!150 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !151, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!151 = metadata !{null, metadata !152, metadata !152}
!152 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !106} ; [ DW_TAG_pointer_type ]
!153 = metadata !{i32 786689, metadata !149, metadata !"src", null, i32 4, metadata !154, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!154 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !106, metadata !27, i32 0, i32 0} ; [ DW_TAG_array_type ]
!155 = metadata !{i32 786689, metadata !149, metadata !"dst", null, i32 4, metadata !154, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!156 = metadata !{i32 4, i32 81, metadata !149, null}
!157 = metadata !{i32 17, i32 10, metadata !158, null}
!158 = metadata !{i32 786443, metadata !159, i32 15, i32 77, metadata !21, i32 4} ; [ DW_TAG_lexical_block ]
!159 = metadata !{i32 786443, metadata !160, i32 15, i32 7, metadata !21, i32 3} ; [ DW_TAG_lexical_block ]
!160 = metadata !{i32 786443, metadata !161, i32 13, i32 66, metadata !21, i32 2} ; [ DW_TAG_lexical_block ]
!161 = metadata !{i32 786443, metadata !162, i32 13, i32 4, metadata !21, i32 1} ; [ DW_TAG_lexical_block ]
!162 = metadata !{i32 786443, metadata !149, i32 5, i32 1, metadata !21, i32 0} ; [ DW_TAG_lexical_block ]
!163 = metadata !{i32 13, i32 9, metadata !161, null}
!164 = metadata !{i32 13, i32 61, metadata !161, null}
!165 = metadata !{i32 19, i32 7, metadata !160, null}
!166 = metadata !{i32 13, i32 67, metadata !160, null}
!167 = metadata !{i32 14, i32 1, metadata !160, null}
!168 = metadata !{i32 16, i32 48, metadata !158, null}
!169 = metadata !{i32 20, i32 4, metadata !160, null}
!170 = metadata !{i32 786688, metadata !162, metadata !"k", metadata !21, i32 6, metadata !119, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!171 = metadata !{i32 43, i32 9, metadata !172, metadata !109}
!172 = metadata !{i32 786443, metadata !100, i32 43, i32 4, metadata !21, i32 12} ; [ DW_TAG_lexical_block ]
!173 = metadata !{i32 43, i32 61, metadata !172, metadata !109}
!174 = metadata !{i32 43, i32 67, metadata !175, metadata !109}
!175 = metadata !{i32 786443, metadata !172, i32 43, i32 66, metadata !21, i32 13} ; [ DW_TAG_lexical_block ]
