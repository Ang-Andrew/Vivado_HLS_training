...
.reset:                                           ; preds = %1
  ...
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str13, i32 %tmp_2)
  %c_1 = add i4 1, %c_mid2
  br label %1
...
; <label>:1                                       ; preds = %0, %.reset
  %indvar_flatten = phi i7 [ 0, %0 ], [ %indvar_flatten_next, %.reset ]
  %r = phi i4 [ 0, %0 ], [ %r_cast4_mid2_v, %.reset ]
...
.reset:                                           ; preds = %1
  ...
  %r_cast4_mid2_v = select i1 %exitcond5, i4 %r_2, i4 %r
  %r_cast4_mid2 = zext i4 %r_cast4_mid2_v to i32
  %tmp = trunc i4 %r_cast4_mid2_v to i3
  ...
  %buf_addr = getelementptr [8 x i128]* %buf_r, i32 0, i32 %r_cast4_mid2
  %buf_load = load i128* %buf_addr, align 8
  %tmp_2 = trunc i4 %c_mid2 to i3
  %tmp_7 = call i7 @_ssdm_op_BitConcatenate.i7.i3.i4(i3 %tmp_2, i4 0)
  %tmp_8 = or i7 %tmp_7, 15
  %tmp_3 = icmp ugt i7 %tmp_7, %tmp_8
  %tmp_5 = zext i7 %tmp_7 to i8
  %tmp_6 = zext i7 %tmp_8 to i8
  %tmp_9 = zext i16 %input_load to i128
  %tmp_10 = xor i8 %tmp_5, 127
  %tmp_11 = select i1 %tmp_3, i8 %tmp_5, i8 %tmp_6
  %tmp_12 = select i1 %tmp_3, i8 %tmp_6, i8 %tmp_5
  %tmp_13 = select i1 %tmp_3, i8 %tmp_10, i8 %tmp_5
  %tmp_14 = xor i8 %tmp_11, 127
  %tmp_15 = zext i8 %tmp_13 to i128
  %tmp_16 = zext i8 %tmp_12 to i128
  %tmp_17 = zext i8 %tmp_14 to i128
  %tmp_18 = shl i128 %tmp_9, %tmp_15
  %tmp_19 = call i128 @llvm.part.select.i128(i128 %tmp_18, i32 127, i32 0)
  %tmp_20 = select i1 %tmp_3, i128 %tmp_19, i128 %tmp_18
  ...
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str11, i32 %tmp_4)
  %c_2 = add i4 1, %c_mid2
  br label %1
...
.preheader2.i:                                    ; preds = %0
  ...
  %j_0_i_cast8_mid2 = zext i4 %j_0_i_cast8_mid2_v to i32
  %j_0_i_cast8_mid2_cas = zext i4 %j_0_i_cast8_mid2_v to i8
  %tmp = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1_i_mid2, i3 0)
  %tmp_7_cast = zext i7 %tmp to i8
  %tmp_8 = add i8 %tmp_7_cast, %j_0_i_cast8_mid2_cas
  %tmp_8_cast = zext i8 %tmp_8 to i32
  %row_outbuf_i_addr = getelementptr [64 x i16]* %row_outbuf_i, i32 0, i32 %tmp_8_cast
  ...
  %col_inbuf_addr = getelementptr [8 x i128]* %col_inbuf, i32 0, i32 %j_0_i_cast8_mid2
...
.preheader.i:                                     ; preds = %0
  ...
  %tmp_10_cast = zext i7 %tmp to i8
  %i_3_i_cast4_cast = zext i4 %i_3_i_mid2 to i8
  %tmp_1 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3_i_mid2, i3 0)
  %tmp_12_cast = zext i7 %tmp_1 to i8
  %tmp_2 = add i8 %j_1_i_cast5_mid2_cas, %tmp_12_cast
  %tmp_13_cast = zext i8 %tmp_2 to i32
  %col_outbuf_i_addr = getelementptr [64 x i16]* %col_outbuf_i, i32 0, i32 %tmp_13_cast
  %tmp_3 = add i8 %i_3_i_cast4_cast, %tmp_10_cast
  %tmp_14_cast = zext i8 %tmp_3 to i32
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i32 0, i32 %tmp_14_cast
...
; <label>:0                                       ; preds = %dct_1d.exit
  ...
  %tmp_16_cast = zext i7 %tmp_s to i8
  %buf_2d_in_addr = getelementptr [8 x i128]* %buf_2d_in, i32 0, i32 %i_2_i1_cast_i
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_4 = add i8 %k_cast1_i_cast, %tmp_16_cast
  %tmp_17_cast = zext i8 %tmp_4 to i32
  %row_outbuf_i_addr = getelementptr [64 x i16]* %row_outbuf_i, i32 0, i32 %tmp_17_cast
  ...
  %tmp_2_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str2) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %dct_coeff_table_addr = getelementptr [8 x i127]* @dct_coeff_table, i32 0, i32 %k_cast1_i
  ...
  %tmp_2_cast_i = sext i16 %tmp_50 to i29
  %tmp_3_i = mul i29 %coeff_cast_i, %tmp_2_cast_i
  %tmp_6_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 16, i32 31) nounwind
  %coeff_1_cast_i = sext i16 %tmp_6_i to i29
  %tmp_7_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 16, i9 31) nounwind
  %tmp_2_1_cast_i = sext i16 %tmp_7_i to i29
  %tmp_3_1_i = mul i29 %coeff_1_cast_i, %tmp_2_1_cast_i
  %tmp_8_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 32, i32 47) nounwind
  %coeff_2_cast_i = sext i16 %tmp_8_i to i29
  %tmp_10_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 32, i9 47) nounwind
  %tmp_2_2_cast_i = sext i16 %tmp_10_i to i29
  %tmp_3_2_i = mul i29 %coeff_2_cast_i, %tmp_2_2_cast_i
  %tmp_11_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 48, i32 63) nounwind
  %coeff_3_cast_i = sext i16 %tmp_11_i to i29
  %tmp_12_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 48, i9 63) nounwind
  %tmp_2_3_cast_i = sext i16 %tmp_12_i to i29
  %tmp_3_3_i = mul i29 %coeff_3_cast_i, %tmp_2_3_cast_i
  %tmp_13_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 64, i32 79) nounwind
  %coeff_4_cast_i = sext i16 %tmp_13_i to i29
  %tmp_14_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 64, i9 79) nounwind
  %tmp_2_4_cast_i = sext i16 %tmp_14_i to i29
  %tmp_3_4_i = mul i29 %coeff_4_cast_i, %tmp_2_4_cast_i
  %tmp_15_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 80, i32 95) nounwind
  %coeff_5_cast_i = sext i16 %tmp_15_i to i29
  %tmp_16_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 80, i9 95) nounwind
  %tmp_2_5_cast_i = sext i16 %tmp_16_i to i29
  %tmp_3_5_i = mul i29 %coeff_5_cast_i, %tmp_2_5_cast_i
  %tmp_17_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 96, i32 111) nounwind
  %coeff_6_cast_i = sext i16 %tmp_17_i to i29
  %tmp_18_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 96, i9 111) nounwind
  %tmp_2_6_cast_i = sext i16 %tmp_18_i to i29
  ...
  %tmp_20_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in_load, i9 112, i9 127) nounwind
  %tmp_2_7_cast_i = sext i16 %tmp_20_i to i29
  %tmp_3_7_i = mul i29 %tmp_2_7_cast_i, %coeff_7_cast_i
  %tmp2 = add i29 %tmp_3_i, %tmp_3_1_i
  %tmp3 = add i29 %tmp_3_2_i, %tmp_3_3_i
  %tmp1 = add i29 %tmp3, %tmp2
  %tmp5 = add i29 %tmp_3_4_i, %tmp_3_5_i
  %tmp7 = add i29 4096, %tmp_3_7_i
  %tmp6 = add i29 %tmp7, %tmp_3_6_i
  %tmp4 = add i29 %tmp6, %tmp5
  %tmp_9_i = add i29 %tmp4, %tmp1
  ...
  %empty_29 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str2, i32 %tmp_2_i) nounwind
  br label %1
}
...
; <label>:0                                       ; preds = %.preheader1.i
  ...
  %col_inbuf_addr = getelementptr [8 x i128]* %col_inbuf, i32 0, i32 %i_2_i1_cast_i
  br label %1
...
; <label>:2                                       ; preds = %1
  %k_cast1_i = zext i4 %k_i to i32
  %k_cast1_i_cast = zext i4 %k_i to i8
  %tmp_6 = add i8 %k_cast1_i_cast, %tmp_19_cast
  %tmp_20_cast = zext i8 %tmp_6 to i32
  %col_outbuf_i_addr = getelementptr [64 x i16]* %col_outbuf_i, i32 0, i32 %tmp_20_cast
  ...
  %tmp_2_cast_i = sext i16 %tmp_52 to i29
  %tmp_3_i = mul i29 %coeff_cast_i, %tmp_2_cast_i
  %tmp_6_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 16, i32 31) nounwind
  %coeff_1_cast_i = sext i16 %tmp_6_i to i29
  %tmp_7_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 16, i9 31) nounwind
  %tmp_2_1_cast_i = sext i16 %tmp_7_i to i29
  %tmp_3_1_i = mul i29 %coeff_1_cast_i, %tmp_2_1_cast_i
  %tmp_8_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 32, i32 47) nounwind
  %coeff_2_cast_i = sext i16 %tmp_8_i to i29
  %tmp_10_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 32, i9 47) nounwind
  %tmp_2_2_cast_i = sext i16 %tmp_10_i to i29
  %tmp_3_2_i = mul i29 %coeff_2_cast_i, %tmp_2_2_cast_i
  %tmp_11_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 48, i32 63) nounwind
  %coeff_3_cast_i = sext i16 %tmp_11_i to i29
  %tmp_12_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 48, i9 63) nounwind
  %tmp_2_3_cast_i = sext i16 %tmp_12_i to i29
  %tmp_3_3_i = mul i29 %coeff_3_cast_i, %tmp_2_3_cast_i
  %tmp_13_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 64, i32 79) nounwind
  %coeff_4_cast_i = sext i16 %tmp_13_i to i29
  %tmp_14_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 64, i9 79) nounwind
  %tmp_2_4_cast_i = sext i16 %tmp_14_i to i29
  %tmp_3_4_i = mul i29 %coeff_4_cast_i, %tmp_2_4_cast_i
  %tmp_15_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 80, i32 95) nounwind
  %coeff_5_cast_i = sext i16 %tmp_15_i to i29
  %tmp_16_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 80, i9 95) nounwind
  %tmp_2_5_cast_i = sext i16 %tmp_16_i to i29
  %tmp_3_5_i = mul i29 %coeff_5_cast_i, %tmp_2_5_cast_i
  %tmp_17_i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table_load, i32 96, i32 111) nounwind
  %coeff_6_cast_i = sext i16 %tmp_17_i to i29
  %tmp_18_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 96, i9 111) nounwind
  %tmp_2_6_cast_i = sext i16 %tmp_18_i to i29
  %tmp_3_6_i = mul i29 %coeff_6_cast_i, %tmp_2_6_cast_i
  ...
  %tmp_20_i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf_load, i9 112, i9 127) nounwind
  %tmp_2_7_cast_i = sext i16 %tmp_20_i to i29
  %tmp_3_7_i = mul i29 %tmp_2_7_cast_i, %coeff_7_cast_i
  %tmp1 = add i29 %tmp_3_i, %tmp_3_1_i
  %tmp2 = add i29 %tmp_3_2_i, %tmp_3_3_i
  %tmp = add i29 %tmp2, %tmp1
  %tmp4 = add i29 %tmp_3_4_i, %tmp_3_5_i
  %tmp6 = add i29 4096, %tmp_3_7_i
  %tmp5 = add i29 %tmp6, %tmp_3_6_i
  %tmp3 = add i29 %tmp5, %tmp4
  %tmp_9_i = add i29 %tmp3, %tmp
  %tmp_1_i = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_9_i, i32 13, i32 28)
  store i16 %tmp_1_i, i16* %col_outbuf_i_addr, align 2
  %empty_31 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str2, i32 %tmp_2_i) nounwind
  br label %1
}
