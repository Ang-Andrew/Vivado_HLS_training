...
set C_modelArgList {
	...
	{ col_inbuf int 128 regular {array 8 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "row_outbuf_i", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "col_inbuf", "interface" : "memory", "bitwidth" : 128, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ col_inbuf_address0 sc_out sc_lv 3 signal 1 } 
	{ col_inbuf_ce0 sc_out sc_logic 1 signal 1 } 
	{ col_inbuf_we0 sc_out sc_logic 1 signal 1 } 
	{ col_inbuf_d0 sc_out sc_lv 128 signal 1 } 
	{ col_inbuf_q0 sc_in sc_lv 128 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "col_inbuf_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "col_inbuf", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"ControlExist" : "1",
		"Port" : [
		{"Name" : "row_outbuf_i", "Type" : "Memory", "Direction" : "I"},
		{"Name" : "col_inbuf", "Type" : "Memory", "Direction" : "IO"}]}]}
...
set Spec2ImplPortList { 
	...
	col_inbuf { ap_memory {  { col_inbuf_address0 mem_address 1 3 }  { col_inbuf_ce0 mem_ce 1 1 }  { col_inbuf_we0 mem_we 1 1 }  { col_inbuf_d0 mem_din 1 128 }  { col_inbuf_q0 mem_dout 0 128 } } }
}
