; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution7/.autopilot/db/a.o.2.bc'
...
; <label>:1                                       ; preds = %8, %0
  ...
  %r.cast8 = zext i4 %r to i32, !dbg !48          ; [#uses=1 type=i32] [debug line = 71:9]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12), !dbg !51 ; [#uses=1 type=i32] [debug line = 71:67]
  %tmp = shl i6 %r.cast7, 3, !dbg !53             ; [#uses=1 type=i6] [debug line = 74:1]
...
; <label>:4                                       ; preds = %6, %3
  ...
  %c.cast5 = zext i4 %c to i32, !dbg !56          ; [#uses=1 type=i32] [debug line = 73:12]
...
; <label>:6                                       ; preds = %4
  ...
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str13), !dbg !57 ; [#uses=1 type=i32] [debug line = 74:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !58 ; [debug line = 75:1]
  %buf.addr = getelementptr [8 x [8 x i16]]* %buf, i32 0, i32 %r.cast8, i32 %c.cast5, !dbg !53 ; [#uses=1 type=i16*] [debug line = 74:1]
  ...
  %output.addr = getelementptr [64 x i16]* %output, i32 0, i32 %sum3.cast, !dbg !53 ; [#uses=1 type=i16*] [debug line = 74:1]
  store i16 %buf.load, i16* %output.addr, align 2, !dbg !53 ; [debug line = 74:1]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str13, i32 %tmp.2), !dbg !59 ; [#uses=0 type=i32] [debug line = 74:67]
...
; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp.1), !dbg !63 ; [#uses=0 type=i32] [debug line = 75:4]
...
; <label>:1                                       ; preds = %8, %0
  ...
  %r.cast4 = zext i4 %r to i32, !dbg !74          ; [#uses=1 type=i32] [debug line = 59:9]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10), !dbg !77 ; [#uses=1 type=i32] [debug line = 59:67]
  %tmp = shl i6 %r.cast3, 3, !dbg !79             ; [#uses=1 type=i6] [debug line = 62:1]
  %buf.addr = getelementptr [8 x i128]* %buf, i32 0, i32 %r.cast4, !dbg !79 ; [#uses=2 type=i128*] [debug line = 62:1]
...
; <label>:6                                       ; preds = %4
  ...
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str11), !dbg !83 ; [#uses=1 type=i32] [debug line = 62:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !84 ; [debug line = 63:1]
  %sum = add i6 %c.cast2, %tmp                    ; [#uses=1 type=i6]
  %sum.cast = zext i6 %sum to i32                 ; [#uses=1 type=i32]
  %input.addr = getelementptr [64 x i16]* %input, i32 0, i32 %sum.cast, !dbg !79 ; [#uses=1 type=i16*] [debug line = 62:1]
  ...
  %tmp.6.cast = zext i4 %c to i7, !dbg !79        ; [#uses=1 type=i7] [debug line = 62:1]
  %tmp.7 = shl i7 %tmp.6.cast, 4, !dbg !79        ; [#uses=2 type=i7] [debug line = 62:1]
  %tmp.7.cast = zext i7 %tmp.7 to i9, !dbg !79    ; [#uses=1 type=i9] [debug line = 62:1]
  %tmp.8 = or i7 %tmp.7, 15                       ; [#uses=1 type=i7]
  %tmp.8.cast = zext i7 %tmp.8 to i9              ; [#uses=1 type=i9]
  %tmp.9 = call i128 @_ssdm_op_PartSet.i128.i128.i16.i9.i9(i128 %buf.load, i16 %input.load, i9 %tmp.7.cast, i9 %tmp.8.cast), !dbg !79 ; [#uses=1 type=i128] [debug line = 62:1]
  store i128 %tmp.9, i128* %buf.addr, align 8, !dbg !79 ; [debug line = 62:1]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.4), !dbg !85 ; [#uses=0 type=i32] [debug line = 62:66]
...
; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.3), !dbg !88 ; [#uses=0 type=i32] [debug line = 63:4]
...
.preheader2.i:                                    ; preds = %1, %newFuncRoot
  ...
  %j.0.i.cast8 = zext i4 %j.0.i to i32, !dbg !127 ; [#uses=2 type=i32] [debug line = 37:9@87:4]
  %tmp. = icmp eq i4 %j.0.i, -8, !dbg !127        ; [#uses=1 type=i1] [debug line = 37:9@87:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %tmp., label %.preheader1.i.exitStub, label %5, !dbg !127 ; [debug line = 37:9@87:4]

; <label>:1                                       ; preds = %3
  %2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str5, i32 %tmp.1) nounwind, !dbg !129 ; [#uses=0 type=i32] [debug line = 40:34@87:4]
...
; <label>:3                                       ; preds = %6, %5
  ...
  %i.1.i.cast7 = zext i4 %i.1.i to i32, !dbg !135 ; [#uses=1 type=i32] [debug line = 39:11@87:4]
...
; <label>:5                                       ; preds = %.preheader2.i
  ...
  %tmp.1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str5) nounwind, !dbg !136 ; [#uses=1 type=i32] [debug line = 38:1@87:4]
  %col_inbuf.addr = getelementptr [8 x i128]* %col_inbuf, i32 0, i32 %j.0.i.cast8, !dbg !137 ; [#uses=2 type=i128*] [debug line = 40:1@87:4]
...
; <label>:6                                       ; preds = %3
  ...
  %row_outbuf.i.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf.i, i32 0, i32 %i.1.i.cast7, i32 %j.0.i.cast8, !dbg !137 ; [#uses=1 type=i16*] [debug line = 40:1@87:4]
  ...
  %tmp.31.cast = zext i4 %i.1.i to i7, !dbg !137  ; [#uses=1 type=i7] [debug line = 40:1@87:4]
  %tmp.3 = shl i7 %tmp.31.cast, 4, !dbg !137      ; [#uses=2 type=i7] [debug line = 40:1@87:4]
  %tmp.32.cast = zext i7 %tmp.3 to i9, !dbg !137  ; [#uses=1 type=i9] [debug line = 40:1@87:4]
  %tmp.4 = or i7 %tmp.3, 15                       ; [#uses=1 type=i7]
  %tmp.33.cast = zext i7 %tmp.4 to i9             ; [#uses=1 type=i9]
  %tmp.5 = call i128 @_ssdm_op_PartSet.i128.i128.i16.i9.i9(i128 %col_inbuf.load, i16 %row_outbuf.i.load, i9 %tmp.32.cast, i9 %tmp.33.cast), !dbg !137 ; [#uses=1 type=i128] [debug line = 40:1@87:4]
  store i128 %tmp.5, i128* %col_inbuf.addr, align 8, !dbg !137 ; [debug line = 40:1@87:4]
...
.preheader.i:                                     ; preds = %1, %newFuncRoot
  ...
  %j.1.i.cast5 = zext i4 %j.1.i to i32, !dbg !144 ; [#uses=2 type=i32] [debug line = 48:9@87:4]
  %tmp.7 = icmp eq i4 %j.1.i, -8, !dbg !144       ; [#uses=1 type=i1] [debug line = 48:9@87:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.7, label %dct_2d.exit.exitStub, label %5, !dbg !144 ; [debug line = 48:9@87:4]
...
; <label>:3                                       ; preds = %6, %5
  ...
  %i.3.i.cast4 = zext i4 %i.3.i to i32, !dbg !150 ; [#uses=2 type=i32] [debug line = 50:11@87:4]
  %tmp.8 = icmp eq i4 %i.3.i, -8, !dbg !150       ; [#uses=1 type=i1] [debug line = 50:11@87:4]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.8, label %1, label %6, !dbg !150     ; [debug line = 50:11@87:4]
...
; <label>:6                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str9) nounwind, !dbg !152 ; [debug line = 51:2@87:4]
  %tmp.6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str9) nounwind, !dbg !152 ; [#uses=1 type=i32] [debug line = 51:2@87:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !154 ; [debug line = 52:1@87:4]
  %col_outbuf.i.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf.i, i32 0, i32 %i.3.i.cast4, i32 %j.1.i.cast5, !dbg !155 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  %col_outbuf.i.load = load i16* %col_outbuf.i.addr, align 2, !dbg !155 ; [#uses=1 type=i16] [debug line = 51:1@87:4]
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 %j.1.i.cast5, i32 %i.3.i.cast4, !dbg !155 ; [#uses=1 type=i16*] [debug line = 51:1@87:4]
  store i16 %col_outbuf.i.load, i16* %buf_2d_out.addr, align 2, !dbg !155 ; [debug line = 51:1@87:4]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str9, i32 %tmp.6) nounwind, !dbg !156 ; [#uses=0 type=i32] [debug line = 51:34@87:4]
...
; <label>:2                                       ; preds = %0
  ...
  call void (...)* @_ssdm_SpecKeepAssert(i4 %i.0.i) nounwind, !hlsrange !162
  %i.2.i1.cast.i = zext i4 %i.0.i to i32          ; [#uses=1 type=i32]
  %i.2.i.cast.i = zext i4 %i.0.i to i32           ; [#uses=1 type=i32]
  ...
  %buf_2d_in.addr = getelementptr [8 x i128]* %buf_2d_in, i32 0, i32 %i.2.i.cast.i, !dbg !172 ; [#uses=1 type=i128*] [debug line = 17:10]
  br label %3, !dbg !178                          ; [debug line = 13:9]

; <label>:3                                       ; preds = %5, %2
  %k.i = phi i4 [ 0, %2 ], [ %k, %5 ]             ; [#uses=3 type=i4]
  %k.cast1.i = zext i4 %k.i to i32, !dbg !178     ; [#uses=2 type=i32] [debug line = 13:9]
...
; <label>:5                                       ; preds = %3
  ...
  %tmp.2.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str2) nounwind, !dbg !179 ; [#uses=1 type=i32] [debug line = 13:67]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !180 ; [debug line = 14:1]
  %dct_coeff_table.addr = getelementptr [8 x i127]* @dct_coeff_table, i32 0, i32 %k.cast1.i, !dbg !181 ; [#uses=1 type=i127*] [debug line = 16:48]
  %dct_coeff_table.load = load i127* %dct_coeff_table.addr, align 16, !dbg !181 ; [#uses=8 type=i127] [debug line = 16:48]
  %tmp.4.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 0, i32 15) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.cast.i = sext i16 %tmp.4.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %buf_2d_in.load = load i128* %buf_2d_in.addr, align 8, !dbg !172 ; [#uses=8 type=i128] [debug line = 17:10]
  %tmp.5.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in.load, i9 0, i9 15) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.cast.i = sext i16 %tmp.5.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.i = mul i29 %tmp.2.cast.i, %coeff.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.6.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 16, i32 31) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.1.cast.i = sext i16 %tmp.6.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.7.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in.load, i9 16, i9 31) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.1.cast.i = sext i16 %tmp.7.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.1.i = mul i29 %tmp.2.1.cast.i, %coeff.1.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.8.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 32, i32 47) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.2.cast.i = sext i16 %tmp.8.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.10.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in.load, i9 32, i9 47) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.2.cast.i = sext i16 %tmp.10.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.2.i = mul i29 %tmp.2.2.cast.i, %coeff.2.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.11.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 48, i32 63) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.3.cast.i = sext i16 %tmp.11.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.12.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in.load, i9 48, i9 63) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.3.cast.i = sext i16 %tmp.12.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.3.i = mul i29 %tmp.2.3.cast.i, %coeff.3.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.13.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 64, i32 79) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.4.cast.i = sext i16 %tmp.13.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.14.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in.load, i9 64, i9 79) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.4.cast.i = sext i16 %tmp.14.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.4.i = mul i29 %tmp.2.4.cast.i, %coeff.4.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.15.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 80, i32 95) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.5.cast.i = sext i16 %tmp.15.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.16.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in.load, i9 80, i9 95) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.5.cast.i = sext i16 %tmp.16.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.5.i = mul i29 %tmp.2.5.cast.i, %coeff.5.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.17.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 96, i32 111) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.6.cast.i = sext i16 %tmp.17.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.18.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in.load, i9 96, i9 111) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.6.cast.i = sext i16 %tmp.18.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.6.i = mul i29 %tmp.2.6.cast.i, %coeff.6.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  ...
  %tmp.20.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %buf_2d_in.load, i9 112, i9 127) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.7.cast.i = sext i16 %tmp.20.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.7.i = mul i29 %coeff.7.cast.i, %tmp.2.7.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp2 = add i29 %tmp.3.1.i, %tmp.3.i, !dbg !182 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp3 = add i29 %tmp.3.3.i, %tmp.3.2.i, !dbg !182 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp1 = add i29 %tmp2, %tmp3, !dbg !182         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp5 = add i29 %tmp.3.5.i, %tmp.3.4.i, !dbg !182 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp7 = add i29 %tmp.3.7.i, 4096, !dbg !182     ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp6 = add i29 %tmp.3.6.i, %tmp7, !dbg !182    ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp4 = add i29 %tmp5, %tmp6, !dbg !182         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp.9.i = add i29 %tmp1, %tmp4, !dbg !182      ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp..i = lshr i29 %tmp.9.i, 13, !dbg !182      ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp.1.i = trunc i29 %tmp..i to i16, !dbg !182  ; [#uses=1 type=i16] [debug line = 19:7]
  %row_outbuf.i.addr = getelementptr [8 x [8 x i16]]* %row_outbuf.i, i32 0, i32 %i.2.i1.cast.i, i32 %k.cast1.i, !dbg !182 ; [#uses=1 type=i16*] [debug line = 19:7]
  store i16 %tmp.1.i, i16* %row_outbuf.i.addr, align 2, !dbg !182 ; [debug line = 19:7]
  %6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str2, i32 %tmp.2.i) nounwind, !dbg !183 ; [#uses=0 type=i32] [debug line = 20:4]
...
.preheader1.i:                                    ; preds = %dct_1d.exit, %newFuncRoot
  ...
  %tmp.5 = icmp eq i4 %i.2.i, -8, !dbg !187       ; [#uses=1 type=i1] [debug line = 43:9@87:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.5, label %.preheader.i.exitStub, label %1, !dbg !187 ; [debug line = 43:9@87:4]
...
; <label>:1                                       ; preds = %.preheader1.i
  ...
  %i.2.i.cast.i = zext i4 %i.2.i to i32           ; [#uses=1 type=i32]
  ...
  %col_inbuf.addr = getelementptr [8 x i128]* %col_inbuf, i32 0, i32 %i.2.i.cast.i, !dbg !172 ; [#uses=1 type=i128*] [debug line = 17:10]
...
; <label>:4                                       ; preds = %2
  ...
  %tmp.5.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf.load, i9 0, i9 15) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.cast.i = sext i16 %tmp.5.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.i = mul i29 %tmp.2.cast.i, %coeff.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.6.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 16, i32 31) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.1.cast.i = sext i16 %tmp.6.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.7.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf.load, i9 16, i9 31) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.1.cast.i = sext i16 %tmp.7.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.1.i = mul i29 %tmp.2.1.cast.i, %coeff.1.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.8.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 32, i32 47) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.2.cast.i = sext i16 %tmp.8.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.10.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf.load, i9 32, i9 47) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.2.cast.i = sext i16 %tmp.10.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.2.i = mul i29 %tmp.2.2.cast.i, %coeff.2.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.11.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 48, i32 63) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.3.cast.i = sext i16 %tmp.11.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.12.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf.load, i9 48, i9 63) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.3.cast.i = sext i16 %tmp.12.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.3.i = mul i29 %tmp.2.3.cast.i, %coeff.3.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.13.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 64, i32 79) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.4.cast.i = sext i16 %tmp.13.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.14.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf.load, i9 64, i9 79) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.4.cast.i = sext i16 %tmp.14.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.4.i = mul i29 %tmp.2.4.cast.i, %coeff.4.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.15.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 80, i32 95) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.5.cast.i = sext i16 %tmp.15.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.16.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf.load, i9 80, i9 95) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.5.cast.i = sext i16 %tmp.16.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.5.i = mul i29 %tmp.2.5.cast.i, %coeff.5.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.17.i = call i16 @_ssdm_op_PartSelect.i16.i127.i32.i32(i127 %dct_coeff_table.load, i32 96, i32 111) nounwind, !dbg !181 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff.6.cast.i = sext i16 %tmp.17.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.18.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf.load, i9 96, i9 111) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.6.cast.i = sext i16 %tmp.18.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.6.i = mul i29 %tmp.2.6.cast.i, %coeff.6.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.2 = call i15 @_ssdm_op_PartSelect.i15.i127.i32.i32(i127 %dct_coeff_table.load, i32 112, i32 126) nounwind, !dbg !181 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff.7.cast.i = sext i15 %tmp.2 to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.20.i = call i16 @_ssdm_op_PartSelect.i16.i128.i9.i9(i128 %col_inbuf.load, i9 112, i9 127) nounwind, !dbg !172 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.2.7.cast.i = sext i16 %tmp.20.i to i29, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp.3.7.i = mul i29 %coeff.7.cast.i, %tmp.2.7.cast.i, !dbg !172 ; [#uses=1 type=i29] [debug line = 17:10]
  %tmp1 = add i29 %tmp.3.1.i, %tmp.3.i, !dbg !182 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp2 = add i29 %tmp.3.3.i, %tmp.3.2.i, !dbg !182 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp = add i29 %tmp1, %tmp2, !dbg !182          ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp4 = add i29 %tmp.3.5.i, %tmp.3.4.i, !dbg !182 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp6 = add i29 %tmp.3.7.i, 4096, !dbg !182     ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp5 = add i29 %tmp.3.6.i, %tmp6, !dbg !182    ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp3 = add i29 %tmp4, %tmp5, !dbg !182         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp.9.i = add i29 %tmp, %tmp3, !dbg !182       ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp..i = lshr i29 %tmp.9.i, 13, !dbg !182      ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp.1.i = trunc i29 %tmp..i to i16, !dbg !182  ; [#uses=1 type=i16] [debug line = 19:7]
  %col_outbuf.i.addr = getelementptr [8 x [8 x i16]]* %col_outbuf.i, i32 0, i32 %i.2.i1.cast.i, i32 %k.cast1.i, !dbg !182 ; [#uses=1 type=i16*] [debug line = 19:7]
  store i16 %tmp.1.i, i16* %col_outbuf.i.addr, align 2, !dbg !182 ; [debug line = 19:7]
  %5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str2, i32 %tmp.2.i) nounwind, !dbg !183 ; [#uses=0 type=i32] [debug line = 20:4]
  %k = add i4 %k.i, 1, !dbg !184                  ; [#uses=1 type=i4] [debug line = 13:61]
  call void @llvm.dbg.value(metadata !{i4 %k}, i64 0, metadata !185) nounwind, !dbg !184 ; [debug line = 13:61] [debug variable = k]
...
!38 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !27} ; [ DW_TAG_pointer_type ]
...
!152 = metadata !{i32 51, i32 2, metadata !153, metadata !120}
!153 = metadata !{i32 786443, metadata !147, i32 51, i32 1, metadata !23, i32 17} ; [ DW_TAG_lexical_block ]
!154 = metadata !{i32 52, i32 1, metadata !153, metadata !120}
!155 = metadata !{i32 51, i32 1, metadata !153, metadata !120}
...
!167 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !26} ; [ DW_TAG_pointer_type ]
