; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution4/.autopilot/db/a.g.1.bc'
...
define void @dct(i16* %input, i16* %output) nounwind {
  ...
  %buf_2d_in.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !201 ; [#uses=3 type=[8 x i16]*] [debug line = 82:1]
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %buf_2d_in.addr, i32 1, i8* getelementptr inbounds ([9 x i8]* @.str13, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !201 ; [debug line = 82:1]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !202), !dbg !203 ; [debug line = 82:10] [debug variable = buf_2d_out]
  call fastcc void @read_data(i16* %input, [8 x i16]* %buf_2d_in.addr), !dbg !204 ; [debug line = 85:4]
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 0, !dbg !205 ; [#uses=2 type=[8 x i16]*] [debug line = 87:4]
  call fastcc void @dct_2d([8 x i16]* %buf_2d_in.addr, [8 x i16]* %buf_2d_out.addr), !dbg !205 ; [debug line = 87:4]
  call fastcc void @write_data([8 x i16]* %buf_2d_out.addr, i16* %output), !dbg !206 ; [debug line = 90:4]
...
!201 = metadata !{i32 82, i32 1, metadata !196, null}
!202 = metadata !{i32 786688, metadata !196, metadata !"buf_2d_out", metadata !6, i32 82, metadata !199, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!203 = metadata !{i32 82, i32 10, metadata !196, null}
!204 = metadata !{i32 85, i32 4, metadata !196, null}
!205 = metadata !{i32 87, i32 4, metadata !196, null}
!206 = metadata !{i32 90, i32 4, metadata !196, null}
!207 = metadata !{i32 91, i32 1, metadata !196, null}
