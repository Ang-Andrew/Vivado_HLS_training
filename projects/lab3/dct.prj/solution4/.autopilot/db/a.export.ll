...
.reset:                                           ; preds = %1
  ...
  %tmp_mid2_v_v = select i1 %exitcond3, i4 %r_1, i4 %r
...
dct_1d.1.exit:                                    ; preds = %1
  ...
  %tmp_4 = call i16 @_ssdm_op_Mux.ap_auto.8i16.i3(i16 %in_block_0_load, i16 %in_block_1_load, i16 %in_block_2_load, i16 %in_block_3_load, i16 %in_block_4_load, i16 %in_block_5_load, i16 %in_block_6_load, i16 %in_block_7_load, i3 %tmp_1)
  %tmp_6_i_cast = sext i16 %tmp_4 to i29
  %tmp_7_i = mul i29 %tmp_6_i_cast, %coeff_i_cast
  %dct_coeff_table_1_ad = getelementptr [8 x i15]* @dct_coeff_table_1, i32 0, i32 %k_i_cast
  %dct_coeff_table_1_lo = load i15* %dct_coeff_table_1_ad, align 2
  %coeff_1_i_cast = sext i15 %dct_coeff_table_1_lo to i29
  ...
  %tmp_6 = call i16 @_ssdm_op_Mux.ap_auto.8i16.i3(i16 %in_block_0_load_1, i16 %in_block_1_load_1, i16 %in_block_2_load_1, i16 %in_block_3_load_1, i16 %in_block_4_load_1, i16 %in_block_5_load_1, i16 %in_block_6_load_1, i16 %in_block_7_load_1, i3 %tmp_1)
  %tmp_6_1_i_cast = sext i16 %tmp_6 to i29
  %tmp_7_1_i = mul i29 %tmp_6_1_i_cast, %coeff_1_i_cast
  %dct_coeff_table_2_ad = getelementptr [8 x i15]* @dct_coeff_table_2, i32 0, i32 %k_i_cast
  %dct_coeff_table_2_lo = load i15* %dct_coeff_table_2_ad, align 2
  %coeff_2_i_cast = sext i15 %dct_coeff_table_2_lo to i29
  ...
  %tmp_8 = call i16 @_ssdm_op_Mux.ap_auto.8i16.i3(i16 %in_block_0_load_2, i16 %in_block_1_load_2, i16 %in_block_2_load_2, i16 %in_block_3_load_2, i16 %in_block_4_load_2, i16 %in_block_5_load_2, i16 %in_block_6_load_2, i16 %in_block_7_load_2, i3 %tmp_1)
  %tmp_6_2_i_cast = sext i16 %tmp_8 to i29
  %tmp_7_2_i = mul i29 %tmp_6_2_i_cast, %coeff_2_i_cast
  %dct_coeff_table_3_ad = getelementptr [8 x i15]* @dct_coeff_table_3, i32 0, i32 %k_i_cast
  %dct_coeff_table_3_lo = load i15* %dct_coeff_table_3_ad, align 2
  %coeff_3_i_cast = sext i15 %dct_coeff_table_3_lo to i29
  ...
  %tmp_s = call i16 @_ssdm_op_Mux.ap_auto.8i16.i3(i16 %in_block_0_load_3, i16 %in_block_1_load_3, i16 %in_block_2_load_3, i16 %in_block_3_load_3, i16 %in_block_4_load_3, i16 %in_block_5_load_3, i16 %in_block_6_load_3, i16 %in_block_7_load_3, i3 %tmp_1)
  %tmp_6_3_i_cast = sext i16 %tmp_s to i29
  %tmp_7_3_i = mul i29 %tmp_6_3_i_cast, %coeff_3_i_cast
  %dct_coeff_table_4_ad = getelementptr [8 x i15]* @dct_coeff_table_4, i32 0, i32 %k_i_cast
  %dct_coeff_table_4_lo = load i15* %dct_coeff_table_4_ad, align 2
  %coeff_4_i_cast = sext i15 %dct_coeff_table_4_lo to i29
  ...
  %tmp_2 = call i16 @_ssdm_op_Mux.ap_auto.8i16.i3(i16 %in_block_0_load_4, i16 %in_block_1_load_4, i16 %in_block_2_load_4, i16 %in_block_3_load_4, i16 %in_block_4_load_4, i16 %in_block_5_load_4, i16 %in_block_6_load_4, i16 %in_block_7_load_4, i3 %tmp_1)
  %tmp_6_4_i_cast = sext i16 %tmp_2 to i29
  %tmp_7_4_i = mul i29 %tmp_6_4_i_cast, %coeff_4_i_cast
  %dct_coeff_table_5_ad = getelementptr [8 x i15]* @dct_coeff_table_5, i32 0, i32 %k_i_cast
  %dct_coeff_table_5_lo = load i15* %dct_coeff_table_5_ad, align 2
  %coeff_5_i_cast = sext i15 %dct_coeff_table_5_lo to i29
  ...
  %tmp_10 = call i16 @_ssdm_op_Mux.ap_auto.8i16.i3(i16 %in_block_0_load_5, i16 %in_block_1_load_5, i16 %in_block_2_load_5, i16 %in_block_3_load_5, i16 %in_block_4_load_5, i16 %in_block_5_load_5, i16 %in_block_6_load_5, i16 %in_block_7_load_5, i3 %tmp_1)
  %tmp_6_5_i_cast = sext i16 %tmp_10 to i29
  %tmp_7_5_i = mul i29 %tmp_6_5_i_cast, %coeff_5_i_cast
  %dct_coeff_table_6_ad = getelementptr [8 x i15]* @dct_coeff_table_6, i32 0, i32 %k_i_cast
  %dct_coeff_table_6_lo = load i15* %dct_coeff_table_6_ad, align 2
  %coeff_6_i_cast = sext i15 %dct_coeff_table_6_lo to i29
  ...
  %tmp_11 = call i16 @_ssdm_op_Mux.ap_auto.8i16.i3(i16 %in_block_0_load_6, i16 %in_block_1_load_6, i16 %in_block_2_load_6, i16 %in_block_3_load_6, i16 %in_block_4_load_6, i16 %in_block_5_load_6, i16 %in_block_6_load_6, i16 %in_block_7_load_6, i3 %tmp_1)
  %tmp_6_6_i_cast = sext i16 %tmp_11 to i29
  %tmp_7_6_i = mul i29 %tmp_6_6_i_cast, %coeff_6_i_cast
  %dct_coeff_table_7_ad = getelementptr [8 x i15]* @dct_coeff_table_7, i32 0, i32 %k_i_cast
  %dct_coeff_table_7_lo = load i15* %dct_coeff_table_7_ad, align 2
  %coeff_7_i_cast = sext i15 %dct_coeff_table_7_lo to i29
  ...
  %tmp_12 = call i16 @_ssdm_op_Mux.ap_auto.8i16.i3(i16 %in_block_0_load_7, i16 %in_block_1_load_7, i16 %in_block_2_load_7, i16 %in_block_3_load_7, i16 %in_block_4_load_7, i16 %in_block_5_load_7, i16 %in_block_6_load_7, i16 %in_block_7_load_7, i3 %tmp_1)
  %tmp_6_7_i_cast = sext i16 %tmp_12 to i29
  %tmp_7_7_i = mul i29 %tmp_6_7_i_cast, %coeff_7_i_cast
  %tmp6 = add i29 %tmp_7_1_i, %tmp_7_i
  %tmp7 = add i29 %tmp_7_3_i, %tmp_7_2_i
  %tmp8 = add i29 %tmp6, %tmp7
  %tmp9 = add i29 %tmp_7_5_i, %tmp_7_4_i
  %tmp2 = add i29 4096, %tmp_7_7_i
  %tmp3 = add i29 %tmp_7_6_i, %tmp2
  %tmp4 = add i29 %tmp9, %tmp3
  %tmp_3_i = add i29 %tmp8, %tmp4
  ...
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_11_i) nounwind
  %k = add i4 1, %k_i_mid2
  br label %1
...
.preheader2:                                      ; preds = %.preheader2.preheader
  ...
  %tmp_15 = add i8 %i_1_cast_cast, %tmp_16_cast
  %tmp_17_cast = zext i8 %tmp_15 to i32
  %col_inbuf_addr = getelementptr [64 x i16]* %col_inbuf, i32 0, i32 %tmp_17_cast
  %tmp_16 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1_mid2, i3 0)
  %tmp_19_cast = zext i7 %tmp_16 to i8
  %tmp_17 = add i8 %j_cast_mid2_cast, %tmp_19_cast
  %tmp_20_cast = zext i8 %tmp_17 to i32
  %dst_assign_addr_1 = getelementptr [64 x i16]* %dst_assign, i32 0, i32 %tmp_20_cast
  ...
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str5, i32 %tmp_7)
...
; <label>:2                                       ; preds = %.preheader1
  ...
  %tmp_6_i4_cast = sext i16 %col_inbuf_load to i29
  %col_inbuf_load_1 = load i16* %col_inbuf_addr_2, align 2
  %tmp_6_1_i7_cast = sext i16 %col_inbuf_load_1 to i29
  %col_inbuf_load_2 = load i16* %col_inbuf_addr_3, align 2
  %tmp_6_2_i11_cast = sext i16 %col_inbuf_load_2 to i29
  %col_inbuf_load_3 = load i16* %col_inbuf_addr_4, align 2
  %tmp_6_3_i15_cast = sext i16 %col_inbuf_load_3 to i29
  %col_inbuf_load_4 = load i16* %col_inbuf_addr_5, align 2
  %tmp_6_4_i19_cast = sext i16 %col_inbuf_load_4 to i29
  %col_inbuf_load_5 = load i16* %col_inbuf_addr_6, align 2
  %tmp_6_5_i23_cast = sext i16 %col_inbuf_load_5 to i29
  %col_inbuf_load_6 = load i16* %col_inbuf_addr_7, align 2
  %tmp_6_6_i27_cast = sext i16 %col_inbuf_load_6 to i29
  %col_inbuf_load_7 = load i16* %col_inbuf_addr_8, align 2
  %tmp_6_7_i31_cast = sext i16 %col_inbuf_load_7 to i29
  br label %3
...
; <label>:4                                       ; preds = %3
  %k_i1_cast = zext i4 %k_i1 to i32
  %k_i1_cast_cast = zext i4 %k_i1 to i8
  %tmp_39 = add i8 %tmp_22_cast, %k_i1_cast_cast
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %dct_coeff_table_0_ad_1 = getelementptr [8 x i14]* @dct_coeff_table_0, i32 0, i32 %k_i1_cast
  %dct_coeff_table_0_lo_1 = load i14* %dct_coeff_table_0_ad_1, align 2
  %coeff_i3_cast = zext i14 %dct_coeff_table_0_lo_1 to i29
  %tmp_7_i5 = mul i29 %tmp_6_i4_cast, %coeff_i3_cast
  %dct_coeff_table_1_ad_1 = getelementptr [8 x i15]* @dct_coeff_table_1, i32 0, i32 %k_i1_cast
  %dct_coeff_table_1_lo_1 = load i15* %dct_coeff_table_1_ad_1, align 2
  %coeff_1_i6_cast = sext i15 %dct_coeff_table_1_lo_1 to i29
  %tmp_7_1_i8 = mul i29 %tmp_6_1_i7_cast, %coeff_1_i6_cast
  %dct_coeff_table_2_ad_1 = getelementptr [8 x i15]* @dct_coeff_table_2, i32 0, i32 %k_i1_cast
  %dct_coeff_table_2_lo_1 = load i15* %dct_coeff_table_2_ad_1, align 2
  %coeff_2_i10_cast = sext i15 %dct_coeff_table_2_lo_1 to i29
  %tmp_7_2_i1 = mul i29 %tmp_6_2_i11_cast, %coeff_2_i10_cast
  %dct_coeff_table_3_ad_1 = getelementptr [8 x i15]* @dct_coeff_table_3, i32 0, i32 %k_i1_cast
  %dct_coeff_table_3_lo_1 = load i15* %dct_coeff_table_3_ad_1, align 2
  %coeff_3_i14_cast = sext i15 %dct_coeff_table_3_lo_1 to i29
  %tmp_7_3_i1 = mul i29 %tmp_6_3_i15_cast, %coeff_3_i14_cast
  %dct_coeff_table_4_ad_1 = getelementptr [8 x i15]* @dct_coeff_table_4, i32 0, i32 %k_i1_cast
  %dct_coeff_table_4_lo_1 = load i15* %dct_coeff_table_4_ad_1, align 2
  %coeff_4_i18_cast = sext i15 %dct_coeff_table_4_lo_1 to i29
  %tmp_7_4_i1 = mul i29 %tmp_6_4_i19_cast, %coeff_4_i18_cast
  %dct_coeff_table_5_ad_1 = getelementptr [8 x i15]* @dct_coeff_table_5, i32 0, i32 %k_i1_cast
  %dct_coeff_table_5_lo_1 = load i15* %dct_coeff_table_5_ad_1, align 2
  %coeff_5_i22_cast = sext i15 %dct_coeff_table_5_lo_1 to i29
  %tmp_7_5_i1 = mul i29 %tmp_6_5_i23_cast, %coeff_5_i22_cast
  %dct_coeff_table_6_ad_1 = getelementptr [8 x i15]* @dct_coeff_table_6, i32 0, i32 %k_i1_cast
  %dct_coeff_table_6_lo_1 = load i15* %dct_coeff_table_6_ad_1, align 2
  %coeff_6_i26_cast = sext i15 %dct_coeff_table_6_lo_1 to i29
  %tmp_7_6_i1 = mul i29 %tmp_6_6_i27_cast, %coeff_6_i26_cast
  %dct_coeff_table_7_ad_1 = getelementptr [8 x i15]* @dct_coeff_table_7, i32 0, i32 %k_i1_cast
  %dct_coeff_table_7_lo_1 = load i15* %dct_coeff_table_7_ad_1, align 2
  %coeff_7_i30_cast = sext i15 %dct_coeff_table_7_lo_1 to i29
  %tmp_7_7_i1 = mul i29 %tmp_6_7_i31_cast, %coeff_7_i30_cast
  %tmp5 = add i29 %tmp_7_1_i8, %tmp_7_i5
  %tmp10 = add i29 %tmp_7_3_i1, %tmp_7_2_i1
  %tmp11 = add i29 %tmp5, %tmp10
  %tmp12 = add i29 %tmp_7_5_i1, %tmp_7_4_i1
  %tmp13 = add i29 %tmp_7_7_i1, 4096
  %tmp14 = add i29 %tmp_7_6_i1, %tmp13
  %tmp15 = add i29 %tmp12, %tmp14
  %tmp_3_i1 = add i29 %tmp11, %tmp15
...
.preheader.preheader:                             ; preds = %.preheader.preheader.preheader, %.preheader
  ...
  %j_1 = phi i4 [ %j_1_cast_mid2_v, %.preheader ], [ 0, %.preheader.preheader.preheader ]
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  %j_1_cast_mid2_v = select i1 %tmp_34, i4 %j_3, i4 %j_1
  %j_1_cast_mid2_cast = zext i4 %j_1_cast_mid2_v to i8
  %tmp_35 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1_cast_mid2_v, i3 0)
  %tmp_38_cast = zext i7 %tmp_35 to i8
  %i_3_cast_cast = zext i4 %i_3_mid2 to i8
  %tmp_36 = add i8 %i_3_cast_cast, %tmp_38_cast
  ...
  %tmp_38 = add i8 %j_1_cast_mid2_cast, %tmp_41_cast
  ...
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str8, i32 %tmp_3)
...
; <label>:1                                       ; preds = %0, %.reset
  ...
  %r_i = phi i4 [ 0, %0 ], [ %r_i_cast4_mid2_v, %.reset ]
...
.reset:                                           ; preds = %1
  ...
  %r_i_cast4_mid2_v = select i1 %exitcond_i3, i4 %r, i4 %r_i
  %tmp = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i_cast4_mid2_v, i3 0)
  %tmp_44_cast = zext i7 %tmp to i8
  %tmp_16 = trunc i4 %r_i_cast4_mid2_v to i3
  %tmp_i_mid2 = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %tmp_16, i3 0)
  %c_i_cast2 = zext i4 %c_i_mid2 to i6
  %c_i_cast1_cast = zext i4 %c_i_mid2 to i8
  %tmp_s = add i8 %tmp_44_cast, %c_i_cast1_cast
  %tmp_46_cast = zext i8 %tmp_s to i32
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i32 0, i32 %tmp_46_cast
  ...
  %sum3_i = add i6 %tmp_i_mid2, %c_i_cast2
  ...
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str12, i32 %tmp_2_i) nounwind
  %c = add i4 1, %c_i_mid2
  br label %1
