; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution4/.autopilot/db/a.o.bc'
...
define void @dct(i16* %input, i16* %output) nounwind {
  ...
  %5 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !222 ; [#uses=1 type=[8 x i16]*] [debug line = 82:1]
  call void bitcast (void (...)* @_ssdm_SpecArrayPartition to void ([8 x i16]*, i32, i8*, i32, i8*)*)([8 x i16]* %5, i32 1, i8* getelementptr inbounds ([9 x i8]* @.str13, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !222 ; [debug line = 82:1]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !223), !dbg !224 ; [debug line = 82:10] [debug variable = buf_2d_out]
  %6 = load i16** %1, align 4, !dbg !225          ; [#uses=1 type=i16*] [debug line = 85:4]
  %7 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !225 ; [#uses=1 type=[8 x i16]*] [debug line = 85:4]
  call void @read_data(i16* %6, [8 x i16]* %7), !dbg !225 ; [debug line = 85:4]
  %8 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !226 ; [#uses=1 type=[8 x i16]*] [debug line = 87:4]
  %9 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 0, !dbg !226 ; [#uses=1 type=[8 x i16]*] [debug line = 87:4]
  call void @dct_2d([8 x i16]* %8, [8 x i16]* %9), !dbg !226 ; [debug line = 87:4]
  %10 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 0, !dbg !227 ; [#uses=1 type=[8 x i16]*] [debug line = 90:4]
  %11 = load i16** %2, align 4, !dbg !227         ; [#uses=1 type=i16*] [debug line = 90:4]
  call void @write_data([8 x i16]* %10, i16* %11), !dbg !227 ; [debug line = 90:4]
...
!222 = metadata !{i32 82, i32 1, metadata !217, null}
!223 = metadata !{i32 786688, metadata !217, metadata !"buf_2d_out", metadata !6, i32 82, metadata !220, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!224 = metadata !{i32 82, i32 10, metadata !217, null}
!225 = metadata !{i32 85, i32 4, metadata !217, null}
!226 = metadata !{i32 87, i32 4, metadata !217, null}
!227 = metadata !{i32 90, i32 4, metadata !217, null}
!228 = metadata !{i32 91, i32 1, metadata !217, null}
