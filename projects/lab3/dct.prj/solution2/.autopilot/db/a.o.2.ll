; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution2/.autopilot/db/a.o.2.bc'
...
.preheader2:                                      ; preds = %10, %.preheader2.preheader
  ...
  %j.cast5 = zext i4 %j to i32, !dbg !52          ; [#uses=2 type=i32] [debug line = 37:9]
  %tmp.8 = icmp eq i4 %j, -8, !dbg !52            ; [#uses=1 type=i1] [debug line = 37:9]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp.8, label %.preheader1.preheader, label %5, !dbg !52 ; [debug line = 37:9]
...
; <label>:5                                       ; preds = %.preheader2
  ...
  %tmp.5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str4), !dbg !62 ; [#uses=1 type=i32] [debug line = 38:1]
  br label %6, !dbg !64                           ; [debug line = 39:11]

; <label>:6                                       ; preds = %8, %5
  %i.1 = phi i4 [ 0, %5 ], [ %i.6, %8 ]           ; [#uses=3 type=i4]
  %i.1.cast4 = zext i4 %i.1 to i32, !dbg !64      ; [#uses=2 type=i32] [debug line = 39:11]
  %tmp. = icmp eq i4 %i.1, -8, !dbg !64           ; [#uses=1 type=i1] [debug line = 39:11]
  %7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp., label %10, label %8, !dbg !64      ; [debug line = 39:11]

; <label>:8                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str5) nounwind, !dbg !66 ; [debug line = 40:2]
  %tmp.7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str5), !dbg !66 ; [#uses=1 type=i32] [debug line = 40:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !68 ; [debug line = 41:1]
  %row_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i32 0, i32 %i.1.cast4, i32 %j.cast5, !dbg !69 ; [#uses=1 type=i16*] [debug line = 40:1]
  %row_outbuf.load = load i16* %row_outbuf.addr, align 2, !dbg !69 ; [#uses=1 type=i16] [debug line = 40:1]
  %col_inbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i32 %j.cast5, i32 %i.1.cast4, !dbg !69 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf.load, i16* %col_inbuf.addr, align 2, !dbg !69 ; [debug line = 40:1]
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str5, i32 %tmp.7), !dbg !70 ; [#uses=0 type=i32] [debug line = 40:34]
...
; <label>:10                                      ; preds = %6
  %11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str4, i32 %tmp.5), !dbg !72 ; [#uses=0 type=i32] [debug line = 40:34]
...
.preheader1:                                      ; preds = %13, %.preheader1.preheader
  ...
  %tmp.9 = icmp eq i4 %i.2, -8, !dbg !60          ; [#uses=1 type=i1] [debug line = 43:9]
  %12 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp.9, label %.preheader.preheader, label %13, !dbg !60 ; [debug line = 43:9]
...
.preheader:                                       ; preds = %20, %.preheader.preheader
  ...
  %j.1.cast2 = zext i4 %j.1 to i32, !dbg !75      ; [#uses=2 type=i32] [debug line = 48:9]
  %tmp.1 = icmp eq i4 %j.1, -8, !dbg !75          ; [#uses=1 type=i1] [debug line = 48:9]
  %14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp.1, label %22, label %15, !dbg !75    ; [debug line = 48:9]

; <label>:15                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str7) nounwind, !dbg !81 ; [debug line = 49:1]
  %tmp.6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str7), !dbg !81 ; [#uses=1 type=i32] [debug line = 49:1]
  br label %16, !dbg !83                          ; [debug line = 50:11]

; <label>:16                                      ; preds = %18, %15
  %i.3 = phi i4 [ 0, %15 ], [ %i.7, %18 ]         ; [#uses=3 type=i4]
  %i.3.cast1 = zext i4 %i.3 to i32, !dbg !83      ; [#uses=2 type=i32] [debug line = 50:11]
  %tmp.2 = icmp eq i4 %i.3, -8, !dbg !83          ; [#uses=1 type=i1] [debug line = 50:11]
  %17 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp.2, label %20, label %18, !dbg !83    ; [debug line = 50:11]

; <label>:18                                      ; preds = %16
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str8) nounwind, !dbg !85 ; [debug line = 51:2]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str8), !dbg !85 ; [#uses=1 type=i32] [debug line = 51:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !87 ; [debug line = 52:1]
  %col_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i32 0, i32 %i.3.cast1, i32 %j.1.cast2, !dbg !88 ; [#uses=1 type=i16*] [debug line = 51:1]
  %col_outbuf.load = load i16* %col_outbuf.addr, align 2, !dbg !88 ; [#uses=1 type=i16] [debug line = 51:1]
  %out_block.addr = getelementptr [8 x [8 x i16]]* %out_block, i32 0, i32 %j.1.cast2, i32 %i.3.cast1, !dbg !88 ; [#uses=1 type=i16*] [debug line = 51:1]
  store i16 %col_outbuf.load, i16* %out_block.addr, align 2, !dbg !88 ; [debug line = 51:1]
  %19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str8, i32 %tmp.3), !dbg !89 ; [#uses=0 type=i32] [debug line = 51:34]
...
; <label>:20                                      ; preds = %16
  %21 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str7, i32 %tmp.6), !dbg !91 ; [#uses=0 type=i32] [debug line = 51:34]
...
define internal fastcc void @dct_1d([8 x [8 x i16]]* nocapture %src, i4 %i.2, [8 x [8 x i16]]* nocapture %dst, i4 %i.21) {
  ...
  %i.2.cast = zext i4 %i.2 to i32                 ; [#uses=2 type=i32]
  call void (...)* @_ssdm_SpecKeepAssert(i32 %i.2.cast), !hlsrange !94
  call void (...)* @_ssdm_SpecKeepAssert(i32 %i.21.cast), !hlsrange !94
...
; <label>:1                                       ; preds = %8, %0
  ...
  %k.cast2 = zext i4 %k to i32, !dbg !100         ; [#uses=2 type=i32] [debug line = 13:9]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !103 ; [#uses=1 type=i32] [debug line = 13:67]
  br label %4, !dbg !105                          ; [debug line = 15:11]

; <label>:4                                       ; preds = %6, %3
  %n = phi i4 [ 0, %3 ], [ %n.1, %6 ]             ; [#uses=3 type=i4]
  %tmp1 = phi i32 [ 0, %3 ], [ %tmp.1, %6 ]       ; [#uses=2 type=i32]
  %n.cast1 = zext i4 %n to i32, !dbg !105         ; [#uses=2 type=i32] [debug line = 15:11]
  %tmp1.cast = trunc i32 %tmp1 to i29, !dbg !105  ; [#uses=1 type=i29] [debug line = 15:11]
  %tmp. = icmp eq i4 %n, -8, !dbg !105            ; [#uses=1 type=i1] [debug line = 15:11]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp., label %8, label %6, !dbg !105      ; [debug line = 15:11]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str1) nounwind, !dbg !107 ; [debug line = 15:78]
  %tmp.9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str1) nounwind, !dbg !107 ; [#uses=1 type=i32] [debug line = 15:78]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !109 ; [debug line = 16:1]
  %dct_coeff_table.addr = getelementptr inbounds [8 x [8 x i16]]* @dct_coeff_table, i32 0, i32 %k.cast2, i32 %n.cast1, !dbg !110 ; [#uses=1 type=i16*] [debug line = 16:48]
  %dct_coeff_table.load = load i16* %dct_coeff_table.addr, align 2, !dbg !110 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff = sext i16 %dct_coeff_table.load to i32, !dbg !110 ; [#uses=1 type=i32] [debug line = 16:48]
  call void @llvm.dbg.value(metadata !{i32 %coeff}, i64 0, metadata !111), !dbg !110 ; [debug line = 16:48] [debug variable = coeff]
  %src.addr = getelementptr [8 x [8 x i16]]* %src, i32 0, i32 %i.2.cast, i32 %n.cast1, !dbg !113 ; [#uses=1 type=i16*] [debug line = 17:10]
  %src.load = load i16* %src.addr, align 2, !dbg !113 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.6 = sext i16 %src.load to i32, !dbg !113   ; [#uses=1 type=i32] [debug line = 17:10]
  %tmp.7 = mul nsw i32 %coeff, %tmp.6, !dbg !113  ; [#uses=1 type=i32] [debug line = 17:10]
  %tmp.1 = add nsw i32 %tmp1, %tmp.7, !dbg !113   ; [#uses=1 type=i32] [debug line = 17:10]
  call void @llvm.dbg.value(metadata !{i32 %tmp.1}, i64 0, metadata !114), !dbg !113 ; [debug line = 17:10] [debug variable = tmp]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str1, i32 %tmp.9) nounwind, !dbg !115 ; [#uses=0 type=i32] [debug line = 18:7]
...
; <label>:8                                       ; preds = %4
  ...
  %tmp.3 = add i29 %tmp1.cast.lcssa, 4096, !dbg !118 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp.4 = lshr i29 %tmp.3, 13, !dbg !118         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp.5 = trunc i29 %tmp.4 to i16, !dbg !118     ; [#uses=1 type=i16] [debug line = 19:7]
  %dst.addr = getelementptr [8 x [8 x i16]]* %dst, i32 0, i32 %i.21.cast, i32 %k.cast2, !dbg !118 ; [#uses=1 type=i16*] [debug line = 19:7]
  store i16 %tmp.5, i16* %dst.addr, align 2, !dbg !118 ; [debug line = 19:7]
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp.8) nounwind, !dbg !119 ; [#uses=0 type=i32] [debug line = 20:4]
...
; <label>:1                                       ; preds = %8, %0
  ...
  %r.i.cast8 = zext i4 %r.i to i32, !dbg !160     ; [#uses=1 type=i32] [debug line = 59:9@85:4]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.3.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str9) nounwind, !dbg !163 ; [#uses=1 type=i32] [debug line = 59:67@85:4]
...
; <label>:4                                       ; preds = %6, %3
  ...
  %c.i.cast5 = zext i4 %c.i to i32, !dbg !168     ; [#uses=1 type=i32] [debug line = 61:12@85:4]
...
; <label>:6                                       ; preds = %4
  ...
  %tmp.4.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10) nounwind, !dbg !169 ; [#uses=1 type=i32] [debug line = 62:2@85:4]
  ...
  %input.addr = getelementptr [64 x i16]* %input, i32 0, i32 %sum.i.cast, !dbg !165 ; [#uses=1 type=i16*] [debug line = 62:1@85:4]
  %input.load = load i16* %input.addr, align 2, !dbg !165 ; [#uses=1 type=i16] [debug line = 62:1@85:4]
  %buf.assign.addr = getelementptr [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 %r.i.cast8, i32 %c.i.cast5, !dbg !165 ; [#uses=1 type=i16*] [debug line = 62:1@85:4]
  store i16 %input.load, i16* %buf.assign.addr, align 2, !dbg !165 ; [debug line = 62:1@85:4]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.4.i) nounwind, !dbg !171 ; [#uses=0 type=i32] [debug line = 62:66@85:4]
...
; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str9, i32 %tmp.3.i) nounwind, !dbg !174 ; [#uses=0 type=i32] [debug line = 63:4@85:4]
...
; <label>:10                                      ; preds = %17, %read_data.exit
  ...
  %r.i2.cast4 = zext i4 %r.i2 to i32, !dbg !186   ; [#uses=1 type=i32] [debug line = 71:9@90:4]
  %r.i2.cast3 = zext i4 %r.i2 to i6, !dbg !186    ; [#uses=1 type=i6] [debug line = 71:9@90:4]
...
; <label>:12                                      ; preds = %10
  ...
  %tmp.1.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str11) nounwind, !dbg !189 ; [#uses=1 type=i32] [debug line = 71:67@90:4]
  %tmp.i4 = shl i6 %r.i2.cast3, 3, !dbg !191      ; [#uses=1 type=i6] [debug line = 74:1@90:4]
  br label %13, !dbg !194                         ; [debug line = 73:12@90:4]

; <label>:13                                      ; preds = %15, %12
  %c.i5 = phi i4 [ 0, %12 ], [ %c.1, %15 ]        ; [#uses=4 type=i4]
  %c.i5.cast2 = zext i4 %c.i5 to i6, !dbg !194    ; [#uses=1 type=i6] [debug line = 73:12@90:4]
  %c.i5.cast1 = zext i4 %c.i5 to i32, !dbg !194   ; [#uses=1 type=i32] [debug line = 73:12@90:4]
  %exitcond.i6 = icmp eq i4 %c.i5, -8, !dbg !194  ; [#uses=1 type=i1] [debug line = 73:12@90:4]
  %14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond.i6, label %17, label %15, !dbg !194 ; [debug line = 73:12@90:4]

; <label>:15                                      ; preds = %13
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str12) nounwind, !dbg !195 ; [debug line = 74:2@90:4]
  %tmp.2.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12) nounwind, !dbg !195 ; [#uses=1 type=i32] [debug line = 74:2@90:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !196 ; [debug line = 75:1@90:4]
  %buf.assign.1.addr = getelementptr [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 %r.i2.cast4, i32 %c.i5.cast1, !dbg !191 ; [#uses=1 type=i16*] [debug line = 74:1@90:4]
  ...
  %output.addr = getelementptr [64 x i16]* %output, i32 0, i32 %sum3.i.cast, !dbg !191 ; [#uses=1 type=i16*] [debug line = 74:1@90:4]
  store i16 %buf.assign.1.load, i16* %output.addr, align 2, !dbg !191 ; [debug line = 74:1@90:4]
  %16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp.2.i) nounwind, !dbg !197 ; [#uses=0 type=i32] [debug line = 74:67@90:4]
  %c.1 = add i4 %c.i5, 1, !dbg !198               ; [#uses=1 type=i4] [debug line = 73:64@90:4]
...
; <label>:17                                      ; preds = %13
  %18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.1.i) nounwind, !dbg !200 ; [#uses=0 type=i32] [debug line = 75:4@90:4]
...
!24 = metadata !{i32 786473, metadata !"resource/lab3/dct.c", metadata !"C:\5CUsers\5CAndrew\5CDocuments\5CVivado_projects\5CHLS_Xilinx_university_program\5Cprojects\5Clab3", null} ; [ DW_TAG_file_type ]
...
!64 = metadata !{i32 39, i32 11, metadata !65, null}
!65 = metadata !{i32 786443, metadata !63, i32 39, i32 7, metadata !24, i32 10} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 40, i32 2, metadata !67, null}
!67 = metadata !{i32 786443, metadata !65, i32 40, i32 1, metadata !24, i32 11} ; [ DW_TAG_lexical_block ]
!68 = metadata !{i32 41, i32 1, metadata !67, null}
!69 = metadata !{i32 40, i32 1, metadata !67, null}
!70 = metadata !{i32 40, i32 34, metadata !67, null}
!71 = metadata !{i32 39, i32 63, metadata !65, null}
!72 = metadata !{i32 40, i32 34, metadata !65, null}
...
!83 = metadata !{i32 50, i32 11, metadata !84, null}
!84 = metadata !{i32 786443, metadata !82, i32 50, i32 7, metadata !24, i32 16} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 51, i32 2, metadata !86, null}
!86 = metadata !{i32 786443, metadata !84, i32 51, i32 1, metadata !24, i32 17} ; [ DW_TAG_lexical_block ]
!87 = metadata !{i32 52, i32 1, metadata !86, null}
!88 = metadata !{i32 51, i32 1, metadata !86, null}
!89 = metadata !{i32 51, i32 34, metadata !86, null}
!90 = metadata !{i32 50, i32 63, metadata !84, null}
!91 = metadata !{i32 51, i32 34, metadata !84, null}
...
!106 = metadata !{i32 786443, metadata !104, i32 15, i32 7, metadata !24, i32 3} ; [ DW_TAG_lexical_block ]
!107 = metadata !{i32 15, i32 78, metadata !108, null}
!108 = metadata !{i32 786443, metadata !106, i32 15, i32 77, metadata !24, i32 4} ; [ DW_TAG_lexical_block ]
!109 = metadata !{i32 16, i32 1, metadata !108, null}
!110 = metadata !{i32 16, i32 48, metadata !108, null}
!111 = metadata !{i32 786688, metadata !108, metadata !"coeff", metadata !24, i32 16, metadata !112, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!112 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!113 = metadata !{i32 17, i32 10, metadata !108, null}
!114 = metadata !{i32 786688, metadata !102, metadata !"tmp", metadata !24, i32 7, metadata !112, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!115 = metadata !{i32 18, i32 7, metadata !108, null}
!116 = metadata !{i32 15, i32 72, metadata !106, null}
...
!137 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !29} ; [ DW_TAG_pointer_type ]
