; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution2/.autopilot/db/a.o.bc'
...
; <label>:14                                      ; preds = %11
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !82 ; [debug line = 16:1]
  ...
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !87 ; [debug line = 18:7]
...
; <label>:30                                      ; preds = %27
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !128 ; [debug line = 41:1]
...
; <label>:72                                      ; preds = %69
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !151 ; [debug line = 52:1]
...
; <label>:14                                      ; preds = %11
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !178 ; [debug line = 63:1]
...
; <label>:14                                      ; preds = %11
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !205 ; [debug line = 75:1]
...
define void @dct(i16* %input, i16* %output) nounwind {
  ...
  %5 = load i16** %1, align 4, !dbg !224          ; [#uses=1 type=i16*] [debug line = 85:4]
  ...
  %10 = load i16** %2, align 4, !dbg !226         ; [#uses=1 type=i16*] [debug line = 90:4]
