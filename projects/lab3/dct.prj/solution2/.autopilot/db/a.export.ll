...
.preheader2:                                      ; preds = %.preheader2.preheader
  ...
  %tmp_5 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1_mid2, i3 0)
  %tmp_6_cast = zext i7 %tmp_5 to i8
  %tmp_8 = add i8 %j_cast5_mid2_cast, %tmp_6_cast
  %tmp_8_cast = zext i8 %tmp_8 to i32
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i32 0, i32 %tmp_8_cast
  %tmp_2 = add i8 %i_1_cast4_cast, %tmp_4_cast
  %tmp_10_cast = zext i8 %tmp_2 to i32
  %col_inbuf_addr = getelementptr [64 x i16]* %col_inbuf, i32 0, i32 %tmp_10_cast
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  %tmp_6 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1_cast2_mid2_v, i3 0)
  %tmp_12_cast = zext i7 %tmp_6 to i8
...
define internal fastcc void @dct_1d2([64 x i16]* nocapture %src, i4 %i_2, [64 x i16]* nocapture %dst, i4 %i_21) {
  ...
  %tmp_20_cast = zext i7 %tmp_14 to i8
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_15 = add i8 %k_cast2_cast, %tmp_18_cast
  %tmp_21_cast = zext i8 %tmp_15 to i32
  %dst_addr = getelementptr [64 x i16]* %dst, i32 0, i32 %tmp_21_cast
  %tmp_16 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %k, i3 0)
  %tmp_23_cast = zext i7 %tmp_16 to i8
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8)
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_17 = add i8 %tmp_20_cast, %n_cast1_cast
  %tmp_24_cast = zext i8 %tmp_17 to i32
  %src_addr = getelementptr [64 x i16]* %src, i32 0, i32 %tmp_24_cast
  %tmp_18 = add i8 %tmp_23_cast, %n_cast1_cast
  %tmp_25_cast = zext i8 %tmp_18 to i32
  %dct_coeff_table_addr = getelementptr [64 x i15]* @dct_coeff_table, i32 0, i32 %tmp_25_cast
  ...
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str1, i32 %tmp_9) nounwind
  br label %3
...
; <label>:5                                       ; preds = %3
  ...
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_8) nounwind
  br label %1
...
.reset:                                           ; preds = %1
  ...
  %tmp_26_cast = zext i7 %tmp to i8
  %tmp_3 = trunc i4 %r_i_cast8_mid2_v to i3
  %tmp_i_mid2 = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %tmp_3, i3 0)
  %c_i_cast6 = zext i4 %c_i_mid2 to i6
  %c_i_cast5_cast = zext i4 %c_i_mid2 to i8
  %tmp_s = add i8 %tmp_26_cast, %c_i_cast5_cast
  %tmp_28_cast = zext i8 %tmp_s to i32
  %buf_2d_in_addr = getelementptr [64 x i16]* %buf_2d_in, i32 0, i32 %tmp_28_cast
  ...
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str10, i32 %tmp_4_i) nounwind
  %c = add i4 1, %c_i_mid2
  br label %1
...
.reset10:                                         ; preds = %2
  ...
  %tmp_19 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i2_cast4_mid2_v, i3 0)
  %tmp_30_cast = zext i7 %tmp_19 to i8
  %tmp_4 = trunc i4 %r_i2_cast4_mid2_v to i3
  %tmp_i4_mid2 = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %tmp_4, i3 0)
  %c_i5_cast2 = zext i4 %c_i5_mid2 to i6
  %c_i5_cast1_cast = zext i4 %c_i5_mid2 to i8
  %tmp_20 = add i8 %tmp_30_cast, %c_i5_cast1_cast
  %tmp_32_cast = zext i8 %tmp_20 to i32
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i32 0, i32 %tmp_32_cast
  ...
  %empty_15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str12, i32 %tmp_2_i) nounwind
