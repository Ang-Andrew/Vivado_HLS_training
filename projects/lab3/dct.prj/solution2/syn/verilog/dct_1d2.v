...
reg   [0:0] ap_pipeline_reg_pp0_iter1_tmp_s_reg_297;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & ~(1'b0 == tmp_s_fu_197_p2))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_159_p2 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_CS_fsm_state2) & (tmp_fu_159_p2 == 1'b0)) | ((1'b1 == ap_CS_fsm_pp0_stage0) & ~(1'b0 == tmp_s_fu_197_p2)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'b0 == tmp_s_fu_197_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_enable_reg_pp0_iter2) & (1'b0 == ap_pipeline_reg_pp0_iter1_tmp_s_reg_297))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == tmp_s_reg_297))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_159_p2 == 1'b0))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_start) & (ap_CS_fsm_state1 == 1'b1)) | ((1'b1 == ap_CS_fsm_state2) & ~(tmp_fu_159_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b1 == ap_enable_reg_pp0_iter2) & ~(1'b1 == ap_enable_reg_pp0_iter1)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & ~(1'b0 == tmp_s_fu_197_p2) & ~(1'b1 == ap_enable_reg_pp0_iter1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((1'b1 == ap_enable_reg_pp0_iter0) & ~(1'b0 == tmp_s_fu_197_p2) & ~(1'b1 == ap_enable_reg_pp0_iter1))) begin
...
assign dst_d0 = {{tmp_3_fu_243_p2[ap_const_lv32_1C : ap_const_lv32_D]}};

assign k_1_fu_165_p2 = (k_reg_101 + ap_const_lv4_1);

assign k_cast2_cast_fu_171_p1 = k_reg_101;

assign n_1_fu_203_p2 = (n_reg_112 + ap_const_lv4_1);

assign n_cast1_cast_fu_209_p1 = n_reg_112;

assign src_address0 = tmp_24_cast_fu_218_p1;

assign tmp_13_fu_135_p3 = {{i_21}, {ap_const_lv3_0}};

assign tmp_14_fu_147_p3 = {{i_2}, {ap_const_lv3_0}};

assign tmp_15_fu_175_p2 = (k_cast2_cast_fu_171_p1 + tmp_18_cast_reg_268);

assign tmp_16_fu_185_p3 = {{k_reg_101}, {ap_const_lv3_0}};
...
assign tmp_3_fu_243_p2 = (ap_const_lv29_1000 + tmp_2_fu_239_p1);

assign tmp_fu_159_p2 = ((k_reg_101 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_s_fu_197_p2 = ((n_reg_112 == ap_const_lv4_8) ? 1'b1 : 1'b0);
