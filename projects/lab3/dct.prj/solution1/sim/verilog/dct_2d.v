...
reg   [3:0] j_2_reg_381;
reg   [5:0] col_inbuf_addr_reg_386;
...
wire   [31:0] tmp_7_cast_fu_233_p1;
...
wire   [7:0] tmp_7_fu_228_p2;
wire   [6:0] tmp_6_fu_238_p3;
wire   [7:0] tmp_11_cast_fu_246_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state2) & (1'b0 == tmp_fu_184_p2)) | ((1'b1 == ap_CS_fsm_state7) & (1'b0 == tmp_9_fu_272_p2)))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state4) & (1'b0 == tmp_8_fu_212_p2))) begin
        i_1_reg_124 <= ap_const_lv4_0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & ~(1'b0 == tmp_8_fu_212_p2))) begin
        i_2_reg_135 <= ap_const_lv4_0;
    end else if ((~(1'b0 == grp_dct_1d2_fu_169_ap_done) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state9) & (1'b0 == tmp_1_fu_300_p2))) begin
        i_3_reg_158 <= ap_const_lv4_0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & ~(1'b0 == grp_dct_1d2_fu_169_ap_done))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & ~(1'b0 == tmp_9_fu_272_p2))) begin
        j_1_reg_147 <= ap_const_lv4_0;
    end else if (((1'b1 == ap_CS_fsm_state10) & ~(1'b0 == tmp_2_fu_348_p2))) begin
        j_1_reg_147 <= j_3_reg_425;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & ~(1'b0 == tmp_fu_184_p2))) begin
        j_reg_113 <= ap_const_lv4_0;
    end else if (((1'b1 == ap_CS_fsm_state5) & ~(tmp_s_fu_260_p2 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        col_inbuf_addr_reg_386 <= tmp_7_cast_fu_233_p1;
...
always @ (*) begin
    if ((((1'b0 == ap_start) & (ap_CS_fsm_state1 == 1'b1)) | ((1'b1 == ap_CS_fsm_state9) & ~(1'b0 == tmp_1_fu_300_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) & ~(1'b0 == tmp_1_fu_300_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        row_outbuf_address0 = tmp_12_cast_fu_255_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (~(1'b0 == grp_dct_1d2_fu_169_ap_done)) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end
...
assign i_4_fu_190_p2 = (i_reg_101 + ap_const_lv4_1);

assign i_5_fu_278_p2 = (i_2_reg_135 + ap_const_lv4_1);

assign i_6_fu_266_p2 = (i_1_reg_124 + ap_const_lv4_1);

assign i_7_fu_354_p2 = (i_3_reg_158 + ap_const_lv4_1);

assign in_block_address0 = grp_dct_1d2_fu_169_src_address0;

assign in_block_ce0 = grp_dct_1d2_fu_169_src_ce0;

assign j_1_cast2_cast_fu_284_p1 = j_1_reg_147;

assign j_2_fu_218_p2 = (j_reg_113 + ap_const_lv4_1);

assign j_3_fu_306_p2 = (j_1_reg_147 + ap_const_lv4_1);
...
assign tmp_10_fu_250_p2 = (j_cast5_cast_reg_368 + tmp_11_cast_fu_246_p1);

assign tmp_11_cast_fu_246_p1 = tmp_6_fu_238_p3;

assign tmp_11_fu_288_p3 = {{j_1_reg_147}, {ap_const_lv3_0}};

assign tmp_12_cast_fu_255_p1 = tmp_10_fu_250_p2;

assign tmp_12_fu_316_p2 = (i_3_cast1_cast_fu_312_p1 + tmp_14_cast_reg_417);

assign tmp_13_fu_326_p3 = {{i_3_reg_158}, {ap_const_lv3_0}};
...
assign tmp_1_fu_300_p2 = ((j_1_reg_147 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_2_fu_348_p2 = ((i_3_reg_158 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_5_fu_200_p3 = {{j_reg_113}, {ap_const_lv3_0}};

assign tmp_6_cast_fu_208_p1 = tmp_5_fu_200_p3;

assign tmp_6_fu_238_p3 = {{i_1_reg_124}, {ap_const_lv3_0}};

assign tmp_7_cast_fu_233_p1 = tmp_7_fu_228_p2;

assign tmp_7_fu_228_p2 = (i_1_cast4_cast_fu_224_p1 + tmp_6_cast_reg_373);

assign tmp_8_fu_212_p2 = ((j_reg_113 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_9_fu_272_p2 = ((i_2_reg_135 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_fu_184_p2 = ((i_reg_101 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_s_fu_260_p2 = ((i_1_reg_124 == ap_const_lv4_8) ? 1'b1 : 1'b0);
