...
set ::env(PATH) "$::env(PATH);D:/Programs/Vivado/Vivado_HLS/2016.3/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Programs/Vivado/Vivado_HLS/2016.3/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Programs/Vivado/Vivado_HLS/2016.3/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);D:/Programs/Vivado/Vivado_HLS/2016.3/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Programs/Vivado/Vivado_HLS/2016.3/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dct.autotvin.dat"
	set constFileTvOut       "dct.autotvout.dat"
	set constFileHdlTvIn     "dct.autohdltvin.dat"
	set constFileHdlTvOut    "dct.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
