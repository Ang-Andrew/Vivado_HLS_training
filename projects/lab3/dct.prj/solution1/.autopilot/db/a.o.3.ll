; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @p_str2) nounwind, !dbg !43 ; [debug line = 32:66]
...
.preheader2:                                      ; preds = %6, %.preheader2.preheader
  ...
  %j_cast5_cast = zext i4 %j to i8                ; [#uses=1 type=i8]
  %tmp_5 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j, i3 0) ; [#uses=1 type=i7]
  %tmp_6_cast = zext i7 %tmp_5 to i8, !dbg !48    ; [#uses=1 type=i8] [debug line = 37:9]
  %tmp_8 = icmp eq i4 %j, -8, !dbg !48            ; [#uses=1 type=i1] [debug line = 37:9]
  ...
  br i1 %tmp_8, label %.preheader1.preheader, label %3, !dbg !48 ; [debug line = 37:9]
...
; <label>:3                                       ; preds = %.preheader2
  ...
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str3), !dbg !53 ; [#uses=1 type=i32] [debug line = 38:1]
  br label %4, !dbg !55                           ; [debug line = 39:11]

; <label>:4                                       ; preds = %5, %3
  %i_1 = phi i4 [ 0, %3 ], [ %i_6, %5 ]           ; [#uses=4 type=i4]
  %i_1_cast4_cast = zext i4 %i_1 to i8, !dbg !57  ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_7 = add i8 %i_1_cast4_cast, %tmp_6_cast, !dbg !57 ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_7_cast = zext i8 %tmp_7 to i32, !dbg !57   ; [#uses=1 type=i32] [debug line = 40:10]
  %col_inbuf_addr = getelementptr [64 x i16]* %col_inbuf, i32 0, i32 %tmp_7_cast, !dbg !57 ; [#uses=1 type=i16*] [debug line = 40:10]
  %tmp_6 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1, i3 0) ; [#uses=1 type=i7]
  %tmp_11_cast = zext i7 %tmp_6 to i8, !dbg !57   ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_10 = add i8 %j_cast5_cast, %tmp_11_cast, !dbg !57 ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_12_cast = zext i8 %tmp_10 to i32, !dbg !57 ; [#uses=1 type=i32] [debug line = 40:10]
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i32 0, i32 %tmp_12_cast, !dbg !57 ; [#uses=1 type=i16*] [debug line = 40:10]
  %tmp_s = icmp eq i4 %i_1, -8, !dbg !55          ; [#uses=1 type=i1] [debug line = 39:11]
  %empty_6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  %i_6 = add i4 %i_1, 1, !dbg !59                 ; [#uses=1 type=i4] [debug line = 39:63]
  br i1 %tmp_s, label %6, label %5, !dbg !55      ; [debug line = 39:11]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str4) nounwind, !dbg !57 ; [debug line = 40:10]
  %row_outbuf_load = load i16* %row_outbuf_addr, align 2, !dbg !57 ; [#uses=1 type=i16] [debug line = 40:10]
  store i16 %row_outbuf_load, i16* %col_inbuf_addr, align 2, !dbg !57 ; [debug line = 40:10]
  call void @llvm.dbg.value(metadata !{i4 %i_6}, i64 0, metadata !46), !dbg !59 ; [debug line = 39:63] [debug variable = i]
  br label %4, !dbg !59                           ; [debug line = 39:63]

; <label>:6                                       ; preds = %4
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str3, i32 %tmp_3), !dbg !60 ; [#uses=0 type=i32] [debug line = 40:43]
...
.preheader1:                                      ; preds = %7, %.preheader1.preheader
  ...
  %tmp_9 = icmp eq i4 %i_2, -8, !dbg !51          ; [#uses=1 type=i1] [debug line = 43:9]
  ...
  br i1 %tmp_9, label %.preheader.preheader, label %7, !dbg !51 ; [debug line = 43:9]

.preheader.preheader:                             ; preds = %.preheader1
  br label %.preheader

; <label>:7                                       ; preds = %.preheader1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @p_str5) nounwind, !dbg !63 ; [debug line = 43:67]
...
.preheader:                                       ; preds = %11, %.preheader.preheader
  ...
  %j_1_cast2_cast = zext i4 %j_1 to i8            ; [#uses=1 type=i8]
  %tmp_11 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1, i3 0) ; [#uses=1 type=i7]
  %tmp_14_cast = zext i7 %tmp_11 to i8, !dbg !66  ; [#uses=1 type=i8] [debug line = 48:9]
  %tmp_1 = icmp eq i4 %j_1, -8, !dbg !66          ; [#uses=1 type=i1] [debug line = 48:9]
  ...
  br i1 %tmp_1, label %12, label %8, !dbg !66     ; [debug line = 48:9]

; <label>:8                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str6) nounwind, !dbg !69 ; [debug line = 49:1]
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str6), !dbg !69 ; [#uses=1 type=i32] [debug line = 49:1]
  br label %9, !dbg !71                           ; [debug line = 50:11]

; <label>:9                                       ; preds = %10, %8
  %i_3 = phi i4 [ 0, %8 ], [ %i_7, %10 ]          ; [#uses=4 type=i4]
  %i_3_cast1_cast = zext i4 %i_3 to i8, !dbg !73  ; [#uses=1 type=i8] [debug line = 51:10]
  %tmp_12 = add i8 %i_3_cast1_cast, %tmp_14_cast, !dbg !73 ; [#uses=1 type=i8] [debug line = 51:10]
  %tmp_15_cast = zext i8 %tmp_12 to i32, !dbg !73 ; [#uses=1 type=i32] [debug line = 51:10]
  %out_block_addr = getelementptr [64 x i16]* %out_block, i32 0, i32 %tmp_15_cast, !dbg !73 ; [#uses=1 type=i16*] [debug line = 51:10]
  %tmp_13 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3, i3 0) ; [#uses=1 type=i7]
  %tmp_17_cast = zext i7 %tmp_13 to i8, !dbg !73  ; [#uses=1 type=i8] [debug line = 51:10]
  %tmp_14 = add i8 %j_1_cast2_cast, %tmp_17_cast, !dbg !73 ; [#uses=1 type=i8] [debug line = 51:10]
  %tmp_18_cast = zext i8 %tmp_14 to i32, !dbg !73 ; [#uses=1 type=i32] [debug line = 51:10]
  %col_outbuf_addr = getelementptr [64 x i16]* %col_outbuf, i32 0, i32 %tmp_18_cast, !dbg !73 ; [#uses=1 type=i16*] [debug line = 51:10]
  %tmp_2 = icmp eq i4 %i_3, -8, !dbg !71          ; [#uses=1 type=i1] [debug line = 50:11]
  %empty_10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  %i_7 = add i4 %i_3, 1, !dbg !75                 ; [#uses=1 type=i4] [debug line = 50:63]
  br i1 %tmp_2, label %11, label %10, !dbg !71    ; [debug line = 50:11]

; <label>:10                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str7) nounwind, !dbg !73 ; [debug line = 51:10]
  %col_outbuf_load = load i16* %col_outbuf_addr, align 2, !dbg !73 ; [#uses=1 type=i16] [debug line = 51:10]
  store i16 %col_outbuf_load, i16* %out_block_addr, align 2, !dbg !73 ; [debug line = 51:10]
  call void @llvm.dbg.value(metadata !{i4 %i_7}, i64 0, metadata !46), !dbg !75 ; [debug line = 50:63] [debug variable = i]
  br label %9, !dbg !75                           ; [debug line = 50:63]

; <label>:11                                      ; preds = %9
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str6, i32 %tmp_4), !dbg !76 ; [#uses=0 type=i32] [debug line = 51:43]
...
define internal fastcc void @dct_1d2([64 x i16]* nocapture %src, i4 %i_2, [64 x i16]* nocapture %dst, i4 %i_21) {
  ...
  %tmp_15 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_21_read, i3 0) ; [#uses=1 type=i7]
  %tmp_20_cast = zext i7 %tmp_15 to i8            ; [#uses=1 type=i8]
  %tmp_16 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_2_read, i3 0) ; [#uses=1 type=i7]
  %tmp_22_cast = zext i7 %tmp_16 to i8, !dbg !78  ; [#uses=1 type=i8] [debug line = 4:24]
...
; <label>:1                                       ; preds = %5, %0
  ...
  %k_cast2_cast = zext i4 %k to i8, !dbg !90      ; [#uses=1 type=i8] [debug line = 19:7]
  %tmp_17 = add i8 %k_cast2_cast, %tmp_20_cast, !dbg !90 ; [#uses=1 type=i8] [debug line = 19:7]
  %tmp_23_cast = zext i8 %tmp_17 to i32, !dbg !90 ; [#uses=1 type=i32] [debug line = 19:7]
  %dst_addr = getelementptr [64 x i16]* %dst, i32 0, i32 %tmp_23_cast, !dbg !90 ; [#uses=1 type=i16*] [debug line = 19:7]
  %tmp_18 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %k, i3 0) ; [#uses=1 type=i7]
  %tmp_25_cast = zext i7 %tmp_18 to i8, !dbg !87  ; [#uses=1 type=i8] [debug line = 13:9]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str) nounwind, !dbg !93 ; [debug line = 13:67]
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind, !dbg !93 ; [#uses=1 type=i32] [debug line = 13:67]
  br label %3, !dbg !94                           ; [debug line = 15:11]

; <label>:3                                       ; preds = %4, %2
  %n = phi i4 [ 0, %2 ], [ %n_1, %4 ]             ; [#uses=3 type=i4]
  %tmp1 = phi i32 [ 0, %2 ], [ %tmp_1, %4 ]       ; [#uses=2 type=i32]
  %n_cast1_cast = zext i4 %n to i8, !dbg !96      ; [#uses=2 type=i8] [debug line = 17:10]
  %tmp_19 = add i8 %tmp_22_cast, %n_cast1_cast, !dbg !96 ; [#uses=1 type=i8] [debug line = 17:10]
  %tmp_26_cast = zext i8 %tmp_19 to i32, !dbg !96 ; [#uses=1 type=i32] [debug line = 17:10]
  %src_addr = getelementptr [64 x i16]* %src, i32 0, i32 %tmp_26_cast, !dbg !96 ; [#uses=1 type=i16*] [debug line = 17:10]
  %tmp_20 = add i8 %tmp_25_cast, %n_cast1_cast, !dbg !98 ; [#uses=1 type=i8] [debug line = 16:48]
  %tmp_27_cast = zext i8 %tmp_20 to i32, !dbg !98 ; [#uses=1 type=i32] [debug line = 16:48]
  %dct_coeff_table_addr = getelementptr [64 x i15]* @dct_coeff_table, i32 0, i32 %tmp_27_cast, !dbg !98 ; [#uses=1 type=i15*] [debug line = 16:48]
  %tmp_s = icmp eq i4 %n, -8, !dbg !94            ; [#uses=1 type=i1] [debug line = 15:11]
  %empty_12 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  %n_1 = add i4 %n, 1, !dbg !99                   ; [#uses=1 type=i4] [debug line = 15:72]
  br i1 %tmp_s, label %5, label %4, !dbg !94      ; [debug line = 15:11]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str1) nounwind, !dbg !100 ; [debug line = 15:78]
  %dct_coeff_table_load = load i15* %dct_coeff_table_addr, align 2, !dbg !98 ; [#uses=1 type=i15] [debug line = 16:48]
  %coeff_cast = sext i15 %dct_coeff_table_load to i31, !dbg !98 ; [#uses=1 type=i31] [debug line = 16:48]
  %src_load = load i16* %src_addr, align 2, !dbg !96 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp_6_cast = sext i16 %src_load to i31, !dbg !96 ; [#uses=1 type=i31] [debug line = 17:10]
  %tmp_7 = mul i31 %coeff_cast, %tmp_6_cast, !dbg !96 ; [#uses=1 type=i31] [debug line = 17:10]
  %tmp_7_cast = sext i31 %tmp_7 to i32, !dbg !96  ; [#uses=1 type=i32] [debug line = 17:10]
  %tmp_1 = add nsw i32 %tmp1, %tmp_7_cast, !dbg !96 ; [#uses=1 type=i32] [debug line = 17:10]
  call void @llvm.dbg.value(metadata !{i32 %tmp_1}, i64 0, metadata !101), !dbg !96 ; [debug line = 17:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i4 %n_1}, i64 0, metadata !103), !dbg !99 ; [debug line = 15:72] [debug variable = n]
  br label %3, !dbg !99                           ; [debug line = 15:72]

; <label>:5                                       ; preds = %3
  %tmp_2 = trunc i32 %tmp1 to i29, !dbg !94       ; [#uses=1 type=i29] [debug line = 15:11]
  %tmp_3 = add i29 4096, %tmp_2, !dbg !90         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp_5 = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_3, i32 13, i32 28), !dbg !90 ; [#uses=1 type=i16] [debug line = 19:7]
  store i16 %tmp_5, i16* %dst_addr, align 2, !dbg !90 ; [debug line = 19:7]
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_8) nounwind, !dbg !104 ; [#uses=0 type=i32] [debug line = 20:4]
  call void @llvm.dbg.value(metadata !{i4 %k_1}, i64 0, metadata !105), !dbg !92 ; [debug line = 13:61] [debug variable = k]
...
; <label>:1                                       ; preds = %5, %0
  ...
  %tmp = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i, i3 0) ; [#uses=1 type=i7]
  %tmp_28_cast = zext i7 %tmp to i8, !dbg !142    ; [#uses=1 type=i8] [debug line = 59:9@85:4]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_2_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8) nounwind, !dbg !146 ; [#uses=1 type=i32] [debug line = 59:67@85:4]
  %tmp_3 = trunc i4 %r_i to i3                    ; [#uses=1 type=i3]
  %tmp_i = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %tmp_3, i3 0), !dbg !148 ; [#uses=1 type=i6] [debug line = 62:10@85:4]
...
; <label>:3                                       ; preds = %4, %2
  ...
  %c_i_cast5_cast = zext i4 %c_i to i8, !dbg !148 ; [#uses=1 type=i8] [debug line = 62:10@85:4]
  %tmp_21 = add i8 %tmp_28_cast, %c_i_cast5_cast, !dbg !148 ; [#uses=1 type=i8] [debug line = 62:10@85:4]
  %tmp_32_cast = zext i8 %tmp_21 to i32, !dbg !148 ; [#uses=1 type=i32] [debug line = 62:10@85:4]
  %buf_2d_in_addr = getelementptr [64 x i16]* %buf_2d_in, i32 0, i32 %tmp_32_cast, !dbg !148 ; [#uses=1 type=i16*] [debug line = 62:10@85:4]
...
; <label>:4                                       ; preds = %3
  ...
  %sum_i = add i6 %c_i_cast6, %tmp_i              ; [#uses=1 type=i6]
  %sum_i_cast = zext i6 %sum_i to i32             ; [#uses=1 type=i32]
  %input_addr = getelementptr [64 x i16]* %input, i32 0, i32 %sum_i_cast, !dbg !148 ; [#uses=1 type=i16*] [debug line = 62:10@85:4]
...
; <label>:5                                       ; preds = %3
  %empty_15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str8, i32 %tmp_2_i) nounwind, !dbg !154 ; [#uses=0 type=i32] [debug line = 63:4@85:4]
...
; <label>:6                                       ; preds = %10, %read_data.exit
  ...
  %tmp_s = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i2, i3 0) ; [#uses=1 type=i7]
  %tmp_31_cast = zext i7 %tmp_s to i8, !dbg !163  ; [#uses=1 type=i8] [debug line = 71:9@90:4]
...
; <label>:7                                       ; preds = %6
  ...
  %tmp_1_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str10) nounwind, !dbg !167 ; [#uses=1 type=i32] [debug line = 71:67@90:4]
  %tmp_4 = trunc i4 %r_i2 to i3                   ; [#uses=1 type=i3]
  %tmp_i4 = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %tmp_4, i3 0), !dbg !169 ; [#uses=1 type=i6] [debug line = 74:10@90:4]
  br label %8, !dbg !172                          ; [debug line = 73:12@90:4]

; <label>:8                                       ; preds = %9, %7
  %c_i5 = phi i4 [ 0, %7 ], [ %c_1, %9 ]          ; [#uses=4 type=i4]
  %c_i5_cast2 = zext i4 %c_i5 to i6, !dbg !172    ; [#uses=1 type=i6] [debug line = 73:12@90:4]
  %c_i5_cast1_cast = zext i4 %c_i5 to i8, !dbg !169 ; [#uses=1 type=i8] [debug line = 74:10@90:4]
  %tmp_22 = add i8 %tmp_31_cast, %c_i5_cast1_cast, !dbg !169 ; [#uses=1 type=i8] [debug line = 74:10@90:4]
  %tmp_34_cast = zext i8 %tmp_22 to i32, !dbg !169 ; [#uses=1 type=i32] [debug line = 74:10@90:4]
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i32 0, i32 %tmp_34_cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 74:10@90:4]
  %exitcond_i6 = icmp eq i4 %c_i5, -8, !dbg !172  ; [#uses=1 type=i1] [debug line = 73:12@90:4]
  %empty_17 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  %c_1 = add i4 %c_i5, 1, !dbg !173               ; [#uses=1 type=i4] [debug line = 73:64@90:4]
  br i1 %exitcond_i6, label %10, label %9, !dbg !172 ; [debug line = 73:12@90:4]
...
; <label>:9                                       ; preds = %8
  ...
  %sum3_i = add i6 %c_i5_cast2, %tmp_i4           ; [#uses=1 type=i6]
  %sum3_i_cast = zext i6 %sum3_i to i32           ; [#uses=1 type=i32]
  %output_addr = getelementptr [64 x i16]* %output, i32 0, i32 %sum3_i_cast, !dbg !169 ; [#uses=1 type=i16*] [debug line = 74:10@90:4]
...
; <label>:10                                      ; preds = %8
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str10, i32 %tmp_1_i) nounwind, !dbg !175 ; [#uses=0 type=i32] [debug line = 75:4@90:4]
...
!49 = metadata !{i32 786443, metadata !38, i32 37, i32 4, metadata !21, i32 8} ; [ DW_TAG_lexical_block ]
!50 = metadata !{i32 37, i32 61, metadata !49, null}
...
!54 = metadata !{i32 786443, metadata !49, i32 38, i32 1, metadata !21, i32 9} ; [ DW_TAG_lexical_block ]
...
!57 = metadata !{i32 40, i32 10, metadata !58, null}
!58 = metadata !{i32 786443, metadata !56, i32 40, i32 10, metadata !21, i32 11} ; [ DW_TAG_lexical_block ]
!59 = metadata !{i32 39, i32 63, metadata !56, null}
!60 = metadata !{i32 40, i32 43, metadata !56, null}
!61 = metadata !{i32 786688, metadata !38, metadata !"j", metadata !21, i32 28, metadata !47, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!62 = metadata !{i32 43, i32 61, metadata !52, null}
!63 = metadata !{i32 43, i32 67, metadata !64, null}
!64 = metadata !{i32 786443, metadata !52, i32 43, i32 66, metadata !21, i32 13} ; [ DW_TAG_lexical_block ]
!65 = metadata !{i32 44, i32 7, metadata !64, null}
!66 = metadata !{i32 48, i32 9, metadata !67, null}
!67 = metadata !{i32 786443, metadata !38, i32 48, i32 4, metadata !21, i32 14} ; [ DW_TAG_lexical_block ]
!68 = metadata !{i32 48, i32 61, metadata !67, null}
...
!73 = metadata !{i32 51, i32 10, metadata !74, null}
!74 = metadata !{i32 786443, metadata !72, i32 51, i32 10, metadata !21, i32 17} ; [ DW_TAG_lexical_block ]
!75 = metadata !{i32 50, i32 63, metadata !72, null}
...
!82 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !26} ; [ DW_TAG_pointer_type ]
...
!90 = metadata !{i32 19, i32 7, metadata !91, null}
!91 = metadata !{i32 786443, metadata !88, i32 13, i32 66, metadata !21, i32 2} ; [ DW_TAG_lexical_block ]
!92 = metadata !{i32 13, i32 61, metadata !88, null}
!93 = metadata !{i32 13, i32 67, metadata !91, null}
!94 = metadata !{i32 15, i32 11, metadata !95, null}
!95 = metadata !{i32 786443, metadata !91, i32 15, i32 7, metadata !21, i32 3} ; [ DW_TAG_lexical_block ]
!96 = metadata !{i32 17, i32 10, metadata !97, null}
!97 = metadata !{i32 786443, metadata !95, i32 15, i32 77, metadata !21, i32 4} ; [ DW_TAG_lexical_block ]
!98 = metadata !{i32 16, i32 48, metadata !97, null}
!99 = metadata !{i32 15, i32 72, metadata !95, null}
!100 = metadata !{i32 15, i32 78, metadata !97, null}
...
!103 = metadata !{i32 786688, metadata !89, metadata !"n", metadata !21, i32 6, metadata !47, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!104 = metadata !{i32 20, i32 4, metadata !91, null}
!105 = metadata !{i32 786688, metadata !89, metadata !"k", metadata !21, i32 6, metadata !47, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!121 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !27} ; [ DW_TAG_pointer_type ]
