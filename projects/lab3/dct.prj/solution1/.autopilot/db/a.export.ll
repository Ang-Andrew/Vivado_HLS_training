...
; <label>:4                                       ; preds = %5, %3
  ...
  %tmp_7 = add i8 %i_1_cast4_cast, %tmp_6_cast
  %tmp_7_cast = zext i8 %tmp_7 to i32
  %col_inbuf_addr = getelementptr [64 x i16]* %col_inbuf, i32 0, i32 %tmp_7_cast
  %tmp_6 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1, i3 0)
  %tmp_11_cast = zext i7 %tmp_6 to i8
  %tmp_10 = add i8 %j_cast5_cast, %tmp_11_cast
  %tmp_12_cast = zext i8 %tmp_10 to i32
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i32 0, i32 %tmp_12_cast
