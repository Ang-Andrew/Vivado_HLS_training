...
`define AUTOTB_TVIN_input_r  "./c.dct.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r  "./c.dct.autotvin_output_r.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "./rtl.dct.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "./rtl.dct.autotvin_output_r.dat"
`define AUTOTB_TVOUT_output_r  "./c.dct.autotvout_output_r.dat"
`define AUTOTB_TVOUT_output_r_out_wrapc  "./impl_rtl.dct.autotvout_output_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 3959;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.dct.autotvout_output_r.dat", "r");
    fp2 = $fopen("./impl_rtl.dct.autotvout_output_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.dct.autotvout_output_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.dct.autotvout_output_r.dat\"!");
    else begin
        $display("Comparing rtl.dct.autotvout_output_r.dat with impl_rtl.dct.autotvout_output_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
