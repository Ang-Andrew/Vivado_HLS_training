; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:5                                       ; preds = %.preheader2
  ...
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str3), !dbg !62 ; [#uses=1 type=i32] [debug line = 38:1]
...
; <label>:6                                       ; preds = %8, %5
  ...
  br i1 %tmp., label %9, label %8, !dbg !64       ; [debug line = 39:11]

; <label>:8                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str4) nounwind, !dbg !66 ; [debug line = 40:10]
  %row_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i32 0, i32 %i.1.cast4, i32 %j.cast5, !dbg !66 ; [#uses=1 type=i16*] [debug line = 40:10]
  %row_outbuf.load = load i16* %row_outbuf.addr, align 2, !dbg !66 ; [#uses=1 type=i16] [debug line = 40:10]
  %col_inbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i32 %j.cast5, i32 %i.1.cast4, !dbg !66 ; [#uses=1 type=i16*] [debug line = 40:10]
  store i16 %row_outbuf.load, i16* %col_inbuf.addr, align 2, !dbg !66 ; [debug line = 40:10]
...
; <label>:9                                       ; preds = %6
  %10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str3, i32 %tmp.3), !dbg !69 ; [#uses=0 type=i32] [debug line = 40:43]
...
.preheader1:                                      ; preds = %12, %.preheader1.preheader
  ...
  br i1 %tmp.9, label %.preheader.preheader, label %12, !dbg !60 ; [debug line = 43:9]
...
.preheader:                                       ; preds = %18, %.preheader.preheader
  ...
  %j.1.cast2 = zext i4 %j.1 to i32, !dbg !72      ; [#uses=2 type=i32] [debug line = 48:9]
  %tmp.1 = icmp eq i4 %j.1, -8, !dbg !72          ; [#uses=1 type=i1] [debug line = 48:9]
  %13 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp.1, label %20, label %14, !dbg !72    ; [debug line = 48:9]

; <label>:14                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str6) nounwind, !dbg !78 ; [debug line = 49:1]
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str6), !dbg !78 ; [#uses=1 type=i32] [debug line = 49:1]
  br label %15, !dbg !80                          ; [debug line = 50:11]

; <label>:15                                      ; preds = %17, %14
  %i.3 = phi i4 [ 0, %14 ], [ %i.7, %17 ]         ; [#uses=3 type=i4]
  %i.3.cast1 = zext i4 %i.3 to i32, !dbg !80      ; [#uses=2 type=i32] [debug line = 50:11]
  %tmp.2 = icmp eq i4 %i.3, -8, !dbg !80          ; [#uses=1 type=i1] [debug line = 50:11]
  %16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp.2, label %18, label %17, !dbg !80    ; [debug line = 50:11]

; <label>:17                                      ; preds = %15
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str7) nounwind, !dbg !82 ; [debug line = 51:10]
  %col_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i32 0, i32 %i.3.cast1, i32 %j.1.cast2, !dbg !82 ; [#uses=1 type=i16*] [debug line = 51:10]
  %col_outbuf.load = load i16* %col_outbuf.addr, align 2, !dbg !82 ; [#uses=1 type=i16] [debug line = 51:10]
  %out_block.addr = getelementptr [8 x [8 x i16]]* %out_block, i32 0, i32 %j.1.cast2, i32 %i.3.cast1, !dbg !82 ; [#uses=1 type=i16*] [debug line = 51:10]
  store i16 %col_outbuf.load, i16* %out_block.addr, align 2, !dbg !82 ; [debug line = 51:10]
...
; <label>:18                                      ; preds = %15
  %19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str6, i32 %tmp.4), !dbg !85 ; [#uses=0 type=i32] [debug line = 51:43]
...
define internal fastcc void @dct_1d([8 x [8 x i16]]* nocapture %src, i4 %i.2, [8 x [8 x i16]]* nocapture %dst, i4 %i.21) {
  ...
  call void (...)* @_ssdm_SpecKeepAssert(i32 %i.2.cast), !hlsrange !88
  call void (...)* @_ssdm_SpecKeepAssert(i32 %i.21.cast), !hlsrange !88
...
; <label>:1                                       ; preds = %7, %0
  ...
  %k.cast2 = zext i4 %k to i32, !dbg !94          ; [#uses=2 type=i32] [debug line = 13:9]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !97 ; [#uses=1 type=i32] [debug line = 13:67]
  br label %4, !dbg !99                           ; [debug line = 15:11]

; <label>:4                                       ; preds = %6, %3
  %n = phi i4 [ 0, %3 ], [ %n.1, %6 ]             ; [#uses=3 type=i4]
  %tmp1 = phi i32 [ 0, %3 ], [ %tmp.1, %6 ]       ; [#uses=2 type=i32]
  %n.cast1 = zext i4 %n to i32, !dbg !99          ; [#uses=2 type=i32] [debug line = 15:11]
  %tmp1.cast = trunc i32 %tmp1 to i29, !dbg !99   ; [#uses=1 type=i29] [debug line = 15:11]
  %tmp. = icmp eq i4 %n, -8, !dbg !99             ; [#uses=1 type=i1] [debug line = 15:11]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %tmp., label %7, label %6, !dbg !99       ; [debug line = 15:11]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str1) nounwind, !dbg !101 ; [debug line = 15:78]
  %dct_coeff_table.addr = getelementptr inbounds [8 x [8 x i16]]* @dct_coeff_table, i32 0, i32 %k.cast2, i32 %n.cast1, !dbg !103 ; [#uses=1 type=i16*] [debug line = 16:48]
  %dct_coeff_table.load = load i16* %dct_coeff_table.addr, align 2, !dbg !103 ; [#uses=1 type=i16] [debug line = 16:48]
  %coeff = sext i16 %dct_coeff_table.load to i32, !dbg !103 ; [#uses=1 type=i32] [debug line = 16:48]
  call void @llvm.dbg.value(metadata !{i32 %coeff}, i64 0, metadata !104), !dbg !103 ; [debug line = 16:48] [debug variable = coeff]
  %src.addr = getelementptr [8 x [8 x i16]]* %src, i32 0, i32 %i.2.cast, i32 %n.cast1, !dbg !106 ; [#uses=1 type=i16*] [debug line = 17:10]
  %src.load = load i16* %src.addr, align 2, !dbg !106 ; [#uses=1 type=i16] [debug line = 17:10]
  %tmp.6 = sext i16 %src.load to i32, !dbg !106   ; [#uses=1 type=i32] [debug line = 17:10]
  %tmp.7 = mul nsw i32 %coeff, %tmp.6, !dbg !106  ; [#uses=1 type=i32] [debug line = 17:10]
  %tmp.1 = add nsw i32 %tmp1, %tmp.7, !dbg !106   ; [#uses=1 type=i32] [debug line = 17:10]
...
; <label>:7                                       ; preds = %4
  ...
  %tmp.3 = add i29 %tmp1.cast.lcssa, 4096, !dbg !110 ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp.4 = lshr i29 %tmp.3, 13, !dbg !110         ; [#uses=1 type=i29] [debug line = 19:7]
  %tmp.5 = trunc i29 %tmp.4 to i16, !dbg !110     ; [#uses=1 type=i16] [debug line = 19:7]
  %dst.addr = getelementptr [8 x [8 x i16]]* %dst, i32 0, i32 %i.21.cast, i32 %k.cast2, !dbg !110 ; [#uses=1 type=i16*] [debug line = 19:7]
  store i16 %tmp.5, i16* %dst.addr, align 2, !dbg !110 ; [debug line = 19:7]
  %8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp.8) nounwind, !dbg !111 ; [#uses=0 type=i32] [debug line = 20:4]
...
; <label>:1                                       ; preds = %7, %0
  ...
  %r.i.cast8 = zext i4 %r.i to i32, !dbg !152     ; [#uses=1 type=i32] [debug line = 59:9@85:4]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.2.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str8) nounwind, !dbg !155 ; [#uses=1 type=i32] [debug line = 59:67@85:4]
...
; <label>:4                                       ; preds = %6, %3
  ...
  %c.i.cast5 = zext i4 %c.i to i32, !dbg !160     ; [#uses=1 type=i32] [debug line = 61:12@85:4]
...
; <label>:6                                       ; preds = %4
  ...
  %input.addr = getelementptr [64 x i16]* %input, i32 0, i32 %sum.i.cast, !dbg !157 ; [#uses=1 type=i16*] [debug line = 62:10@85:4]
  %input.load = load i16* %input.addr, align 2, !dbg !157 ; [#uses=1 type=i16] [debug line = 62:10@85:4]
  %buf.assign.addr = getelementptr [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 %r.i.cast8, i32 %c.i.cast5, !dbg !157 ; [#uses=1 type=i16*] [debug line = 62:10@85:4]
...
; <label>:7                                       ; preds = %4
  %8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str8, i32 %tmp.2.i) nounwind, !dbg !163 ; [#uses=0 type=i32] [debug line = 63:4@85:4]
...
; <label>:9                                       ; preds = %15, %read_data.exit
  ...
  %r.i2.cast4 = zext i4 %r.i2 to i32, !dbg !175   ; [#uses=1 type=i32] [debug line = 71:9@90:4]
  %r.i2.cast3 = zext i4 %r.i2 to i6, !dbg !175    ; [#uses=1 type=i6] [debug line = 71:9@90:4]
...
; <label>:11                                      ; preds = %9
  ...
  %tmp.1.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10) nounwind, !dbg !178 ; [#uses=1 type=i32] [debug line = 71:67@90:4]
  %tmp.i4 = shl i6 %r.i2.cast3, 3, !dbg !180      ; [#uses=1 type=i6] [debug line = 74:10@90:4]
  br label %12, !dbg !183                         ; [debug line = 73:12@90:4]

; <label>:12                                      ; preds = %14, %11
  %c.i5 = phi i4 [ 0, %11 ], [ %c.1, %14 ]        ; [#uses=4 type=i4]
  %c.i5.cast2 = zext i4 %c.i5 to i6, !dbg !183    ; [#uses=1 type=i6] [debug line = 73:12@90:4]
  %c.i5.cast1 = zext i4 %c.i5 to i32, !dbg !183   ; [#uses=1 type=i32] [debug line = 73:12@90:4]
  %exitcond.i6 = icmp eq i4 %c.i5, -8, !dbg !183  ; [#uses=1 type=i1] [debug line = 73:12@90:4]
  %13 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond.i6, label %15, label %14, !dbg !183 ; [debug line = 73:12@90:4]

; <label>:14                                      ; preds = %12
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str11) nounwind, !dbg !180 ; [debug line = 74:10@90:4]
  %buf.assign.1.addr = getelementptr [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 %r.i2.cast4, i32 %c.i5.cast1, !dbg !180 ; [#uses=1 type=i16*] [debug line = 74:10@90:4]
  ...
  %output.addr = getelementptr [64 x i16]* %output, i32 0, i32 %sum3.i.cast, !dbg !180 ; [#uses=1 type=i16*] [debug line = 74:10@90:4]
  store i16 %buf.assign.1.load, i16* %output.addr, align 2, !dbg !180 ; [debug line = 74:10@90:4]
  %c.1 = add i4 %c.i5, 1, !dbg !184               ; [#uses=1 type=i4] [debug line = 73:64@90:4]
...
; <label>:15                                      ; preds = %12
  %16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.1.i) nounwind, !dbg !186 ; [#uses=0 type=i32] [debug line = 75:4@90:4]
...
!66 = metadata !{i32 40, i32 10, metadata !67, null}
!67 = metadata !{i32 786443, metadata !65, i32 40, i32 10, metadata !24, i32 11} ; [ DW_TAG_lexical_block ]
!68 = metadata !{i32 39, i32 63, metadata !65, null}
!69 = metadata !{i32 40, i32 43, metadata !65, null}
...
!80 = metadata !{i32 50, i32 11, metadata !81, null}
!81 = metadata !{i32 786443, metadata !79, i32 50, i32 7, metadata !24, i32 16} ; [ DW_TAG_lexical_block ]
!82 = metadata !{i32 51, i32 10, metadata !83, null}
!83 = metadata !{i32 786443, metadata !81, i32 51, i32 10, metadata !24, i32 17} ; [ DW_TAG_lexical_block ]
!84 = metadata !{i32 50, i32 63, metadata !81, null}
!85 = metadata !{i32 51, i32 43, metadata !81, null}
...
!99 = metadata !{i32 15, i32 11, metadata !100, null}
!100 = metadata !{i32 786443, metadata !98, i32 15, i32 7, metadata !24, i32 3} ; [ DW_TAG_lexical_block ]
!101 = metadata !{i32 15, i32 78, metadata !102, null}
!102 = metadata !{i32 786443, metadata !100, i32 15, i32 77, metadata !24, i32 4} ; [ DW_TAG_lexical_block ]
!103 = metadata !{i32 16, i32 48, metadata !102, null}
!104 = metadata !{i32 786688, metadata !102, metadata !"coeff", metadata !24, i32 16, metadata !105, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!105 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!106 = metadata !{i32 17, i32 10, metadata !102, null}
!107 = metadata !{i32 786688, metadata !96, metadata !"tmp", metadata !24, i32 7, metadata !105, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!108 = metadata !{i32 15, i32 72, metadata !100, null}
...
!129 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !29} ; [ DW_TAG_pointer_type ]
...
!146 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !147} ; [ DW_TAG_pointer_type ]
