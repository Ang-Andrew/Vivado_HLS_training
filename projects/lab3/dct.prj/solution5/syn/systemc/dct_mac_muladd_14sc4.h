...
#ifndef __dct_mac_muladd_14sc4__HH__
#define __dct_mac_muladd_14sc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mac_muladd_14sc4) {
    ...
    SC_CTOR(dct_mac_muladd_14sc4):  simcore_mac_0_U ("simcore_mac_0_U") {
