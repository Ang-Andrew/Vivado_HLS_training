...
#ifndef __dct_mac_muladd_15tde__HH__
#define __dct_mac_muladd_15tde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mac_muladd_15tde) {
    ...
    SC_CTOR(dct_mac_muladd_15tde):  simcore_mac_1_U ("simcore_mac_1_U") {
