...
#ifndef __dct_mac_muladd_15udo__HH__
#define __dct_mac_muladd_15udo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mac_muladd_15udo) {
    ...
    SC_CTOR(dct_mac_muladd_15udo):  simcore_mac_2_U ("simcore_mac_2_U") {
