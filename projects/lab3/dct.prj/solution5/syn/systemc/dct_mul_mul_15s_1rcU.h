...
#ifndef __dct_mul_mul_15s_1rcU__HH__
#define __dct_mul_mul_15s_1rcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mul_mul_15s_1rcU) {
    ...
    SC_CTOR(dct_mul_mul_15s_1rcU):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
