...
write_data::write_data(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_4_cast_fu_182_p1 );
    ...
    SC_METHOD(thread_c_cast5_cast_fu_172_p1);
    sensitive << ( c_mid2_fu_128_p3 );
    ...
    sensitive << ( exitcond_flatten_reg_203 );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( r_cast8_mid2_v_reg_212 );
    sensitive << ( ap_enable_reg_pp0_iter1 );

    SC_METHOD(thread_sum3_cast_fu_199_p1);
    sensitive << ( sum3_reg_222 );

    SC_METHOD(thread_sum3_fu_187_p2);
    sensitive << ( c_cast6_fu_168_p1 );
    sensitive << ( tmp_mid2_fu_160_p3 );

    SC_METHOD(thread_tmp_1_cast_fu_152_p1);
    sensitive << ( tmp_fu_144_p3 );

    SC_METHOD(thread_tmp_1_fu_156_p1);
    sensitive << ( r_cast8_mid2_v_fu_136_p3 );

    SC_METHOD(thread_tmp_4_cast_fu_182_p1);
    sensitive << ( tmp_4_fu_176_p2 );

    SC_METHOD(thread_tmp_4_fu_176_p2);
    sensitive << ( tmp_1_cast_fu_152_p1 );
    sensitive << ( c_cast5_cast_fu_172_p1 );

    SC_METHOD(thread_tmp_fu_144_p3);
    sensitive << ( r_cast8_mid2_v_fu_136_p3 );

    SC_METHOD(thread_tmp_mid2_fu_160_p3);
    sensitive << ( tmp_1_fu_156_p1 );
    ...
    sc_trace(mVcdFile, r_cast8_mid2_v_reg_212, "r_cast8_mid2_v_reg_212");
    sc_trace(mVcdFile, sum3_fu_187_p2, "sum3_fu_187_p2");
    sc_trace(mVcdFile, sum3_reg_222, "sum3_reg_222");
    sc_trace(mVcdFile, c_1_fu_193_p2, "c_1_fu_193_p2");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter1, "ap_enable_reg_pp0_iter1");
    sc_trace(mVcdFile, r_phi_fu_86_p4, "r_phi_fu_86_p4");
    sc_trace(mVcdFile, tmp_4_cast_fu_182_p1, "tmp_4_cast_fu_182_p1");
    sc_trace(mVcdFile, sum3_cast_fu_199_p1, "sum3_cast_fu_199_p1");
...
void write_data::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        r_reg_82 = r_cast8_mid2_v_reg_212.read();
    } else if ((esl_seteq<1,1,1>(ap_CS_fsm_state1.read(), ap_const_lv1_1) && 
                !(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(exitcond_flatten_fu_104_p2.read(), ap_const_lv1_0))) {
        r_cast8_mid2_v_reg_212 = r_cast8_mid2_v_fu_136_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(exitcond_flatten_fu_104_p2.read(), ap_const_lv1_0))) {
        sum3_reg_222 = sum3_fu_187_p2.read();
    }
}
...
void write_data::thread_buf_r_address0() {
    buf_r_address0 =  (sc_lv<6>) (tmp_4_cast_fu_182_p1.read());
}
...
void write_data::thread_c_1_fu_193_p2() {
...
void write_data::thread_c_cast5_cast_fu_172_p1() {
    c_cast5_cast_fu_172_p1 = esl_zext<8,4>(c_mid2_fu_128_p3.read());
}
...
void write_data::thread_c_mid2_fu_128_p3() {
    c_mid2_fu_128_p3 = (!exitcond2_fu_122_p2.read()[0].is_01())? sc_lv<4>(): ((exitcond2_fu_122_p2.read()[0].to_bool())? ap_const_lv4_0: c_reg_93.read());
}

void write_data::thread_exitcond2_fu_122_p2() {
    exitcond2_fu_122_p2 = (!c_reg_93.read().is_01() || !ap_const_lv4_8.is_01())? sc_lv<1>(): sc_lv<1>(c_reg_93.read() == ap_const_lv4_8);
}
...
void write_data::thread_output_r_address0() {
    output_r_address0 =  (sc_lv<6>) (sum3_cast_fu_199_p1.read());
}
...
void write_data::thread_r_phi_fu_86_p4() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
         esl_seteq<1,1,1>(exitcond_flatten_reg_203.read(), ap_const_lv1_0))) {
        r_phi_fu_86_p4 = r_cast8_mid2_v_reg_212.read();
    } else {
        r_phi_fu_86_p4 = r_reg_82.read();
    }
}

void write_data::thread_sum3_cast_fu_199_p1() {
    sum3_cast_fu_199_p1 = esl_zext<32,6>(sum3_reg_222.read());
}

void write_data::thread_sum3_fu_187_p2() {
    sum3_fu_187_p2 = (!c_cast6_fu_168_p1.read().is_01() || !tmp_mid2_fu_160_p3.read().is_01())? sc_lv<6>(): (sc_biguint<6>(c_cast6_fu_168_p1.read()) + sc_biguint<6>(tmp_mid2_fu_160_p3.read()));
}

void write_data::thread_tmp_1_cast_fu_152_p1() {
    tmp_1_cast_fu_152_p1 = esl_zext<8,7>(tmp_fu_144_p3.read());
}

void write_data::thread_tmp_1_fu_156_p1() {
    tmp_1_fu_156_p1 = r_cast8_mid2_v_fu_136_p3.read().range(3-1, 0);
}

void write_data::thread_tmp_4_cast_fu_182_p1() {
    tmp_4_cast_fu_182_p1 = esl_zext<32,8>(tmp_4_fu_176_p2.read());
}

void write_data::thread_tmp_4_fu_176_p2() {
    tmp_4_fu_176_p2 = (!tmp_1_cast_fu_152_p1.read().is_01() || !c_cast5_cast_fu_172_p1.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp_1_cast_fu_152_p1.read()) + sc_biguint<8>(c_cast5_cast_fu_172_p1.read()));
}

void write_data::thread_tmp_fu_144_p3() {
    tmp_fu_144_p3 = esl_concat<4,3>(r_cast8_mid2_v_fu_136_p3.read(), ap_const_lv3_0);
}

void write_data::thread_tmp_mid2_fu_160_p3() {
    tmp_mid2_fu_160_p3 = esl_concat<3,3>(tmp_1_fu_156_p1.read(), ap_const_lv3_0);
}
...
void write_data::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && !esl_seteq<1,1,1>(exitcond_flatten_fu_104_p2.read(), ap_const_lv1_0))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else {
