; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution5/.autopilot/db/a.g.1.bc'
...
; <label>:5                                       ; preds = %4
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !136 ; [debug line = 41:1]
...
; <label>:10                                      ; preds = %9
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !156 ; [debug line = 52:1]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !174 ; [debug line = 14:1]
  br label %3, !dbg !175                          ; [debug line = 15:11]

; <label>:3                                       ; preds = %4, %2
  %n = phi i32 [ 0, %2 ], [ %n.1, %4 ]            ; [#uses=4 type=i32]
  %tmp18 = phi i32 [ 0, %2 ], [ %tmp.26, %4 ]     ; [#uses=2 type=i32]
  %tmp.19 = icmp eq i32 %n, 8, !dbg !175          ; [#uses=1 type=i1] [debug line = 15:11]
  br i1 %tmp.19, label %5, label %4, !dbg !175    ; [debug line = 15:11]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)), !dbg !177 ; [debug line = 15:78]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !177 ; [#uses=1 type=i32] [debug line = 15:78]
  ...
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !183 ; [#uses=0 type=i32] [debug line = 18:7]
...
define void @dct(i16* %input, i16* %output) nounwind {
  ...
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !198 ; [debug line = 80:1]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_in}, metadata !199), !dbg !201 ; [debug line = 81:10] [debug variable = buf_2d_in]
  %buf_2d_in.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !202 ; [#uses=3 type=[8 x i16]*] [debug line = 82:1]
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %buf_2d_in.addr, i32 1, i8* getelementptr inbounds ([9 x i8]* @.str13, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !202 ; [debug line = 82:1]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !203), !dbg !204 ; [debug line = 82:10] [debug variable = buf_2d_out]
  call fastcc void @read_data(i16* %input, [8 x i16]* %buf_2d_in.addr), !dbg !205 ; [debug line = 85:4]
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 0, !dbg !206 ; [#uses=2 type=[8 x i16]*] [debug line = 87:4]
  call fastcc void @dct_2d([8 x i16]* %buf_2d_in.addr, [8 x i16]* %buf_2d_out.addr), !dbg !206 ; [debug line = 87:4]
  call fastcc void @write_data([8 x i16]* %buf_2d_out.addr, i16* %output), !dbg !207 ; [debug line = 90:4]
...
!174 = metadata !{i32 14, i32 1, metadata !173, null}
!175 = metadata !{i32 15, i32 11, metadata !176, null}
!176 = metadata !{i32 786443, metadata !173, i32 15, i32 7, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!177 = metadata !{i32 15, i32 78, metadata !178, null}
!178 = metadata !{i32 786443, metadata !176, i32 15, i32 77, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!179 = metadata !{i32 16, i32 48, metadata !178, null}
!180 = metadata !{i32 786688, metadata !178, metadata !"coeff", metadata !6, i32 16, metadata !78, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!181 = metadata !{i32 17, i32 10, metadata !178, null}
!182 = metadata !{i32 786688, metadata !168, metadata !"tmp", metadata !6, i32 7, metadata !78, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!183 = metadata !{i32 18, i32 7, metadata !178, null}
!184 = metadata !{i32 15, i32 72, metadata !176, null}
...
!198 = metadata !{i32 80, i32 1, metadata !196, null}
!199 = metadata !{i32 786688, metadata !196, metadata !"buf_2d_in", metadata !6, i32 81, metadata !200, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!200 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !11, metadata !38, i32 0, i32 0} ; [ DW_TAG_array_type ]
!201 = metadata !{i32 81, i32 10, metadata !196, null}
!202 = metadata !{i32 82, i32 1, metadata !196, null}
!203 = metadata !{i32 786688, metadata !196, metadata !"buf_2d_out", metadata !6, i32 82, metadata !200, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!204 = metadata !{i32 82, i32 10, metadata !196, null}
!205 = metadata !{i32 85, i32 4, metadata !196, null}
!206 = metadata !{i32 87, i32 4, metadata !196, null}
!207 = metadata !{i32 90, i32 4, metadata !196, null}
!208 = metadata !{i32 91, i32 1, metadata !196, null}
