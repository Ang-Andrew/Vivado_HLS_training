; ModuleID = 'C:/Users/Andrew/Documents/Vivado_projects/HLS_Xilinx_university_program/projects/lab3/dct.prj/solution5/.autopilot/db/a.o.bc'
...
; <label>:6                                       ; preds = %17, %5
  ...
  br i1 %8, label %9, label %20, !dbg !112        ; [debug line = 32:8]

; <label>:9                                       ; preds = %6
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([13 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !114 ; [debug line = 32:66]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([13 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !114 ; [debug line = 32:66]
  %10 = load i32* %i, align 4, !dbg !116          ; [#uses=1 type=i32] [debug line = 33:7]
  %11 = load [8 x i16]** %1, align 4, !dbg !116   ; [#uses=1 type=[8 x i16]*] [debug line = 33:7]
  %12 = getelementptr inbounds [8 x i16]* %11, i32 %10, !dbg !116 ; [#uses=1 type=[8 x i16]*] [debug line = 33:7]
  %13 = getelementptr inbounds [8 x i16]* %12, i32 0, i32 0, !dbg !116 ; [#uses=1 type=i16*] [debug line = 33:7]
  %14 = load i32* %i, align 4, !dbg !116          ; [#uses=1 type=i32] [debug line = 33:7]
  %15 = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i32 0, i32 %14, !dbg !116 ; [#uses=1 type=[8 x i16]*] [debug line = 33:7]
  %16 = getelementptr inbounds [8 x i16]* %15, i32 0, i32 0, !dbg !116 ; [#uses=1 type=i16*] [debug line = 33:7]
  call void @dct_1d(i16* %13, i16* %16), !dbg !116 ; [debug line = 33:7]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([13 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !117 ; [debug line = 34:4]
  br label %17, !dbg !117                         ; [debug line = 34:4]

; <label>:17                                      ; preds = %9
  %18 = load i32* %i, align 4, !dbg !118          ; [#uses=1 type=i32] [debug line = 32:60]
  %19 = add i32 %18, 1, !dbg !118                 ; [#uses=1 type=i32] [debug line = 32:60]
  store i32 %19, i32* %i, align 4, !dbg !118      ; [debug line = 32:60]
  br label %6, !dbg !118                          ; [debug line = 32:60]

; <label>:20                                      ; preds = %6
  br label %21, !dbg !119                         ; [debug line = 34:4]

; <label>:21                                      ; preds = %20
  store i32 0, i32* %j, align 4, !dbg !120        ; [debug line = 37:9]
  br label %22, !dbg !120                         ; [debug line = 37:9]

; <label>:22                                      ; preds = %44, %21
  %23 = load i32* %j, align 4, !dbg !120          ; [#uses=1 type=i32] [debug line = 37:9]
  %24 = icmp ult i32 %23, 8, !dbg !120            ; [#uses=1 type=i1] [debug line = 37:9]
  br i1 %24, label %25, label %47, !dbg !120      ; [debug line = 37:9]

; <label>:25                                      ; preds = %22
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !122 ; [debug line = 38:1]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !122 ; [debug line = 38:1]
  br label %26, !dbg !122                         ; [debug line = 38:1]

; <label>:26                                      ; preds = %25
  store i32 0, i32* %i, align 4, !dbg !124        ; [debug line = 39:11]
  br label %27, !dbg !124                         ; [debug line = 39:11]

; <label>:27                                      ; preds = %40, %26
  %28 = load i32* %i, align 4, !dbg !124          ; [#uses=1 type=i32] [debug line = 39:11]
  %29 = icmp ult i32 %28, 8, !dbg !124            ; [#uses=1 type=i1] [debug line = 39:11]
  br i1 %29, label %30, label %43, !dbg !124      ; [debug line = 39:11]

; <label>:30                                      ; preds = %27
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !126 ; [debug line = 40:2]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !126 ; [debug line = 40:2]
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !128 ; [debug line = 41:1]
  %31 = load i32* %j, align 4, !dbg !129          ; [#uses=1 type=i32] [debug line = 40:1]
  %32 = load i32* %i, align 4, !dbg !129          ; [#uses=1 type=i32] [debug line = 40:1]
  %33 = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i32 0, i32 %32, !dbg !129 ; [#uses=1 type=[8 x i16]*] [debug line = 40:1]
  %34 = getelementptr inbounds [8 x i16]* %33, i32 0, i32 %31, !dbg !129 ; [#uses=1 type=i16*] [debug line = 40:1]
  %35 = load i16* %34, align 2, !dbg !129         ; [#uses=1 type=i16] [debug line = 40:1]
  %36 = load i32* %i, align 4, !dbg !129          ; [#uses=1 type=i32] [debug line = 40:1]
  %37 = load i32* %j, align 4, !dbg !129          ; [#uses=1 type=i32] [debug line = 40:1]
  %38 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i32 %37, !dbg !129 ; [#uses=1 type=[8 x i16]*] [debug line = 40:1]
  %39 = getelementptr inbounds [8 x i16]* %38, i32 0, i32 %36, !dbg !129 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %35, i16* %39, align 2, !dbg !129     ; [debug line = 40:1]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !130 ; [debug line = 40:34]
  br label %40, !dbg !130                         ; [debug line = 40:34]

; <label>:40                                      ; preds = %30
  %41 = load i32* %i, align 4, !dbg !131          ; [#uses=1 type=i32] [debug line = 39:63]
  %42 = add i32 %41, 1, !dbg !131                 ; [#uses=1 type=i32] [debug line = 39:63]
  store i32 %42, i32* %i, align 4, !dbg !131      ; [debug line = 39:63]
  br label %27, !dbg !131                         ; [debug line = 39:63]

; <label>:43                                      ; preds = %27
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !132 ; [debug line = 40:34]
  br label %44, !dbg !132                         ; [debug line = 40:34]

; <label>:44                                      ; preds = %43
  %45 = load i32* %j, align 4, !dbg !133          ; [#uses=1 type=i32] [debug line = 37:61]
  %46 = add i32 %45, 1, !dbg !133                 ; [#uses=1 type=i32] [debug line = 37:61]
  store i32 %46, i32* %j, align 4, !dbg !133      ; [debug line = 37:61]
  br label %22, !dbg !133                         ; [debug line = 37:61]

; <label>:47                                      ; preds = %22
  br label %48, !dbg !134                         ; [debug line = 40:34]

; <label>:48                                      ; preds = %47
  store i32 0, i32* %i, align 4, !dbg !135        ; [debug line = 43:9]
  br label %49, !dbg !135                         ; [debug line = 43:9]

; <label>:49                                      ; preds = %59, %48
  %50 = load i32* %i, align 4, !dbg !135          ; [#uses=1 type=i32] [debug line = 43:9]
  %51 = icmp ult i32 %50, 8, !dbg !135            ; [#uses=1 type=i1] [debug line = 43:9]
  br i1 %51, label %52, label %62, !dbg !135      ; [debug line = 43:9]

; <label>:52                                      ; preds = %49
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([13 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !137 ; [debug line = 43:67]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([13 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !137 ; [debug line = 43:67]
  %53 = load i32* %i, align 4, !dbg !139          ; [#uses=1 type=i32] [debug line = 44:7]
  %54 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i32 %53, !dbg !139 ; [#uses=1 type=[8 x i16]*] [debug line = 44:7]
  %55 = getelementptr inbounds [8 x i16]* %54, i32 0, i32 0, !dbg !139 ; [#uses=1 type=i16*] [debug line = 44:7]
  %56 = load i32* %i, align 4, !dbg !139          ; [#uses=1 type=i32] [debug line = 44:7]
  %57 = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i32 0, i32 %56, !dbg !139 ; [#uses=1 type=[8 x i16]*] [debug line = 44:7]
  %58 = getelementptr inbounds [8 x i16]* %57, i32 0, i32 0, !dbg !139 ; [#uses=1 type=i16*] [debug line = 44:7]
  call void @dct_1d(i16* %55, i16* %58), !dbg !139 ; [debug line = 44:7]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([13 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !140 ; [debug line = 45:4]
  br label %59, !dbg !140                         ; [debug line = 45:4]

; <label>:59                                      ; preds = %52
  %60 = load i32* %i, align 4, !dbg !141          ; [#uses=1 type=i32] [debug line = 43:61]
  %61 = add i32 %60, 1, !dbg !141                 ; [#uses=1 type=i32] [debug line = 43:61]
  store i32 %61, i32* %i, align 4, !dbg !141      ; [debug line = 43:61]
  br label %49, !dbg !141                         ; [debug line = 43:61]

; <label>:62                                      ; preds = %49
  br label %63, !dbg !142                         ; [debug line = 45:4]

; <label>:63                                      ; preds = %62
  store i32 0, i32* %j, align 4, !dbg !143        ; [debug line = 48:9]
  br label %64, !dbg !143                         ; [debug line = 48:9]

; <label>:64                                      ; preds = %87, %63
  %65 = load i32* %j, align 4, !dbg !143          ; [#uses=1 type=i32] [debug line = 48:9]
  %66 = icmp ult i32 %65, 8, !dbg !143            ; [#uses=1 type=i1] [debug line = 48:9]
  br i1 %66, label %67, label %90, !dbg !143      ; [debug line = 48:9]

; <label>:67                                      ; preds = %64
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !145 ; [debug line = 49:1]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !145 ; [debug line = 49:1]
  br label %68, !dbg !145                         ; [debug line = 49:1]

; <label>:68                                      ; preds = %67
  store i32 0, i32* %i, align 4, !dbg !147        ; [debug line = 50:11]
  br label %69, !dbg !147                         ; [debug line = 50:11]

; <label>:69                                      ; preds = %83, %68
  %70 = load i32* %i, align 4, !dbg !147          ; [#uses=1 type=i32] [debug line = 50:11]
  %71 = icmp ult i32 %70, 8, !dbg !147            ; [#uses=1 type=i1] [debug line = 50:11]
  br i1 %71, label %72, label %86, !dbg !147      ; [debug line = 50:11]

; <label>:72                                      ; preds = %69
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !149 ; [debug line = 51:2]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !149 ; [debug line = 51:2]
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !151 ; [debug line = 52:1]
  %73 = load i32* %j, align 4, !dbg !152          ; [#uses=1 type=i32] [debug line = 51:1]
  %74 = load i32* %i, align 4, !dbg !152          ; [#uses=1 type=i32] [debug line = 51:1]
  %75 = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i32 0, i32 %74, !dbg !152 ; [#uses=1 type=[8 x i16]*] [debug line = 51:1]
  %76 = getelementptr inbounds [8 x i16]* %75, i32 0, i32 %73, !dbg !152 ; [#uses=1 type=i16*] [debug line = 51:1]
  %77 = load i16* %76, align 2, !dbg !152         ; [#uses=1 type=i16] [debug line = 51:1]
  %78 = load i32* %i, align 4, !dbg !152          ; [#uses=1 type=i32] [debug line = 51:1]
  %79 = load i32* %j, align 4, !dbg !152          ; [#uses=1 type=i32] [debug line = 51:1]
  %80 = load [8 x i16]** %2, align 4, !dbg !152   ; [#uses=1 type=[8 x i16]*] [debug line = 51:1]
  %81 = getelementptr inbounds [8 x i16]* %80, i32 %79, !dbg !152 ; [#uses=1 type=[8 x i16]*] [debug line = 51:1]
  %82 = getelementptr inbounds [8 x i16]* %81, i32 0, i32 %78, !dbg !152 ; [#uses=1 type=i16*] [debug line = 51:1]
  store i16 %77, i16* %82, align 2, !dbg !152     ; [debug line = 51:1]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !153 ; [debug line = 51:34]
  br label %83, !dbg !153                         ; [debug line = 51:34]

; <label>:83                                      ; preds = %72
  %84 = load i32* %i, align 4, !dbg !154          ; [#uses=1 type=i32] [debug line = 50:63]
  %85 = add i32 %84, 1, !dbg !154                 ; [#uses=1 type=i32] [debug line = 50:63]
  store i32 %85, i32* %i, align 4, !dbg !154      ; [debug line = 50:63]
  br label %69, !dbg !154                         ; [debug line = 50:63]

; <label>:86                                      ; preds = %69
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([21 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !155 ; [debug line = 51:34]
  br label %87, !dbg !155                         ; [debug line = 51:34]

; <label>:87                                      ; preds = %86
  %88 = load i32* %j, align 4, !dbg !156          ; [#uses=1 type=i32] [debug line = 48:61]
  %89 = add i32 %88, 1, !dbg !156                 ; [#uses=1 type=i32] [debug line = 48:61]
  store i32 %89, i32* %j, align 4, !dbg !156      ; [debug line = 48:61]
  br label %64, !dbg !156                         ; [debug line = 48:61]
...
define void @read_data(i16* %input, [8 x i16]* %buf) nounwind {
  ...
  %3 = load i16** %1, align 4, !dbg !162          ; [#uses=1 type=i16*] [debug line = 55:2]
  call void bitcast (void (...)* @_ssdm_SpecArrayDimSize to void (i16*, i32)*)(i16* %3, i32 64) nounwind, !dbg !162 ; [debug line = 55:2]
  %4 = load [8 x i16]** %2, align 4, !dbg !164    ; [#uses=1 type=[8 x i16]*] [debug line = 55:40]
  call void bitcast (void (...)* @_ssdm_SpecArrayDimSize to void ([8 x i16]*, i32)*)([8 x i16]* %4, i32 8) nounwind, !dbg !164 ; [debug line = 55:40]
...
; <label>:6                                       ; preds = %31, %5
  ...
  br i1 %8, label %9, label %34, !dbg !170        ; [debug line = 59:9]

; <label>:9                                       ; preds = %6
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !172 ; [debug line = 59:67]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !172 ; [debug line = 59:67]
...
; <label>:11                                      ; preds = %27, %10
  ...
  br i1 %13, label %14, label %30, !dbg !174      ; [debug line = 61:12]

; <label>:14                                      ; preds = %11
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !176 ; [debug line = 62:2]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !176 ; [debug line = 62:2]
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !178 ; [debug line = 63:1]
  ...
  %19 = load i16** %1, align 4, !dbg !179         ; [#uses=1 type=i16*] [debug line = 62:1]
  %20 = getelementptr inbounds i16* %19, i32 %18, !dbg !179 ; [#uses=1 type=i16*] [debug line = 62:1]
  %21 = load i16* %20, align 2, !dbg !179         ; [#uses=1 type=i16] [debug line = 62:1]
  %22 = load i32* %c, align 4, !dbg !179          ; [#uses=1 type=i32] [debug line = 62:1]
  %23 = load i32* %r, align 4, !dbg !179          ; [#uses=1 type=i32] [debug line = 62:1]
  %24 = load [8 x i16]** %2, align 4, !dbg !179   ; [#uses=1 type=[8 x i16]*] [debug line = 62:1]
  %25 = getelementptr inbounds [8 x i16]* %24, i32 %23, !dbg !179 ; [#uses=1 type=[8 x i16]*] [debug line = 62:1]
  %26 = getelementptr inbounds [8 x i16]* %25, i32 0, i32 %22, !dbg !179 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %21, i16* %26, align 2, !dbg !179     ; [debug line = 62:1]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !180 ; [debug line = 62:66]
  br label %27, !dbg !180                         ; [debug line = 62:66]

; <label>:27                                      ; preds = %14
  %28 = load i32* %c, align 4, !dbg !181          ; [#uses=1 type=i32] [debug line = 61:64]
  %29 = add nsw i32 %28, 1, !dbg !181             ; [#uses=1 type=i32] [debug line = 61:64]
  store i32 %29, i32* %c, align 4, !dbg !181      ; [debug line = 61:64]
  br label %11, !dbg !181                         ; [debug line = 61:64]

; <label>:30                                      ; preds = %11
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !182 ; [debug line = 63:4]
  br label %31, !dbg !182                         ; [debug line = 63:4]

; <label>:31                                      ; preds = %30
  %32 = load i32* %r, align 4, !dbg !183          ; [#uses=1 type=i32] [debug line = 59:61]
  %33 = add nsw i32 %32, 1, !dbg !183             ; [#uses=1 type=i32] [debug line = 59:61]
  store i32 %33, i32* %r, align 4, !dbg !183      ; [debug line = 59:61]
...
define void @write_data([8 x i16]* %buf, i16* %output) nounwind {
  ...
  %3 = load i16** %2, align 4, !dbg !189          ; [#uses=1 type=i16*] [debug line = 67:2]
  call void bitcast (void (...)* @_ssdm_SpecArrayDimSize to void (i16*, i32)*)(i16* %3, i32 64) nounwind, !dbg !189 ; [debug line = 67:2]
  %4 = load [8 x i16]** %1, align 4, !dbg !191    ; [#uses=1 type=[8 x i16]*] [debug line = 67:41]
  call void bitcast (void (...)* @_ssdm_SpecArrayDimSize to void ([8 x i16]*, i32)*)([8 x i16]* %4, i32 8) nounwind, !dbg !191 ; [debug line = 67:41]
...
; <label>:6                                       ; preds = %31, %5
  ...
  br i1 %8, label %9, label %34, !dbg !197        ; [debug line = 71:9]

; <label>:9                                       ; preds = %6
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !199 ; [debug line = 71:67]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !199 ; [debug line = 71:67]
...
; <label>:11                                      ; preds = %27, %10
  ...
  br i1 %13, label %14, label %30, !dbg !201      ; [debug line = 73:12]

; <label>:14                                      ; preds = %11
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str12, i32 0, i32 0)) nounwind, !dbg !203 ; [debug line = 74:2]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str12, i32 0, i32 0)) nounwind, !dbg !203 ; [debug line = 74:2]
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !205 ; [debug line = 75:1]
  %15 = load i32* %c, align 4, !dbg !206          ; [#uses=1 type=i32] [debug line = 74:1]
  %16 = load i32* %r, align 4, !dbg !206          ; [#uses=1 type=i32] [debug line = 74:1]
  %17 = load [8 x i16]** %1, align 4, !dbg !206   ; [#uses=1 type=[8 x i16]*] [debug line = 74:1]
  %18 = getelementptr inbounds [8 x i16]* %17, i32 %16, !dbg !206 ; [#uses=1 type=[8 x i16]*] [debug line = 74:1]
  %19 = getelementptr inbounds [8 x i16]* %18, i32 0, i32 %15, !dbg !206 ; [#uses=1 type=i16*] [debug line = 74:1]
  %20 = load i16* %19, align 2, !dbg !206         ; [#uses=1 type=i16] [debug line = 74:1]
  %21 = load i32* %r, align 4, !dbg !206          ; [#uses=1 type=i32] [debug line = 74:1]
  %22 = mul nsw i32 %21, 8, !dbg !206             ; [#uses=1 type=i32] [debug line = 74:1]
  %23 = load i32* %c, align 4, !dbg !206          ; [#uses=1 type=i32] [debug line = 74:1]
  %24 = add nsw i32 %22, %23, !dbg !206           ; [#uses=1 type=i32] [debug line = 74:1]
  %25 = load i16** %2, align 4, !dbg !206         ; [#uses=1 type=i16*] [debug line = 74:1]
  %26 = getelementptr inbounds i16* %25, i32 %24, !dbg !206 ; [#uses=1 type=i16*] [debug line = 74:1]
  store i16 %20, i16* %26, align 2, !dbg !206     ; [debug line = 74:1]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str12, i32 0, i32 0)) nounwind, !dbg !207 ; [debug line = 74:67]
  br label %27, !dbg !207                         ; [debug line = 74:67]

; <label>:27                                      ; preds = %14
  %28 = load i32* %c, align 4, !dbg !208          ; [#uses=1 type=i32] [debug line = 73:64]
  %29 = add nsw i32 %28, 1, !dbg !208             ; [#uses=1 type=i32] [debug line = 73:64]
  store i32 %29, i32* %c, align 4, !dbg !208      ; [debug line = 73:64]
  br label %11, !dbg !208                         ; [debug line = 73:64]

; <label>:30                                      ; preds = %11
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !209 ; [debug line = 75:4]
  br label %31, !dbg !209                         ; [debug line = 75:4]

; <label>:31                                      ; preds = %30
  %32 = load i32* %r, align 4, !dbg !210          ; [#uses=1 type=i32] [debug line = 71:61]
  %33 = add nsw i32 %32, 1, !dbg !210             ; [#uses=1 type=i32] [debug line = 71:61]
  store i32 %33, i32* %r, align 4, !dbg !210      ; [debug line = 71:61]
...
define void @dct(i16* %input, i16* %output) nounwind {
  ...
  %3 = load i16** %2, align 4, !dbg !216          ; [#uses=1 type=i16*] [debug line = 79:2]
  call void bitcast (void (...)* @_ssdm_SpecArrayDimSize to void (i16*, i32)*)(i16* %3, i32 64) nounwind, !dbg !216 ; [debug line = 79:2]
  %4 = load i16** %1, align 4, !dbg !218          ; [#uses=1 type=i16*] [debug line = 79:41]
  call void bitcast (void (...)* @_ssdm_SpecArrayDimSize to void (i16*, i32)*)(i16* %4, i32 64) nounwind, !dbg !218 ; [debug line = 79:41]
  call void bitcast (void (...)* @_ssdm_op_SpecDataflowPipeline to void (i32, i8*)*)(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !219 ; [debug line = 80:1]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_in}, metadata !220), !dbg !222 ; [debug line = 81:10] [debug variable = buf_2d_in]
  %5 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !223 ; [#uses=1 type=[8 x i16]*] [debug line = 82:1]
  call void bitcast (void (...)* @_ssdm_SpecArrayPartition to void ([8 x i16]*, i32, i8*, i32, i8*)*)([8 x i16]* %5, i32 1, i8* getelementptr inbounds ([9 x i8]* @.str13, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !223 ; [debug line = 82:1]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !224), !dbg !225 ; [debug line = 82:10] [debug variable = buf_2d_out]
  %6 = load i16** %1, align 4, !dbg !226          ; [#uses=1 type=i16*] [debug line = 85:4]
  %7 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !226 ; [#uses=1 type=[8 x i16]*] [debug line = 85:4]
  call void @read_data(i16* %6, [8 x i16]* %7), !dbg !226 ; [debug line = 85:4]
  %8 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i32 0, i32 0, !dbg !227 ; [#uses=1 type=[8 x i16]*] [debug line = 87:4]
  %9 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 0, !dbg !227 ; [#uses=1 type=[8 x i16]*] [debug line = 87:4]
  call void @dct_2d([8 x i16]* %8, [8 x i16]* %9), !dbg !227 ; [debug line = 87:4]
  %10 = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i32 0, i32 0, !dbg !228 ; [#uses=1 type=[8 x i16]*] [debug line = 90:4]
  %11 = load i16** %2, align 4, !dbg !228         ; [#uses=1 type=i16*] [debug line = 90:4]
  call void @write_data([8 x i16]* %10, i16* %11), !dbg !228 ; [debug line = 90:4]
  ret void, !dbg !229                             ; [debug line = 91:1]
}
...
!219 = metadata !{i32 80, i32 1, metadata !217, null}
!220 = metadata !{i32 786688, metadata !217, metadata !"buf_2d_in", metadata !6, i32 81, metadata !221, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!221 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !11, metadata !38, i32 0, i32 0} ; [ DW_TAG_array_type ]
!222 = metadata !{i32 81, i32 10, metadata !217, null}
!223 = metadata !{i32 82, i32 1, metadata !217, null}
!224 = metadata !{i32 786688, metadata !217, metadata !"buf_2d_out", metadata !6, i32 82, metadata !221, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!225 = metadata !{i32 82, i32 10, metadata !217, null}
!226 = metadata !{i32 85, i32 4, metadata !217, null}
!227 = metadata !{i32 87, i32 4, metadata !217, null}
!228 = metadata !{i32 90, i32 4, metadata !217, null}
!229 = metadata !{i32 91, i32 1, metadata !217, null}
