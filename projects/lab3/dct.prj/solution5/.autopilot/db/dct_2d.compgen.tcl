...
set out_width 29
set exp i0*i1
set arg_lists {i0 {15 1 +} i1 {16 1 +} p {29 1 +} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 29
set exp i0*i1+i2
set arg_lists {i0 {14 0 +} i1 {16 1 +} m {29 1 +} i2 {29 1 +} p {29 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 29
set exp i0*i1+i2
set arg_lists {i0 {15 1 +} i1 {16 1 +} m {29 1 +} i2 {29 1 +} p {29 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
...
set out_width 29
set exp i0*i1+i2
set arg_lists {i0 {15 1 +} i1 {16 1 +} m {29 1 +} i2 {14 0 +} p {29 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
...
set ID 27
set MemName dct_2d_dct_coeff_bkb
...
set TrueReset 0
set IsROM 1
set ROMData { "10000000000000" "10110001100011" "10100111001111" "10010110100001" "10000000000000" "01100100100100" "01000101010001" "00100011010100" }
...
# Memory (RAM/ROM)  definition:
set ID 28
set MemName dct_2d_dct_coeff_cud
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 8
...
set TrueReset 0
set IsROM 1
set ROMData { "010000000000000" "010010110100001" "001000101010001" "111011100101100" "110000000000000" "101001110011110" "101011000110001" "110011011011100" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
# Memory (RAM/ROM)  definition:
set ID 29
set MemName dct_2d_dct_coeff_dEe
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 8
...
set TrueReset 0
set IsROM 1
set ROMData { "010000000000000" "001100100100100" "110111010101111" "101001110011110" "110000000000000" "000100011010100" "010100111001111" "010010110100001" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
# Memory (RAM/ROM)  definition:
set ID 30
set MemName dct_2d_dct_coeff_eOg
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 8
...
set TrueReset 0
set IsROM 1
set ROMData { "010000000000000" "000100011010100" "101011000110001" "110011011011100" "010000000000000" "010010110100001" "110111010101111" "101001110011110" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
# Memory (RAM/ROM)  definition:
set ID 31
set MemName dct_2d_dct_coeff_fYi
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 8
...
set TrueReset 0
set IsROM 1
set ROMData { "010000000000000" "111011100101100" "101011000110001" "001100100100100" "010000000000000" "101101001100000" "110111010101111" "010110001100011" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
# Memory (RAM/ROM)  definition:
set ID 32
set MemName dct_2d_dct_coeff_g8j
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 8
...
set TrueReset 0
set IsROM 1
set ROMData { "010000000000000" "110011011011100" "110111010101111" "010110001100011" "110000000000001" "111011100101100" "010100111001111" "101101001100000" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
# Memory (RAM/ROM)  definition:
set ID 33
set MemName dct_2d_dct_coeff_hbi
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 8
...
set TrueReset 0
set IsROM 1
set ROMData { "010000000000000" "101101001100000" "001000101010001" "000100011010100" "110000000000001" "010110001100011" "101011000110001" "001100100100100" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
# Memory (RAM/ROM)  definition:
set ID 34
set MemName dct_2d_dct_coeff_ibs
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 8
...
set TrueReset 0
set IsROM 1
set ROMData { "010000000000000" "101001110011110" "010100111001111" "101101001100000" "010000000000000" "110011011011100" "001000101010001" "111011100101100" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out_block \
    op interface \
    ports { out_block_address0 { O 6 vector } out_block_ce0 { O 1 bit } out_block_we0 { O 1 bit } out_block_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'out_block'"
}
}
